...
CATALOG: dict[str, list[dict]] = {
    ...
    "me1": [
        ...
        {"id": "major_kyle", "prompt": "The Cult - Major Kyle and the biotic commune on Presrop.", "options": ["talked into surrender", "shot"]},
        {"id": "rana_thanoptis", "prompt": "Rana Thanoptis, the asari researcher, on Virmire (she reappears in Mass Effect 2).", "options": ["spared", "killed"]},
        {"id": "noveria_garage_evidence", "prompt": "Noveria - Qui'in's evidence of Anoleis's corruption.", "options": ["given to Qui'in", "given to Anoleis"]},
        ...
        {"id": "emily_wong_data", "prompt": "Emily Wong and Fist's data on the Shadow Broker.", "options": ["given to Wong", "sold to the Broker's agent"]},
        {"id": "admiral_kahoku", "prompt": "Admiral Kahoku, the missing marines, and the Cerberus labs at Binthu.", "options": []},
        {"id": "pinnacle_station", "prompt": "Pinnacle Station - Ahern's survival wager.", "options": ["won", "lost or not done"]},
    ...
    "me2": [
        ...
        {"id": "veetor_fate", "prompt": "Freedom's Progress - Veetor, handed to Cerberus or released to the Migrant Fleet.", "options": ["Cerberus", "Migrant Fleet"]},
        {"id": "kal_reegar_haestrom", "prompt": "Haestrom - Kal'Reegar during the retrieval of Tali.", "options": ["kept in the fight", "ordered to stand down"]},
        ...
        {"id": "blue_rose_illium", "prompt": "Illium - Charr and Ereba, the Blue Rose of Illium.", "options": ["reconciled", "apart"]},
        ...
        {"id": "daniel_hostage", "prompt": "Omega - the batarians holding Dr. Daniel Abbott near Mordin's clinic.", "options": ["talked down", "batarians killed"]},
        {"id": "forvan_afterlife", "prompt": "Omega - Forvan and the poisoned drink at Afterlife.", "options": []},
        {"id": "jonn_whitson", "prompt": "Omega - the freelancer Jonn Whitson during the Archangel job.", "options": ["signed on", "turned away"]},
        ...
        {"id": "legion_cerberus", "prompt": "Whether Legion was handed over to Cerberus at the end of Mass Effect 2.", "options": ["kept", "handed to Cerberus"]},
    ...
    "me3": [
        ...
        {"id": "illusive_man_confrontation", "prompt": "The final confrontation with the Illusive Man on the Crucible.", "options": ["talked into suicide", "shot"]},
        {"id": "koris_rannoch", "prompt": "Admiral Zaal'Koris shot down on Rannoch - save him or save his crew.", "options": ["Koris saved", "crew saved"]},
        {"id": "petrovsky_fate", "prompt": "Omega DLC - General Petrovsky's fate after Aria retakes Omega.", "options": ["executed by Aria", "spared and handed to the Alliance"]},
        {"id": "omega_reactor", "prompt": "Omega DLC - the reactor and the civilians in the path of the power routing.", "options": []},
        {"id": "gellix_scientists", "prompt": "Gellix - rescuing Brynn Cole and the defecting Cerberus scientists.", "options": ["rescued", "lost"]},
        {"id": "burns_l2_reparations", "prompt": "MSV Ontario - Burns and the L2 biotic reparations standoff.", "options": []},
        {"id": "terra_firma_saracino", "prompt": "Citadel - the Terra Firma protest and endorsing Charles Saracino.", "options": ["endorsed", "refused"]},
