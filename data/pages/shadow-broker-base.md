---
title: Shadow Broker Base
url: https://masseffect.fandom.com/wiki/Shadow_Broker_Base
game: Mass Effect 3
type: location
characters: []
scraped: '2026-08-28'
...
The **Shadow Broker Base** is a massive unnamed ship that travels through the volatile atmosphere of Hagalaz, which conceals its presence. It is from here that the Shadow Broker rules his empire.
...
- **Eezo Mining Company**
 Provides the location of a planet rich with eezo.
**Credits required:** 1,000
- **Iridium Mining Company**
 Provides the location of a planet rich with iridium.
**Credits required:** 300
- **Palladium Mining Company**
 Provides the location of a planet rich with palladium.
**Credits required:** 300
- **Platinum Mining Company**
 Provides the location of a planet rich with platinum.
**Credits required:** 650
...
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Lair of the Shadow Broker
