---
title: EDI
url: https://masseffect.fandom.com/wiki/EDI
game: Mass Effect 3
type: character
characters: []
scraped: '2026-08-28'
...
During Shepard's final battle against a rogue VI at a Cerberus research facility on the planet Aite, the VI attempts to upload itself remotely into the Normandy SR\-2's systems. If Shepard is unable to stop the upload in time, the VI may be shown infecting EDI's holographic interface, presumably gaining control of both her and the ship and allowing a catastrophic spread of the virus\-like VI throughout the galaxy.
...
- Chris L'Etoile was the main writer for EDI in the second game, though bits of her dialogues were also written by Lukas Kristjanson and Trick Weekes. In the third game, EDI was written by Chris Hepler.
...
- Some early drafts of EDI had a model without eyes. Holographic, omni\-tool\-like eyes were brainstormed about, but was eventually decided against since it wouldn't work with the digital acting system BioWare used.
...
- The Art of the Mass Effect Trilogy/Mass Effect 3\#EDI
