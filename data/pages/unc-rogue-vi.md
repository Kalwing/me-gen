---
title: 'UNC: Rogue VI'
url: https://masseffect.fandom.com/wiki/UNC:_Rogue_VI
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
You will be fighting mostly synthetic drones on this mission, which are largely immune to physics\-based biotics. You will want to choose a squad heavy on tech powers such as AI Hacking, Overload, and especially Sabotage; Tali's engineering background makes her an especially strong squadmate here.
...
**Tip:** You may want to make a save point right before destroying the final conduit, as doing so will trigger a menu to pick your specialization immediately without a way to exit or postpone the choice.
...
- The assignment is referred to as "(UNC:) Ghost in the Machine" within the game's internal data. "Ghost in the machine" is an expression which can mean different things, but it has often been associated with the emergence of AI's within the realm of science\-fiction.
...
- In Mass Effect: Andromeda, after SAM is sabotaged during The Firefighters quest and after investigating anti\-AI activities, the hacked Avina has a line regarding the Hannibal VI going rogue on Luna.
...
- This assignment has a number of unused squadmate voicelines.
