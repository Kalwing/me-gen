---
title: 'Citadel Archives: Escape'
url: https://masseffect.fandom.com/wiki/Citadel_Archives:_Escape
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
This mission's journal entry is acquired after the cutscenes following the first conflict in the archives.
...
Stay under cover; CAT6 is unleashing their full arsenal, so you'll need to be constantly on the move. The group of adversaries you encounter here is known as the Rapier Squad, a name that becomes insignificant once you've bested them in combat. Stay focused, use powers, weapons, and anything to help. Get out of the middle as soon as you can do so safely, as your initial position can be flanked easily. Try and move to a corner and use it to prevent flanks and get the drop on enemies. Generally sticking to the outer rim is a good way to go.
...
Once every enemy falls, move to the doors as Shepard orders the teams to stick together and move up. Before leaving, grab the Shotgun Ultralight Materials mod and the medi\-gel on the right. Go through the door and, at the top of the ramp behind the desk in front of you is a terminal with 3,750 credits, and on a terminal before the scanning field checkpoints there sits some grenades.
...
In one of the display bins within this transport vault is an M\-7 Lancer assault rifle. This rifle does not use clips, but rather a cooldown system from the original game. It was apparently from the First Contact War, and now it may see use again. **Note:**  taking this weapon is the last opportunity to reselect your weaponry (though not mods) for the rest of this mission; make use of it as you will.
...
Despite being sealed in the vault, Shepard appears more concerned about the way they have always said "I should go" and asks if they really sound like that. One of the squadmates will confirm it. You can take the conversation where you want, but eventually one of your squadmates asks why Shepard isn’t more worried about their current situation, at which point Shepard calls Glyph to get them out and the next mission begins.

## Rewards

*See also: Equipment Guide (Mass Effect 3\)*
- **Total credits**: 15,000
	- Credits found: 15,000 (in 4 pickups)
	- Alliance Funding: none
- **Medi\-gels**: 19 (in 8 pickups)
- **Weapons**: M\-7 Lancer
- **Weapon mods**: Shotgun Ultralight Materials, SMG Power Magnifier, Sniper Rifle High\-Velocity Barrel, Assault Rifle Ultralight Materials, Sniper Rifle Ultralight Materials
- **Morality**: Morality Guide (Mass Effect 3\)\#Citadel Archives: Escape
...
| --- | --- | --- |
| Citadel: Identity Theft II | Missions | Citadel Docks: Retake the Normandy |
