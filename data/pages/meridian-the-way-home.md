---
title: 'Meridian: The Way Home'
url: https://masseffect.fandom.com/wiki/Meridian:_The_Way_Home
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
Ryder emerges into a large open area with a balcony overlooking a catwalk, and a fight in progress between kett and allied angaran and Initiative soldiers (apparently they arrived by shuttle; the space is open to the sky on one side). Melee\-oriented squadmates can get themselves into trouble here by charging down to the catwalk, which is full of kett (and a Behemoth if krogan scouts were not saved). Keep squadmates under control or Ryder will end up being the only one alive to kill all of the enemies. Remnant enemies will also appear during the battle; they will attack the kett, and if any are left over they will attack the squad.

**Note:** Be careful with skills/combos which can quickly and easily remove the enemies from the platform (e.g. Throw, Singularity, Concussion Shot). When an enemy is thrown into the abyss, those kills aren't registered, and therefore access to Meridian Control will NOT open after every enemy is eliminated. The only solution is to reload the last Autosave and carefully kill all enemies again without causing environmental deaths.
...
| --- | --- | --- |
| The Journey to Meridian | Missions (Mass Effect: Andromeda) | Epilogue: Home and Away |
