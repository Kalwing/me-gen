---
title: 'Citadel Arena: Reaper Solo Challenge'
url: https://masseffect.fandom.com/wiki/Citadel_Arena:_Reaper_Solo_Challenge
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
You will need to use one of your prizes from a previous match to purchase enemies (Reaper Combat Set) for the combat simulator. It is a Silver\-level prize. After doing so, simply set the simulator to Reaper enemies and no squadmates, and complete the combat to finish the mission. Since most arena challenges are not mutually exclusive to each other, the other options can be set in a way to finish other arena challenges at the same time, e.g. Citadel Arena: Medi\-Gel Challenge or Citadel Arena: Thermal Clip Challenge.
...
You'll earn 5000 credits and \+2 Reputation after receiving and reading the second email.
