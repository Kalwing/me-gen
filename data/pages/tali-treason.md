---
title: 'Tali: Treason'
url: https://masseffect.fandom.com/wiki/Tali:_Treason
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
**Combat Strategy:** The ramp up to the upper level makes a natural chokepoint, and a Combat Drone can be used to impede geth progress up the ramp. Sending a Combat Drone *inside* the downstairs door at the beginning of the battle will usually stop further enemies from spawning. Hacking unshielded geth also works well, and is particularly useful for distracting the deadly Geth Hunters. One thing to be careful about is hacking the Geth Hunters themselves if they are on the ramp, because while attacking the other geth they will often "back up" (toward you), leaving you in an extremely delicate position when the hack runs out. It is better in this case to hack one of the nearby lesser geth to distract the Hunter. Another technique that works well in this fight is to have the M\-622 Avalanche and fire a volley of shots down at the lower level door as the first large group of geth comes through. Taking cover at the upper ledge becomes a much safer proposition if you can freeze any Hunters before they climb up to your level; otherwise, you should wait in the back room for the Hunters to come to you and hopefully take them out quickly there. The Geth Plasma Shotgun will greatly even the odds against Hunters at close quarters.
...
**Note:** Although the mission summary screen may display a maximum credit award total of up to 45,000 (reporting the accurate maximum of 30,000 credits that can be found on the mission from pickups), the maximum you can *actually* receive from Cerberus funding and credits found is capped at a combined 30,000\. This does not apply to credits gained from salvaging medi\-gel or power cells.

## Trivia

- This mission was originally written by Chris L'Etoile before it was rewritten by Trick Weekes. As with other aspects of quarian culture, the Migrant Fleet and Tali's trial drew heavily from Jewish influences.
...
- According to Mass Effect Legendary Edition gameplay statistics as of July 27, 2021, in 96% of instances Tali was pardoned while she was exiled in the remaining 4%.
...
- A number of unused journal entries imply additional side\-objectives were planned at some point:
	- **Quarian: Reach Safety**: a quarian scientist's survival would depend on whether the player helps them reach the safety of a lockdown room.
	- **Quarian: Repair the Computer**: the player could repair a lab's quantum bluebox module and deliver it to a cut character named Director Genn'Shais.
- The trial itself was focused on Rael'Zorah instead of his daughter, and the admirals would all have accusations which could be refuted by finding the appropriate piece of evidence on the Alarei:
	- **The Trial: Admiral Shala'Raan**: instead of recusing herself, Shala'Raan would have supported exiling Rael'Zorah on the grounds that he endangered the Fleet by relaxing security protocols. The player could refute these claims by finding evidence on the Alarei proving that security was still tight.
	- **The Trial: Admiral Zaal'Koris**: Zaal'Koris accuses Rael'Zorah of "torturing" the geth, prompting the player to find evidence that counters his claims.
	- **The Trial: Admiral Han'Gerrel**: Shepard could find evidence to dispel the admiral's theory that the geth were severely weakened after the Battle of the Citadel.
	- **The Trial: Admiral Daro'Xen**: Daro'Xen intends to defeat the geth by hacking them, but the player can find evidence to prove that it's an inconceivable goal.
- Unused plot data implies Legion could testify in favor of Rael'Zorah during the trial at some point in development.
- Unused conversation paths indicate that it was possible at one point to miss Rael'Zorah's body on the Alarei, which would have resulted in different dialogue with Shala'Raan.
