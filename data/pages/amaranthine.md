---
title: Amaranthine
url: https://masseffect.fandom.com/wiki/Amaranthine
game: Mass Effect
type: location
characters: []
scraped: '2026-08-28'
...
**Location:** Milky Way / Horse Head Nebula / Fortuna System /  **Third planet**
...
| 2 | Initial | Turian Wreckage (UNC: Turian Insignias) *“You find an intricate beaded necklace marked with the Galatana Colony insignia. It appears to be very old.”* |
...
- Amaranthine and Chohe have exactly the same in\-game geography.
- Amaranthine's moon is the same asset as the one used to represent satellites on the skyboxes of Klensal, Ontarom, Eletania, Binthu, and Feros (original version of Mass Effect only).
- BioWare also used this name for the primary setting in the Awakening expansion for Dragon Age: Origins. It is a coastal region in the northeast part of Ferelden.
