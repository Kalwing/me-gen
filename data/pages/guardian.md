---
title: Guardian
url: https://masseffect.fandom.com/wiki/Guardian
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
- Guardians that are hit by Stasis from behind will drop their shields, making them vulnerable. The rank 6 Bubble evolution is highly recommended—it can hit multiple Guardians and works from any angle.
...
- Cryo Ammo or Cryo Rounds cannot freeze a Guardian still carrying its shield even if an unprotected area is hit, unless the Guardian is being hit from directly behind. In other words, shooting through the "mail slot" in the Guardian's shield, or hitting it in the foot cannot freeze a Guardian. Once the shield is dropped (which will happen if the Guardian freezes) this no longer applies.
