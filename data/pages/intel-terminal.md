...
url: https://masseffect.fandom.com/wiki/Intel_Terminal
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
All intel upgrades obtainable through Search and Rescue will have become accessible by the time Priority: Thessia has been completed. The rest of the upgrades can be obtained by finding them during missions and, in a few instances, by playing an imported game from Mass Effect 2 or Mass Effect 3 with certain conditions met. Intel upgrades will not carry over between Mass Effect 3 playthroughs with the same character (New Game\+) and must be earned again.
...
Location
The Prejek Paddlefish intel can be obtained by importing a Mass Effect 2 save file where Shepard purchased the Prejek Paddle Fish, and Kelly Chambers and Shepard's fish survived. Also, Kelly and Shepard must have had dinner together in Mass Effect 2 for Kelly to return in Mass Effect 3, though Kelly agreeing to feed Shepard's fish is not required. Upon meeting Kelly at the Citadel docks in Mass Effect 3, she will return Shepard's fish. If they survive until the game is completed and that save file is imported into a New Game\+, then the intel will be unlocked when reaching the Citadel after Priority: Mars. It can be acquired after returning to the Normandy SR\-2\.
