---
title: 'Epilogue: Home and Away'
url: https://masseffect.fandom.com/wiki/Epilogue:_Home_and_Away
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- If August Bradley is chosen as the ambassador and Moshae Sjefa is spoken with on Aya afterwards, she will speak as if she was chosen instead.\[*confirmation needed*]
...
- After the credits, you can access a terminal in their quarters with a large number of email messages from Initiative citizens, presumably those who had awoken from stasis pods. A number of them include in\-joke references to Bioware's *Dragon Age* franchise.
	- An e\-mail titled "A great story, Pathfinder" is sent by V. Tethras, saying that he is going to write a story about Pathfinder's journey. It is presumably taken from Varric Tethras, a storyteller and playable character in Dragon Age 2 and Dragon Age: Inquisition.
	- An e\-mail titled "Winners get razzberries!" is sent by R. Jenny \+ Widdle. R. Jenny is the anonymous name that Sera and other members her organization take. Widdle is Sera's affectionate nickname for Dagna if she romances her. Both are from Dragon Age: Inquisition.
	...
	- D. Sutherland (another name from Dragon Age: Inquisition) sends a thank you message titled "I'll make it matter." There is also an email from one of Sutherland's recruits, the elf Voth, written as "L. Voth."
	- Anders (named for a Grey Warden in Dragon Age) sends a greeting mail, "Happy Landing Day!" and invites the Pathfinder to blow up the roof off the place. This refers to a storyline in Dragon Age 2 involving Anders in which he blows up a Chantry building.
	- Other Dragon Age character names referenced in the Pathfinder's inbox include Aveline (written as A. Hendyr, referring to the fact the character married fellow guard Donnic Hendyr), Captain Isabela (written as Captain I., with her message stating that she'd allow Pathfinder to drive her boat anytime), Calpernia (written as C. Pernia) and Neve Gallus, listed simply as Neve in a thank you note.
	- Two e\-mails appear to be references to the Baldur's Gate series. One is from Alora, a halfling thief and possible party member in Baldur's Gate, and another one is from M. Fentan (likely Mazzy Fentan), a halfling fighter and possible party member in Baldur's Gate 2\.
...
- There is a note from Eric Camber saying "Thanks for picking up my slack. Jr. would have been amazed." referencing the plot of Task: What He Would Have Wanted.

Priority Ops Navigation

| ← Previous Mission | Mission Index | Next Mission → |
| --- | --- | --- |
| Meridian: The Way Home | Missions (Mass Effect: Andromeda) | The World is Waiting |
