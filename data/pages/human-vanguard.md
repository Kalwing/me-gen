---
title: Human Vanguard
url: https://masseffect.fandom.com/wiki/Human_Vanguard
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the multiplayer class in Mass Effect 3\. For the ex\-Cerberus human Vanguard class in Mass Effect 3, see Project Phoenix Vanguard.* *For the multiplayer class in Mass Effect: Andromeda, see Human Vanguard (Mass Effect: Andromeda).* |
| --- | --- |
...
| | **Barrier:** 500 / **Health:** 500 | | | --- | --- | | **Class: Alliance Training** | | | Biotic Charge |  | | Shockwave |  | | Nova |  | | Fitness |  | |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

## Melee and movement

|  | - **Regular Melee** – Punch 	- **Melee Sequence:** The Human Vanguard executes a series of up to three punches. - **Heavy Melee (Biotic Strike)** – The Human Vanguard strikes a target with a biotically\-charged fist. An unprotected foot soldier can be sent flying. - **Grab (Biotic Punch)** – The Human Vanguard drags an enemy over cover and then executes them with a charged biotic punch. |
| --- | --- |
|  | - **Dodge (Combat Roll)** – The Human Vanguard rolls to quickly evade incoming attacks. - The Human Vanguard can take cover, and can roll from cover to cover. |
...
- While one may choose to neglect Shockwave in favor of Charge and Nova, Shockwave is the only power that can be safely used from a distance (up to 24 meters) to knock enemies off their feet and detonate Power Combos, with potential bonus damage when detonating Biotic Explosions. Shockwave is also the Human Vanguard's only means of priming enemies for biotic combos through use of the Lifting Shockwave evolution. Detonating enemies lifted by the power generally must be done with Nova, as enemies are not suspended long enough for Charge to come off cooldown. Also, as enemies tend to fly up out of reach of Nova when hit by Lifting Shockwave, this works best where vertical space is confined (i.e. there is a ceiling).

### Cerberus

- Against Cerberus, the Human Vanguard's notorious Charge\-Nova tactic is nigh unstoppable. As most Cerberus troops can be staggered by biotic abilities, Charge\-Nova will rip through anything but an Atlas or Guardian. The rank 6 Pierce evolution on Nova will only devastate their infantry even more. However, beware of smoke, as it can prevent you from locking on to targets for Charge, severely hampering your play style; the Geth Scanner gear can be an invaluable tool for fighting through smoke.
...
- Atlases can instantly kill you if you are not careful, so it is preferable to attack them from behind. With that in mind, the Vanguard can effectively tank the Atlas, drawing their attention away from the rest of the squad.
...
- Nova can hit and stagger Geth Bombers even while they're flying higher. It's also an excellent tool for hitting invisible Hunters and revealing them so they can be locked on to with Charge.
...
- The Human Vanguard's Charge\-Nova tactic is very effective against most Reaper ground troops, though caution should be taken when facing a Brute or Ravager. Against these two enemies, constantly circling them while using Charge\-Nova is recommended.
	- Groups of Ravagers are difficult to damage with Nova due to the large numbers of Swarmers they produce, as Nova only damages up to 3 enemies per hit. Methods to eliminate the Swarmers quickly can include Power Combos, Explosive Rounds, or weapons that fire explosive rounds by default such as the Falcon assault rifle.
- Extreme caution (and possibly avoidance) should be taken around Banshees, as charging a Banshee will not cause them to stagger and will put you within range of their instantly killing Impale ability.
	- Should one decide to face the Banshees, do not charge them while they are glowing/teleporting. This applies to all Vanguards.
