---
title: Codex/Ships and Vehicles
url: https://masseffect.fandom.com/wiki/Codex/Ships_and_Vehicles
game: Mass Effect
type: tech
characters: []
scraped: '2026-08-28'
...
|  | Audio: Military Ship Classifications |
| --- | --- |
...
|  | Audio: Cyclonic Barrier Technology |
| --- | --- |
...
The Systems Alliance Space Vehicle Normandy is a prototype starship created as a joint human and turian venture. A frigate optimized for reconnaissance missions, the vessel uses state\-of\-the\-art stealth technology.
