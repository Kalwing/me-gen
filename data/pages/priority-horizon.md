...
Unlike the other Lawson daughter consoles, this one is mandatory viewing. Climb up the ladder Shepard just lowered after the vid. This is a point of no return, so you may want to **save here** before proceeding.
...
**Warning:**  It is fairly common for one of your two squadmates to fail to climb up the ladder into this area, making them unavailable for this fight. It's possible to unglitch them by moving forward into the area, but given the high threat level and close proximity of the enemies here, this is very unsafe. Your only other options are to either accept having only one teammate to assist, or to reload an earlier save and try going up the ladder again to see if you can avoid this glitch.
...
- Miranda always dies in a game that was not imported from Mass Effect 2\.
...
If Miranda survives this mission, she becomes fully available for further interactions in Mass Effect 3: Citadel, including being able to attend the party at its conclusion.

Conversations with Javik and EDI can also be had that can earn reputation, as well as the bonus powers Dark Channel and Decoy, respectively, if you didn't already have those unlocked.

## Rewards

*See also: Equipment Guide (Mass Effect 3\)*
- **Total credits**: 30,000
	- Credits found: 15,000 (in 7 pickups)
	- Alliance Funding: 15,000
- **Medi\-gels**: 10 units (in 4 pickups)
- **Weapons**: M\-99 Saber
- **Weapon mods**: Pistol Scope, M\-12 Locust, Shotgun Blade Attachment
- **Armor pieces**: Rosenkov Materials Shoulders
- **Morality**: none
...
- In the room where a banshee is trapped behind some glass, the only exit is a door that occasionally causes you harm when you try to access it. The only known fix so far is to restart the mission. To date, this bug has been confirmed for the PC, Playstation3, and Xbox 360 versions.
...
| --- | --- | --- |
| Priority: Thessia | Missions | Priority: Cerberus Headquarters |
