...
url: https://masseffect.fandom.com/wiki/Noveria:_Geth_Interest
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
As for suggestions on how to prepare for this mission, perhaps the best single piece of advice is as follows: bring Wrex. You'll be facing some tough opponents that can easily kill in one or two hits; your krogan teammate's ability to absorb punishment will almost certainly make things easier for you in many battles. Aside from that, it's advisable to bring a party that has the tech skills to allow you to access secured containers and maximize your loot, and biotics like Lift and Singularity can also be very useful throughout. Finally, if you don't have any medical upgrades for armor, you may consider waiting until you have at least one before undertaking this mission. You can always purchase some at Dr. Michel's med clinic on the Citadel.
...
At this point you can choose to cooperate and deescalate tensions, or refuse to hand over your guns; in the former case, again some of your squadmates have something to say about that. Two of the three decisions yield \+2 morality points in either direction.
...
When you reach the second landing and pass through some scanners, an alarm goes off. Parasini is there and tells you not to worry, since they are only weapons detectors. The sequence is inescapable; you'll have to talk to Parasini for the lay of the land (**Note:**  It's actually possible to talk to Parasini and *not* set off the alarms by standing at a small area below the nearest detector: her conversation interaction range extends up to there). She finally introduces herself as the administrative assistant to Administrator Anoleis, the chief of the port. If you wonder about the heavily\-armed nature of the place, Parasini explains it's for protecting the interests and privacy of Noveria's corporations, and you can offer your opinion on that.

To get things going, you have to ask about any unusual visitors. Parasini admits that Matriarch Benezia arrived recently and headed to Peak 15, but explains that Anoleis must approve any request to leave Port Hanshan if you want to follow. If you don't have Liara in your current party but she has joined your crew, one of your squadmates will recommend that you take her with you because of her familial relationship with Benezia. Otherwise, Liara herself figures you may want to talk about her mother, which raises the issue of whether Liara can be trusted to side with the team over her mother if it comes to it.
...
- Within the game's internal data, this mission (both as "Noveria: Geth Interest" and "Noveria: Leave Port Hanshan") is referred to as "(Noveria:) Leaving Hanshan Port".
...
| --- | --- | --- |
|  | Missions | Noveria: Matriarch Benezia |
