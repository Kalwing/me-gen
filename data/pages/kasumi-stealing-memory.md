---
title: 'Kasumi: Stealing Memory'
url: https://masseffect.fandom.com/wiki/Kasumi:_Stealing_Memory
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
**Graybox Preserved:** The heist was successful. Keiji Okuda's graybox was recovered and remains in Kasumi Goto's possession. Donovan Hock was killed in the destruction of his gunship. Kasumi is loyal.

**Graybox Destroyed:** The heist was successful. Keiji Okuda's graybox was recovered and all information contained within was destroyed. Donovan Hock was killed in the destruction of his gunship. Kasumi is loyal.
...
**Note:**  There is a cap of 60,000 credits that can be earned from Cerberus funding and credits found combined (this does **not** include salvaged medi\-gel or power cells). Even though the single credit chit in Hock's apartment does show up in your credit total after finding it, it won't be added to your post\-mission total if you found every other credit pickup possible on the mission.

## Trivia

- This mission was written by Jay Turner.
- The Creature statue is a reference to the Ogre monster found in Dragon Age: Origins, another BioWare game.
...
- Upon examining the head of the Statue of Liberty, Kasumi comments "Damn you, Hock!". This could be a reference to the 1968 film *Planet of the Apes*.
- The password to Hock's vault, "Peruggia", is the last name of the person who stole the Mona Lisa. Kasumi herself is known to have acquired the painting centuries later.
	- Coincidentally, Donovan Hock's voice actor says two Italian proper nouns that are homophones as two separate characters: first, the above\-mentioned reference to Vincenzo Peruggia; and second, when Kenneth Donnelly, also played by John Ullyatt, says he and Gabby served on the SSV Perugia (likely named after a city in Italy).
- Data files contain a rather thorough developer script of the mission's narrative progress and cutscenes.
...
- The DLC's text files contain many unused alternate versions of the mission's dialogues, among other things:
	...
	- During the gunship fight, Hock's taunts would have been more crude.
