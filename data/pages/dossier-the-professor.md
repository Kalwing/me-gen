...
url: https://masseffect.fandom.com/wiki/Dossier:_The_Professor
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
If he survives, Daniel (from the Omega clinic) sends Commander Shepard an email regarding the state of the clinic since Mordin joined Shepard.
...
- Unused plot data for this mission points to deleted combat sequences involving batarians or "hounds" (presumably varren). A "Collector log" is also mentioned, which may have detailed the deal between the Collectors and the vorcha gangs.
- Though it's not normally possible to experience them in\-game, the mission's numerous squadmate reactions account for the presence of Thane, Samara, Tali and Legion. In the released game, neither of them can be recruited by the time this mission can be undertaken. Before entering the slums, Samara and Thane ask whether they should really come along due to the virus, while Legion and Tali mention they won't be affected by it. When applying the cure, Mordin mentions asari are very susceptible and Samara would have died quickly, and in regards to Thane, he remarks his vaccine is untested due to the rarity of drell.
- An unused name tag for the turian mercenaries at the start of the mission is labeled "Talon Merc".
- A few refugee comments at the clinic were left unused.
