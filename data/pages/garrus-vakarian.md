...
If Shepard recruits Wrex first, Garrus will come to Shepard requesting to join the team later, but the Med Clinic encounter will still be available. It is possible for Shepard to refuse Garrus' request and bring Saren to justice without ever recruiting him. If he does join the mission to stop Saren, Garrus has no qualms about hunting a fellow turian, seeing Saren's actions as a disgrace to their species.
...
Although Ashley is initially suspicious of Garrus, he tends to get along well with the rest of the crew, enjoying the chance to get off the Citadel and see how things are done outside C\-Sec. He is surprised by Wrex, stating that he thought all krogan were bloodthirsty thugs, prompting Wrex to retort: "The genophage is a lot easier to swallow when all krogan are savage monsters isn't it? Why don't you head back to the Normandy, kid – if you stay here in the real world, you might have to learn something."
...
If someone in the group starts reciting from the periodic table of the elements, he sarcastically comments how turian parties almost never end up with something like that happening. At the mention of "element 69", the humans in the group snicker while Garrus takes the time to remind them it's thulium.
...
- Mac Walters wrote Garrus in the first game. For Mass Effect 2, Trick Weekes wrote most of his conversations on the Normandy while Mac Walters wrote his recruitment and loyalty missions. John Dombrow was the main writer for Garrus in Mass Effect 3\.
...
- There is a bug on the original PC version of Mass Effect where even on Ultra\-High detail, the texture of Garrus' face is remarkably low quality. This was known by the developers of the game, who have said that due to the way the game is made, it would require a multi\-gigabyte patch to fix. It can be mitigated, however, by modifying the BIOEngine.ini file in the game's install directory. This is one of many graphical aspects to have been fully resolved in Mass Effect Legendary Edition.
...
- Early promotional screenshots for the first Mass Effect show Garrus would originally be able to wear heavy turian armor; however, this was scrapped later during development. In the sequels, heavy\-looking turian armor is his default outfit.
...
- Writer Trick Weekes pegs Garrus Vakarian's age at 2\-4 years younger than Shepard.
- Garrus was not originally intended to be romanceable. Fan feedback for the first Mass Effect game allowed him to become an option for female Shepards.
...
- In an early development document for Mass Effect 2, the squadmate pitch for "Garrus the Bounty Hunter" had him going after Dr. Saleon's accomplices on Omega, cutting through local gangs in the process. A further developed narrative concept nailed down the story of his ill\-fated vigilante group, though they were fewer at this point ("6 or less").
...
- Mass Effect 2 Character Concepts\#19\. Garrus the Bounty Hunter
- Mass Effect 2 Character Concepts\#The Rebel General (Garrus)
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Garrus Vakarian
- The Art of the Mass Effect Trilogy/Mass Effect 3\#Garrus Vakarian
