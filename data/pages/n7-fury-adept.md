---
title: N7 Fury Adept
url: https://masseffect.fandom.com/wiki/N7_Fury_Adept
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
| | **Barrier:** 500 / **Health:** 500 | | | --- | --- | | **Class: N7 Fury** | | | Throw |  | | Annihilation Field |  | | Dark Channel |  | | Fitness |  | |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

## Melee and movement

|  | - **Regular Melee** – Punch 	- **Melee Sequence:** The N7 Fury executes a continuous series of punches and kicks. - **Heavy Melee (Biotic Strike)** – The N7 Fury teleports a short distance forward before releasing a powerful biotic burst at the expense of barrier strength. - **Grab (Biotic Punch)** – The N7 Fury Adept drags an enemy over cover and then executes them with a charged biotic punch. |
| --- | --- |
|  | - **Dodge (Acrobatics)** – The N7 Fury Adept flips and teleports a short distance at the expense of barrier strength. - The N7 Fury Adept can take cover, and can roll from cover to cover. |
...
- In order to maximize the combo potential, it is vital to go full 6 ranks into Annihilation Field and Throw.
- Movement speed is a precious asset for the Fury. Adrenaline Module and the movement speed evolution of Annihilation Field help to reach crazy maximum velocity, allowing to run to the enemies and kill them before they are able to complete the process of gaining accuracy against the player.
...
- The Fury has a very strong combo detonation potential and a very strong priming potential at short range, but little priming potential at further ranges. As such, Furies are usually better left undisturbed when fighting at short range but supplied with priming when fighting from afar.
	- Spamming biotic detonators in the close proximity of a Fury is usually acceptable, however; Cluster Grenade is particularly useful.
