---
title: 'UNC: Listening Post Alpha'
url: https://masseffect.fandom.com/wiki/UNC:_Listening_Post_Alpha
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
Note that the left room has an angled tunnel and jump, stopping the rachni from leaving the room, allowing you to fight from the main room and use the walls as cover. The right room is flat; rachni and the Brood Warrior will charge towards you. Run in, pull the rachni out, and find some sort of cover/obstruction to stop them from going into melee.
...
- This assignment is referred to as "Rachni Rebirth: Listening Post Alpha" within the game's internal data.
...
| --- | --- | --- |
|  | Assignments | UNC: Listening Post Theta |
