---
title: 'Citadel Arena: Unusual Scores'
url: https://masseffect.fandom.com/wiki/Citadel_Arena:_Unusual_Scores
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
It looks like they haven't fixed anything at all, and have, in fact, made it worse! The map is filled with incomplete digital artifacts and text reading "Fatal Error," the announcer sounds strange, and the enemies that appear aren't geth at all—they're super\-elite level Collectors. The next wave is super\-elite level geth, then Cerberus, Reapers, and finally, a combination of all high\-level boss enemies: Banshees, Praetorians, Geth Primes, and Atlases all in a single wave. You might find yourself reminiscent about Mass Effect 3 Multiplayer's Platinum difficulty, if you've played it. If your health and shields fall to zero, it will result in a **Critical Mission Failure** instead of the normal failed simulations which are not life\-threatening.

**Note:**  Enemies can sometimes spawn high in the air and remain stuck there, and if this happens it can be a huge pain as those enemies have easy angles to hit you no matter where you try to hide. If you notice you're taking an especially heavy beating, look skyward. Reloading a save and trying the fight again may prevent this from occurring.
