...
url: https://masseffect.fandom.com/wiki/Citadel:_Jahleed's_Fears
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- Hear the volus at the precinct
- Point guns with the salarian at the market
1/2You met a volus scientist named Jahleed. He's in the C\-Sec offices and refuses to leave for fear that his life is in danger. He claims that his colleague, a salarian named Chorban, is trying to kill him. The details are a bit vague.
...
There are two paths to this assignment, depending on whether you have talked to Chorban already, and accepted the Citadel: Scan the Keepers assignment. Talking to Chorban first gives more insight on what the partners were doing. The assignment can yield a fair amount of morality points depending on which assignment is started first; Scan the Keepers must have been started first in order to get the maximum amount of Paragon points from this assignment, while starting Jahleed's Fears first is required to get the maximum amount of Renegade points.

### Finding Jahleed

Jahleed can be found in the C\-Sec offices. When facing the elevator to the docking bay, follow the hallway to the right, and he will be in a small alcove talking to a C\-Sec Officer. Walk up to the volus and accept his assignment. He thinks his business associate Chorban is plotting to kill him, and wants you to meet with Chorban in the lower markets.
...
- There is a typo in the journal, reading "C***ti***adel: Jahleed and Chorban" instead of "C***it***adel: Jahleed and Chorban."
