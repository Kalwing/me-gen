---
title: 'UNC: Cerberus'
url: https://masseffect.fandom.com/wiki/UNC:_Cerberus
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
*“You check for a pulse but find none. Admiral Kahoku is dead.
...
- Text and subtitles misspell Kahoku's name as K**o**h**a**ku in the original version of Mass Effect. The error has been rectified in Mass Effect Legendary Edition.
- After clearing the final facility of enemies, a squadmate may make a comment mentioning Kahoku's death, even though you haven't yet interacted with his body on the ground to confirm that he is, in fact, dead.
...
- This assignment is referred to as "Cerberus: Research Colony" within the game's internal data.
...
| --- | --- | --- |
| UNC: Missing Marines | Assignments | UNC: Hades' Dogs |
