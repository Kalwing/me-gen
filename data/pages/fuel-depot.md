---
title: Fuel Depot
url: https://masseffect.fandom.com/wiki/Fuel_Depot
game: Mass Effect 3
type: location
characters: []
scraped: '2026-08-28'
...
Fuel costs 1 credit per unit to restore at a fuel depot, with a minimum cost of 25 credits to start refueling, even if the Normandy is less than 25 units of fuel away from fully fueled. Hitting the refuel button while the Normandy SR\-2 is at a depot's location on the Galaxy Map will start a continuous refueling that restores fuel in 25 unit increments until the ship is fully refueled. Once started, the only ways to cancel refueling early are to fly the ship away from the depot or to leave the Galaxy Map entirely (e.g. by hitting ESCAPE on PC).

**Note:**  On the Xbox 360, the refueling button must be held down to refuel continuously; tapping refuel lightly will restore only 25 units of fuel.
