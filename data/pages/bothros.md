---
title: Bothros
url: https://masseffect.fandom.com/wiki/Bothros
game: Mass Effect 3
type: location
characters: []
scraped: '2026-08-28'
...
**Location:** Milky Way / Hades Nexus / Hekate System /  **Third planet**
...
| --- | --- | --- |
| Palladium | Medium | 6,890 |
| Platinum | High | 16,935 |
| Iridium | Medium | 6,122 |
| Element Zero | Low | 1,752 |

## Trivia

- Bothros is an Ancient Greek word that means "hole", "pit", or "trench".
- The planet in the same system which the Bothros description refers to, Asteria, is not present in Mass Effect 2. This is fixed in Mass Effect 3 where Asteria does exist.
