...
url: https://masseffect.fandom.com/wiki/Prologue:_Find_the_Beacon
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- The farms of Eden Prime
- The spaceport tram
1/2You are in charge of the ground team dropped onto Eden Prime, an Alliance colony under attack. Your primary goal is to find and secure the Prothean beacon.
...
You regain control at this stage—once the geth attackers are down, approach the soldier and talk to her.

**Note:**  If you held off from investigating Jenkins' corpse earlier, the last opportunity to do it will be before talking to the rescued soldier. Afterward, Jenkins' body can no longer be interacted with.
...
Before you leave, grab the crate and upgrade kit to the right. The crate contains the Scorpion light armor, which has better stats than the default Onyx armor and is thus probably worth equipping on someone. The upgrade kit contains some random loot. Once you have everything, head out and be prepared.
...
The exterior of the spaceport has a few Husks, and some Geth Troopers are defending this position. The Husks will rush you while the Troopers will stay at a distance. At the top of the stairs is another containment cell; if you hit it at the right time you can eliminate the Troopers before they are a threat. Once they are down, destroy the Husks that are preparing to swarm you. Use Kaidan's Throw to help with the overwhelming part, and otherwise keep backing up while firing at the Husks. Once they're down, head to the left and access a malfunctioning object for some loot. There is also a crate outside another shack. Bypass the lock to meet some farmers, though you may wish to make a quick save before doing so just in case the ensuing conversation doesn't go the way you'd like.

A farmer named Cole and two of his friends exit saying they are not armed. You can ask Cole some questions about the attack and the ship you just saw. Before you leave, one of the other farmers asks Cole to give you some loot. Apparently, there was a smuggling ring and the farmers were making some illicit cash by hiding stolen goods in their sheds. Respond to that any way you wish. If you have at least one point in Charm or Intimidate, you can use a persuasion dialogue option on the left (blue for Paragon or red for Renegade) to pry some more information out of Cole; apparently, he had a contact at the spaceport who was also a member of the smuggling operation.

Ashley demands the name of the contact, but Cole demurs, not wanting to get him into trouble. If you have at least two points in Charm or Intimidate, this gives you the option to threaten or cajole the name out of Cole. Along with the name ("Powell"), using the persuasion options also rewards you with some morality points. After your conversation ends, you will be awarded the pistol Cole said he found, regardless of any other outcomes of your talk with him. Note that this pistol, a Stinger II model from Devlon Industries, is an above\-average weapon compared to anything else you might find this early in the game, if this is your first time playing with your current character.

**Note:**  Even though you can talk with Cole again once your initial conversation is over, you'll only be able to use the "investigate" options to ask about the geth attack, the Prothean beacon, and the hostile ship. If you didn't or couldn't use the persuasion dialogue choices discussed above, you won't get another chance.

Once you are done talking with the farmers, head into the shack for a storage locker. This locker requires Electronics to unlock; even a single point in Kaidan's or Shepard's Electronics talent (if you have it) is enough to bypass the locker. If you don't have the score now, you will probably level up once more before moving on to the next area, so you can come back for the locker later.

Head up to the platform where you can see a body; unfortunately, it is Nihlus. Before you investigate his body, head to a fire in the corner because it isolates an upgrade kit in it. **Going into the fire can kill you very quickly**, but it's possible to grab the upgrade kit without doing so. Once you have it, there is a medical kit on the ground near the steps, so grab it if you need it. Then investigate Nihlus' body.

Ashley immediately notices someone moving behind the crates. Everyone pulls their pistols, but it is just a dockworker. He introduces himself as Powell, a name you'll recognize if you got Cole to reveal it earlier. You can ask him the same questions as you did the farmers, though he will give slightly different answers. If you managed to persuade Cole to mention Powell's name, you will have the option to ask Powell about the smuggling ring, at which point he will say that it doesn't matter anymore. Press him and he will say that no one misses a few pieces from the military orders. Ashley presses him for the grenades and he hands them over. You can use Paragon or Renegade dialogue options to get a High Explosive grenade upgrade out of him (requires 3 Charm or Intimidate, respectively, though only the Renegade dialogue choice rewards you with morality points).
...
Once the troopers are down, **DO NOT** investigate the beacon yet if you aren't ready to end the mission. There is a crate and a storage locker on the main platform, a wall safe to the far left, and a technician kit on the far right, when looking at the beacon. Note that there is a brief but easy\-to\-miss cutscene where your team observes the burning crater where the hostile ship landed; this triggers if you walk up to the middle of the fence posts behind the beacon and next to the crate (i.e. in between the beacon and the crate). Once you are ready, investigate the beacon and a final cutscene will start.

Shepard radios the Normandy for pickup while Kaidan and Ashley investigate the beacon. The person who is the same gender as Shepard will then go to talk to the Commander, while the other investigates the beacon. Without warning, the beacon activates and starts pulling the nearby squad member towards it; Shepard notices, runs up and grabs them, throwing them bodily to one side. Shepard is lifted up by the beacon instead, and a scene showing disjointed chaotic images plays, while the third squad member prevents the one Shepard saved from going back to help the Commander. Finally, the beacon explodes and Shepard falls to the deck, unconscious.

The scene switches to the massive enemy ship gliding through space. Inside its dark metallic interior, Saren sits alone at a command chair. Then, a tall asari dressed in black approaches and coughs lightly to announce her presence. She informs the turian that the attempt to destroy the Eden Prime colony was foiled by a team from an Alliance warship under the command of Captain Anderson. Saren asks her about the Prothean beacon, and the asari admits that one of the humans may have used it. The interior of the ship begins flashing red, and Saren flies into an uncontrollable rage. The scene ends as he growls at the asari that the human must be eliminated.
...
- On the Normandy right after the player gains control of Shepard, a musical theme is playing that isn't heard at any other point in the game; this theme will not play again if the player makes and reloads a save. This theme is one of several that is not included in the game's original official soundtrack release.
...
- During development, the attack on Eden Prime was originally meant to look less devastating than in the final release. The weather would have been clearer and the environments greener as Shepard battles the geth, until BioWare decided the attack needed to look truly harrowing.
- Various cut voicelines and developer insights imply additional conversations and events could have occurred during this mission:
	- In the Normandy mess hall, Shepard and Dr. Chakwas could witness Kaidan's biotics demonstration where he lightly hurt Jenkins in annoyance. While one data source implies Jenkins himself was tossed, a left\-over animation file clearly shows Kaidan throwing a cup at Jenkins. Dr. Chakwas in Mass Effect 2 references a similar scene, though it differs in that Kaidan tossed Jenkins to the latter's amusement. In addition, it was possible for Shepard to go down to the cargo hold and engine room, to which Adams would remark that it's unusual to see officers down there.
	- During the cutscene where Jenkins is shot, just before that happens, Shepard would have vocally given him the order to take point.
	- Shepard's interaction with Manuel would have had different ramifications. You could offer to help him, or refuse to. A grenade is also mentioned, which could detonate or be disarmed. It was also possible, somehow, to "heal" Manuel.
	- After passing the sheds, the path to the spaceport apparently would lead through agricultural fields and installations. Kaidan and Ashley would comment on the surroundings, offering information on Eden Prime farming and agriculture, and suggesting to use different tactics, like hacking an immobilized M35 Mako to use its guns, bringing down the aeroculture on the geth, or starting a disabled crop harvester to clear out the geth. Ashley also remarks on some local farming animals called "hexacows", which is an internal data name for the space cow.
	- Approaching the spaceport, the squad would come across a number of dead bodies. From the conversation with Cole, they conclude it must have been his friends who didn't make it to the garage.
	- A combat sequence was planned on top of the moving train, but it was scrapped due to numerous technical issues.
...
- The Art of Mass Effect/Alien Worlds\#Eden Prime
- Bonus Content Disc/Environments: Eden Prime
