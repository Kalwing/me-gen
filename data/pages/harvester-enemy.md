---
title: Harvester (enemy)
url: https://masseffect.fandom.com/wiki/Harvester_(enemy)
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the enemy in Mass Effect 3 called Harvester. For the page about Harvesters in general, see Harvester.* |
| --- | --- |

**Harvesters** are aerial synthetic\-organic creatures derived from creatures of the same name that have been mutated by Reaper technology, often used for air superiority in the atmosphere of a planet. Synthetic Harvesters were first introduced in Mass Effect 3.
...
Defensive
Harvesters only have armor and no barriers or shields. They do not suffer bonus damage from hits to their head or any other part of their body, including the large blue disc on their chest area.
