---
title: Ashley Williams/Unique dialogue
url: https://masseffect.fandom.com/wiki/Ashley_Williams/Unique_dialogue
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
- On the Citadel:
	...
	- During the Citadel: Signal Tracking assignment, when Shepard asks the AI if the matter can be resolved peacefully Ashley vehemently disagrees if the other squadmate is anyone else but Tali: "What are you, crazy? It’s an AI, like the Geth, it would kill us all if it could!"
...
- Eden Prime:
	- "We thought this world was safe… until the geth showed up."
...
- Therum exterior surface:
	- "Like an oven here."
	- "I think my eyeballs are dried out."
- Noveria:
	- Inside Port Hanshan:
		- "Rock gardens and waterfalls. Very Zen."
		- "Why would they have so many windows if all they see outside is snow?"
	- Outside Port Hanshan:
		- "Just like winter back home."
		- "Nobody lick any poles."
		- "All this for one damned asari."

- Feros:
	- Zhu's Hope:
		- "Nice place to visit, but I wouldn't want to live here. Scratch that; it's not a nice place to visit."
		- "Gotta give these colonists credit; they don't give up easy."
	- Prothean skyway:
		- "Too much cover here."
		- "I bet this place was pretty impressive back in the day."
	- ExoGeni facility: "I think this situation falls under the 'shoot on sight' category."
	- Thorian:
		- "If it's slimy and moving, shoot it."
		- "Smells like compost. Rotten compost."

- Virmire:
	- Salarian camp:
		- "I don't like the looks Wrex keeps throwing at you. Watch yourself."
		- "I hope these salarians can fight."
		- "If you need my help dealing with Wrex, just let me know."
		- "It won't be an easy fight, but we're ready when you are."
		- (Wrex lives) "Just say the word. I'm ready to go."
		- (Wrex lives) "Nice job with Wrex. He's totally changed his attitude."
		- (Wrex dies) "I'd rather have Wrex on our side, but he chose his path."
		- (Wrex dies) "I'm ready when you are, Commander."
	- On approach to Saren's base: "Nothing like a nice, relaxing stroll on the beach… blasting bad guys with my boomstick!"
	- Inside Saren's base:
		- "Let's clear this place out."
		- "I hope we can count on those salarians."

- Ilos:
	- "I wouldn't touch anything."
	- "Feels like we're being watched. And not by the geth."
	- "Let's just find the Conduit and get the hell off this world."

- Final Battle
	- Citadel exterior: "Damn geth have us at a disadvantage, Commander. Synthetic bastards don't even need space suits out here."
	- Presidium/Council Chambers:
		- "Time for payback!"
		- "Saren can't run any more."
...
- On Eden Prime:
	- After the first Husk encounter, Ashley will note that the security lock is engaged on the shed where Warren and Manuel are hiding.
	- After securing the Prothean beacon, when surveying the devastated area in the distance, Ashley exclaims it looks like someone "dropped a bomb". Kaidan surmises that it's likely where the unidentified ship landed.
- On the Citadel:
	...
	- After speaking to Harkin about where to find Garrus Vakarian, as the squad leaves Chora's Den Ashley wonders aloud why Captain Anderson never told them he used to be a Spectre. Kaidan responds that Harkin's claim might not be true given his questionable character.
...
- On Therum:
	- Inside Prothean ruins by the first elevator: "Dare you to spit over the side."
...
- During Kallini: Ardat\-Yakshi Monastery:
	...
	- After interacting with the dead commando by a bomb, Ashley comments that the fighting before they arrived must have been very chaotic. If James is present, he asks "LC" if she's sad she missed the party, Ashley responds affirmatively, saying they could have used extra support.
...
- During Priority: Cerberus Headquarters:
	...
	- When encountering the remains of the Human Proto\-Reaper, Ashley will initially be confused by it stating "Is that…?" until EDI explains it. After which Ashley will comment that "I wish I'd been there." If romanced Shepard will reply "You're here now."
