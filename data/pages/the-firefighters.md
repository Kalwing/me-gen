...
url: https://masseffect.fandom.com/wiki/The_Firefighters
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
Use the scanner to search the building. If you haven't been quick enough drawing your scanner, the alarm will be triggered even before you get to scan all three clues (EMP device, quantum computer blue box schematics and Nexus' computer network) and use Knight's personal terminal.
...
- On the other hand, if you helped her son Alain or were able to escape detection at her base then it's possible to talk her down.
