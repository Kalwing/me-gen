...
Unlike most Cerberus operatives on\-board the Normandy, both Kenneth and his friend Gabriella seem almost entirely ignorant of the "terrorist" operations that the organization engages in. If Shepard asks about why Kenneth joined Cerberus, he replies that he joined to "kick the Collectors right in the daddy\-bags."
...
- In Mass Effect 3, both he and Gabby were originally meant to be recruited at the Purgatory Bar, where they are happy to see Shepard made it off Earth alive and admit to be serving with Cerberus only because of the Commander. They quickly agree to follow. However, if Gabby is dead, Ken is instead found drowning his sorrows, blaming himself for her death and regretting having never told her how he felt. Shepard is only able to recruit him saying drinking himself to death would be a dishonor to Gabby's sacrifice.
- According to developer posts on the BioWare Forums, Donnelly was originally meant to be a 'light' romance.
- Being a Scottish engineer, Donnelly is commonly thought to be a reference to Scotty from the *Star Trek* franchise. However, according to lead level designer Dusty Everman, the "homage" was purely accidental, and their resemblance only came to light after voiceover recording had begun.
- According to Dusty Everman from BioWare, a programming error in Mass Effect 3 causes the banter and argument between Ken and Gabby only to occur if Shepard is "good friends with Ashley," meaning that the player must frequently converse with Ashley and take her out on several missions to hear the two banter back and forth. If Ashley is dead, the banter cannot be activated. This error is fixed by installing Mass Effect 3: Extended Cut.
- In addition to also playing Donovan Hock, John Ullyatt portrays Faryn in Dragon Age: Origins.
- In an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file, Donnelly's name is on the Normandy's memorial wall, indicating he did not survive the suicide mission.
