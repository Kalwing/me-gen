---
title: Kett Vakarsh
url: https://masseffect.fandom.com/wiki/Kett_Vakarsh
game: Mass Effect
type: tech
characters: []
scraped: '2026-08-28'
...
The **Kett Vakarsh** is a melee weapon in Mass Effect: Andromeda.
...
The Kett Vakarsh is a mid\-tier melee weapon that is able to prime enemies for a Fire Combo . It is swung horizontally in a spinning move, which enables it to hit multiple targets around the wielder, making it useful for crowd control purposes.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Melee Damage | 300 | 340 | 380 | 420 | 460 | 500 | 540 | 580 | 620 | 660 |
| Burn Damage(Per Second) | 110 | 144 | 139 | 154 | 168 | 183 | 198 | 212 | 227 | 242 |

## Development

| Rank | Research Cost | Kett Alloy | Copper | Cadmium | Element Zero | Augmentation Slots |
| --- | --- | --- | --- | --- | --- | --- |
