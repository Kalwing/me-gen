---
title: Geth Prime
url: https://masseffect.fandom.com/wiki/Geth_Prime
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
Defensive
Geth Primes have high shields, armor and health but do not seek cover. Primes take additional damage from headshots, but their headshot area is located above their "flashlight". Their weapon is also vulnerable to the overheating effects of Overload and Disruptor Ammo when unprotected. Flashbang Grenade has no effect on Primes whatsoever other than the damage it deals.
...
- Once their defenses have been stripped, Primes are vulnerable to being knocked down by most physics\-based powers or frozen just like most other enemies.
	- M\-100 Grenade Launcher shots don't possess enough force to knock unprotected Primes off their feet, though force\-based powers like Throw, Concussive Shot, Pull, Shadow Strike, Shockwave, and Singularity do (though not Flashbang Grenade).
	- While protected, Geth Primes are immune to the continuous stunning effects of both Singularity and M\-490 Blackstorm shots. Shockwave also will not stun them while protected.
...
- Decoy, Combat Drone, and Sentry Turret can all draw fire from Primes and their own turrets and drones, but they must be resummoned often to maintain the distraction.
