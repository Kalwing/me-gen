---
title: Volus Protector Vanguard
url: https://masseffect.fandom.com/wiki/Volus_Protector_Vanguard
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
| | **Barrier:** 500 / **Health:** 150 | | | --- | --- | | **Class: Volus Training** | | | Biotic Charge |  | | Biotic Orbs |  | | Shield Boost |  | | Fitness |  | |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

## Melee and movement

|  | - **Regular Melee** – The Volus Protector cloaks to avoid enemy detection. - **Heavy Melee (Defensive Stance)** – The Volus Protector Vanguard becomes stationary and generates a protective shield sphere that damages nearby enemies. Each activation pulse confers brief invulnerability to damage and restores a small amount of shields. - **Grab** – The Volus Protector Vanguard is unable to perform a grab. |
| --- | --- |
