---
title: 'Mordin: Old Blood'
url: https://masseffect.fandom.com/wiki/Mordin:_Old_Blood
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
The next room will contain a Clan Weyrloc Speaker. He just wants you to go away. During his (otherwise very long) speech there'll be a Renegade interrupt. While the clanspeaker is monologuing about the "grand plans" that Clan Weyrloc have for the galaxy after curing the genophage (which includes sending the Citadel "into the sun" and keeping salarians as slaves), Shepard can cut it short by shooting at the pipe with the flammable gas below the Clanspeaker. The Clanspeaker first laughs at the human's inability to shoot straight, but Shepard's second shot detonates the leaked gas and incinerates the Clanspeaker. If you don't take the interrupt, be prepared for a slightly harder fight. Once the conversation ends, take cover and shoot the enemies on the upper level. The krogan will charge down the ramps down to get to you while vorcha hang back and provide covering fire.

**Combat Strategy:** From Shepard's initial cover position it is quite difficult to successfully target the enemies up on top of the ramp, yet you are very much exposed to their fire. Therefore move to your left and take cover where you can instead get clear shots at them as they emerge from the bottom of the ramp. Strip the armor from each krogan in turn, knock them down with powers, use Incinerate to stop their regeneration, and then take them out.

**Tip:** On higher difficulties this fight can be hairy due to the amount of enemies, your low ground position, and the fact that several krogan will be closing on you while some vorcha pin you down. A good way to make it easier is to have the M\-622 Avalanche as your heavy weapon option. First, have the Avalanche selected *before* you enter the room and trigger the cutscene. Right at the start of the fight after the cutscene ends, fire a volley of 4\-6 shots at the upper level where all of the enemies are grouped up outside a door. This will severely damage all opponents and should freeze the vorcha and knock them out of the fight until you've dealt with the krogan. The arcing shots of the Avalanche plus its large area of effect make it ideal for attacking enemies on higher ground; if you can't hit them directly it's enough that you land shots on the walls near them.

When the combat is done, pick up the iridium (\+300 iridium) and the medi\-gel before moving up the ramps. Move across the upper level and through the door that the speaker came out of. Around the corner and through another door are circuit boards that you can salvage (\+3,000 credits). This area seems to be some type of laboratory, judging by the equipment and the dead krogan female in the room to the left. The room to the right will contain some more iridium (\+500 iridium) and a terminal. Accessing the terminal will help to get Mordin’s tongue a little looser about his role in the genophage update project. Once you have the information you need, end the conversation.
...
- Maelon's data is not saved in an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file.
