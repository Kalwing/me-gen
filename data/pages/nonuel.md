---
title: Nonuel
url: https://masseffect.fandom.com/wiki/Nonuel
game: Mass Effect 3
type: location
characters: []
scraped: '2026-08-28'
...
**Location:** Milky Way / Hades Gamma / Plutus System /  **Fourth planet**
...
| 2 | Initial | Crashed probe (salvage: High Electronics) |
| 3 | Initial | Mercenary outpost (UNC: Asari Writings, UNC: Locate Signs of Battle, salvage) *Judging by the footprints in the ash, the two mercenaries were facing each other over the crate when they died. Both suffered single gunshot wounds and have a rifle close beside them.* *Prying open the crate, you discover a carefully wrapped, handwritten copy of one of Matriarch Dilinaga's treatises. It is unlikely she penned it herself, but the flowing brushwork and intricate watercolor illustrations clearly show the hand of a master scribe.* *This mercenary was carrying a League of One medallion. There's no indication of how or where he found it.* |
| 4 | Unmarked | Thresher Maw |
...
Nonuel's terrain features streams of lava that could incinerate even vehicles like the Mako. The titanium deposit at the northern end of the traversable map and both thresher maw encounters are outside of mission boundaries; they can still be dealt with but not without some nagging to turn back from Joker.
...
- If viewed in Mass Effect 3, the planet appears to be entirely blue and covered by water. This seems to conflict with the in\-game description of the planet as an uninhabitable volcanic world.
- In Mass Effect Legendary Edition lava hazards were ostensibly changed so that touching them in the M35 Mako would not cause instant death as it did in the original Mass Effect. For whatever reason, the lava lake on Nonuel still causes instant Game Over if driven into, though lightly grazing it with the wheels or edge of the vehicle is sometimes possible without taking any damage.

## Bug

- The surveyed deposit of samarium can be seen on the small radar but may fail to register on the larger map.
