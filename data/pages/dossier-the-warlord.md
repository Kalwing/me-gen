...
url: https://masseffect.fandom.com/wiki/Dossier:_The_Warlord
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
- This mission was written by Lukas Kristjanson, taking over after a first pass by Brian Kindregan.
...
- Unused data for an earlier iteration of this level appears to mention fighting with snipers and "beasts" in trenches, a "spider lair", a character named Nekor, Collectors arriving during the mission, and choosing whether to release or kill a scientist.
- Though it's not normally possible to experience them in\-game, the mission's numerous squadmate reactions account for the presence of Thane, Samara, Tali and Legion. In the released game, neither of them can be recruited by the time this mission can be undertaken.
- An option to summarily execute the wounded merc at the beginning of the mission was removed from the game.
