---
title: Barrier
url: https://masseffect.fandom.com/wiki/Barrier
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the biotic ability Barrier in Mass Effect, Mass Effect 2, and Mass Effect 3\. For the Barrier skill in Mass Effect: Andromeda, see Barrier (skill).* |
| --- | --- |
...
| *Blast Effect* Increase damage, force, and radius of the detonation by 30%. - **Recharge Speed:** 8 sec - **Damage Reduction:** 15% (25% multiplayer) - **Blast Damage:** 162 (900 multiplayer) - **Blast Radius:** 5\.40 m | *Barrier Strength* Decrease damage taken by 5%. - **Recharge Speed:** 8 sec - **Damage Reduction:** 20% (30% multiplayer) - **Blast Damage:** 135 (750 multiplayer) - **Blast Radius:** 4\.50 m |
| --- | --- |

#### Rank 5: Shield Recharge/Power Synergy

| *Shield Recharge* Increase shield regeneration rate by 15% while Barrier is active. | *Power Synergy* Increase damage and force by 25% (30% multiplayer) while Barrier is active. |
| --- | --- |

#### Rank 6: Power Recharge/Barrier Strength

| *Power Recharge* Reduce power speed penalty by 30%. | *Barrier Strength* Increase damage protection by 10%. - **Recharge Speed:** 8 sec - **Damage Reduction:** 25% (35% multiplayer) \[Blast Effect], 30% (40% multiplayer) \[Barrier Strength] - **Blast Damage:** 162 (900 multiplayer) \[Blast Effect], 135 (750 multiplayer) \[Barrier Strength] - **Blast Radius:** 5\.40 m (Blast Effect), 4\.50 m (Barrier Strength) |
| --- | --- |

### Player Notes

Mechanics
- Much like with Tech Armor, the damage protection from Barrier applies to both health and shields, and remains in effect even when shields break. The damage protection bonus of Barrier can stack with additional powers such as Tech Armor and Reave.
...
- The power use penalty at rank 1 Barrier is **not** 60% (50% multiplayer) overall reduction to power recharge speed, but a 60% (50% multiplayer) points reduction of the Power Recharge Speed bonus visible in the weapon loadout screen. In other words, it functions like a weapon weight penalty.
	- For example, if you have \+200% Power Recharge Speed bonus when looking at the weapons screen, activating rank 1 Barrier reduces that Power Recharge Speed to \+140% (\+150% multiplayer).
...
- The rank 5 Power Synergy evolution improves the damage of *all* powers, not just tech powers like the similar evolution of Defense Matrix. However, this does *not* include ammo power damage, including the damage of the Explosive Burst evolution of Incendiary Ammo in single\-player (which, it is worth noting, *is* improved by the Power Synergy evolution of Fortification).
- **Detonation:** Similar to Tech Armor, Barrier can be detonated, creating an omnidirectional blast wave centered on the user and causing powers to go on cooldown.
	- Detonation terminates any passive benefits or penalties from having Barrier active until it is reactivated, which does not cause powers to go on cooldown.
	- Barrier's detonation deals 1\.5x damage to barriers. The blast is much more damaging in multiplayer.
	- The detonation of Barrier can hit a maximum of 3 targets, unlike Tech Armor, which has no target cap.
	- Detonation of Barrier is instantaneous, but there is a brief animation of the user throwing their head backwards.
	- Unlike the detonation of Tech Armor, blast damage from detonating Barrier will **not** go through walls and cover.
	- As with most biotic powers, only unprotected red bar foot soldiers can be lifted by Barrier detonations; the force component of the blast usually ends up sending lifted enemies flying as well. The lift duration lasts only a few seconds but does serve as a "primer" for Biotic Explosions that can be detonated by follow\-up biotic powers such as Throw. Lighter protected opponents will not be lifted, but they take damage and are usually staggered.

Strategies
- A character with the rank 5 Power Synergy evolution and rank 6 Power Recharge evolution will have a slightly increased damage\-per\-second from powers while Barrier is active than without Barrier. The Power Synergy evolution for Barrier is slightly less bonus damage than the similar evolution on Fortification.
...
- **Single Player:** Kaidan Alenko, Commander Shepard (Bonus Power), Urdnot Wrex, Jacob Taylor
- **Multiplayer:** Krogan Battlemaster Vanguard, Krogan Shaman Adept
