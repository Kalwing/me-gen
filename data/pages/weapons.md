...
Each of the playable character classes is only able to equip some of the five conventional weapon types:

- Soldier: assault rifles, sniper rifles, shotguns, heavy pistols
- Vanguard: shotguns, heavy pistols, SMGs
- Infiltrator: sniper rifles, heavy pistols, SMGs
- Adept: heavy pistols, SMGs
- Engineer: heavy pistols, SMGs
- Sentinel: heavy pistols, SMGs

Only one of each type of equipable weapon can be carried at a time during a mission. Squadmates are only able to carry two types of conventional weapon. In contrast to the original Mass Effect, as long as a weapon type can be equipped, it can be used without any other penalties to effectiveness.

New models of each weapon type can sometimes be found on missions and immediately used in combat. However, keep in mind that picking up a new model of a weapon type you or your party already have equipped will replace the previous weapon you had for that type with no option to go back to the old weapon unless you can access a weapons locker. Changing any equipped weapon in your party will also immediately cancel any active ammo powers on your party's weapons. Also be aware that picking up a new gun can temporarily rearrange the order in which your weapons cycle with the Next Weapon or Previous Weapon selects; however, accessing a locker or saving and reloading the game will put your weapons back in their "standard" order.
...
**Legendary Edition:**  Weapon stats in Legendary Edition are not based on the latest patched version of the original Mass Effect 3, but rather the base game before any patches were applied. The Player Notes sections of particular weapon pages are assuming the latest patched versions of the original game, but will note any significant differences with the Legendary Edition stats under the single\-player tab.
...
The following squadmates available during story missions have access to ammo powers of their own: Ashley Williams, James Vega, Garrus Vakarian, and Liara T'Soni. Squad members will automatically activate their own ammo powers in combat for their personal use, even if Squad Power Use is turned off in the menus; for the party\-sharing evolutions to apply, however, a squadmate must be explicitly ordered to activate their ammo power by the player. Shepard can have access to ammo powers either as class powers or as bonus powers.
...
Ammo powers deal their own unique damage type as a percentage of the "base" damage of the weapon they are augmenting, which is then added on to that base damage. Every ammo power except Cryo Ammo has its own unique multipliers against certain enemy protection types that improves its added "ammo damage". Ammo power damage can be further boosted by a few other modifiers, but it is worth noting that the various evolutions of the above ammo powers that improve headshot damage do **not** improve added ammo damage; instead, these evolutions work as a multiplicative enhancement of base weapon damage when scoring headshots.
...
- **Bonus damage to shields and barriers**: Acolyte, Adas Anti\-Synthetic Rifle, M\-358 Talon, Reegar Carbine (deals reduced damage to armor), N7 Typhoon, Geth Spitfire
- **Bonus damage to armor**: Krysae Sniper Rifle, Collector SMG (multiplayer only), N7 Typhoon, Blood Pack Punisher (special armor\-piercing round only)
...
**Note:**  These modifiers do not affect the damage of ammo powers.
...
Mods and Armor\-Piercing Ammo in single\-player can enable weapons to pierce objects, albeit with a significant damage penalty for doing so. Armor\-Piercing Rounds and Drill Rounds in Multiplayer do not apply a penalty. Penalties from multiple sources (e.g. a piercing mod plus Armor\-Piercing Ammo, or two piercing mods) do not stack; instead, the lowest penalty will apply.

The following weapons possess innate shot penetration in both single\-player and multiplayer modes: the Javelin, N7 Typhoon, M\-98 Widow, Black Widow, Executioner Pistol, and the N7 Crusader. These weapons benefit from the unique quality of not suffering a damage penalty for hitting targets through other enemies or objects under **any** circumstances, i.e. when equipped with mods or ammo augmentations that normally apply a penalty.
...
- Explosive munitions ignore enemy shield gates, except for the Krysae Sniper Rifle in multiplayer.
...
- In single\-player, weapons that fire explosive rounds are very ineffective for breaking or destroying inanimate targets as their rounds do not auto\-detonate on them. This includes Reaper Barrier Engines, Cerberus Shield Pylons, the latches on power control boxes, and Geth Trip Mines.
...
- In single\-player, NPC squadmates rarely overheat self\-cooling weapons as they only fire them in short bursts.
...
- Bonus Content Disc/Technology: Human Weapons\#Image 5
- Bonus Content Disc/Technology: Geth Weapons\#Image 4
- Mass Effect 2 Art Book/Texts\#05: Weapons
- The Art of the Mass Effect Trilogy/Mass Effect\#Weaponry
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Weaponry
- The Art of the Mass Effect Trilogy/Mass Effect 3\#Weaponry
- BioWare: Stories and Secrets from 25 Years of Game Development/The Making of Mass Effect 3\#Balancing Combat: Corey Vs. Brenon: How Designers in Mass Effect 3 Entered an "Arms Race"
