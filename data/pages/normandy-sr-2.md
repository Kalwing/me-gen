...
Located just outside the elevator there is a memorial wall featuring a record of crew casualties, including those who died on Prologue: Find the Beacon, Virmire, the Suicide Mission, and the twenty\-one crew members lost during the destruction of the Normandy SR\-1\. The wall will be updated throughout the game with the names of significant current or former crew members who die during the course of the story. On certain occasions, usually after significant events, different crew members can be found by the wall, gazing at it in contemplation. The ordering of names is not fixed, as they are placed in alphabetical order; when new names are added, some names previously on the wall will be in different positions.

Richard L. Jenkins, the Virmire casualty (Kaidan Alenko or Ashley Williams), Charles Pressley, Abishek Pakti, Addison Chase, Alexei Dubyansky, Amina Waaberi, Carlton Tucks, Caroline Grenado, Germeen Barret, Harvey J. Gladstone, Hector Emerson, Helen M. Lowe, Jamin Bakari, Mandira Rahman, Marcus Grieco, Monica Negulesco, Orden Laflamme, Raymond Tanaka, Robert Felawa, Rosamund Draven, Silas Crosby, and Talitha Draven are always on the memorial wall from the start of Mass Effect 3\.

Karin Chakwas, Kelly Chambers, Kenneth Donnelly, Gabriella Daniels, Rupert Gardner, Sarah Patel, Richard Hadley, Zach Matthews, Jenny Goldstein, Thomas Hawthorne, and Vadim Rolston will be on the wall if not rescued from the Collector Base.

Any of the major members of Shepard's squad as well as Steve Cortez may end up with their name on the memorial wall by the epilogue of Mass Effect 3, depending on what choices Shepard made over the course of their mission. Their names will also be joined by David Anderson, and possibly the Commander as well.
...
- According to an Official Xbox Magazine interview with BioWare art director Derek Watts (erroneously credited as "David Watts"), the Normandy SR\-2 is 170 meters long.
- In Mass Effect 3, the Memorial Wall has room for a maximum 48 names (not counting the ones added in the final cutscene), with 49 different names available for inclusion on the wall.
...
- According to The Final Hours of Mass Effect 3 as well as a Mass Effect 2 character document used during development, Shepard's ship in Mass Effect 2 was going to be named the Leviathan, before BioWare decided to make it into a new, improved Normandy. This was apparently due to people's fondness for the original Normandy.

## See Also

- Mass Effect 2 Art Book/Texts\#04: Transport
- The Art of the Mass Effect Trilogy/Mass Effect 2\#The Normandy SR\-2
- The Art of the Mass Effect Trilogy/Mass Effect 3\#The Normandy SR\-2
- BioWare: Stories and Secrets from 25 Years of Game Development/The Making of Mass Effect\#Bio\-Trivia: There's a Secret in the Background Sound of ME3's Normandy
