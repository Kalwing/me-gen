---
title: Swarmer
url: https://masseffect.fandom.com/wiki/Swarmer
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
- Slow\-moving and fragile, these small targets are easy to miss. Since Swarmers tend to appear in groups, attacks with an area of effect are generally effective in dealing with them.
	...
	- It doesn't show on the multiplayer kill log, but Reave instantly kills all Swarmers in its area of effect.
...
- One very important thing to keep in mind when facing lots of Swarmers, especially for power\-centric classes, is that most non\-grenade powers in Mass Effect 3 have a maximum number of targets they can hit, even when the power has an area of effect, usually capped at 3 or less. Power Combos are capped at hitting a maximum of 4 targets. This makes mass Swarmers obnoxiously good at absorbing powers and preventing them from hitting more threatening enemies in the area.
	- The detonation of Tech Armor can hit any number of targets within its blast radius and is an effective anti\-Swarmer measure; the same is also true of Proximity Mine and Flare. All three of the aforementioned powers also ignore terrain or obstructions. The detonation of Barrier is capped at 3 targets hit and it does not ignore terrain.
	...
	- Grenades are not limited in the number of targets they affect within their detonation area, making them both very handy for clearing out Swarmers, and making regular powers that much more effective as well.
- Being a "summoned" unit, Swarmer kills don't count as enemy kills in certain situations:
	...
	- In single\-player, the existence of Swarmers *will* prevent squadmates from reviving even if all other enemies in the area have been eliminated. It will also prevent saving the game.
...
- Swarmers' arachnoid, multi\-legged bodies, acidic body fluids, and habit of leaping at targets after emerging explosively from "eggs" all bear strong parallels with the "facehuggers" from the *Alien* film franchise. This is reinforced by the fact that the rachni as a whole were inspired by *Alien*, as confirmed by artist Matt Rhodes.
