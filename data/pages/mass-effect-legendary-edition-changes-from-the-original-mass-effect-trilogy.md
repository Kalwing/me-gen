...
- The redesigned female Commander Shepard design made for Mass Effect 3 is the female default. The original female Shepard from the first two games can be recovered by selecting the first preset and then adjusting the randomized hair, eyes, and scars.

### Audiovisual Updates

- Real\-time reflections in select areas, such as the fish tank in the Captain's Cabin aboard the Normandy SR\-2.
- Assets which appeared in higher quality in Mass Effect 3 have been reverse\-implemented into the first two games. This also applies to Mass Effect 3 if the assets appeared in higher quality in the DLCs.
...
- On Therum, Tali's voiceline about trying to find a "side window" when approaching the first fortified geth outpost has been fixed with a filter effect so that it properly sounds like it's coming through her suit.
...
- In the battle against Benezia, she has a biotic shield around her to explain why she can't be damaged during the first three rounds.
...
- The larger bipedal geth enemies more closely resemble the original appearance of the Geth Prime in Mass Effect 3\.
- Kate Bowman's character model in Bring Down the Sky has been retouched.
- Several sound effects have been adjusted; the firing sound for pistols is very noticeably different.
...
- The Unity ability has improved stats at every rank in almost all categories.
- Liara T'Soni's bonus to First Aid recharge time from Asari Scientist has been significantly improved.
...
- Weapon accuracy and handling has been significantly improved:
	...
	- The accuracy cost mechanic appears to have been largely or totally removed, despite in\-game tooltip text still indicating it exists.
...
- Squadmates can be individually directed, like in the two following games.
- Squadmates don't make "all clear" comments (to indicate when all nearby enemies have been eliminated) as often.
- Melee attacks mapped to a button similar to Mass Effect 2 and Mass Effect 3; melee attacks are no longer forced when you are close to the enemy, allowing you to shoot instead.
...
- The M35 Mako's physics were tweaked to be more precise, although the option to revert to the original controls is available.
...
- Touching the pools of lava on Therum deals damage over time instead of an instant Game Over. Strangely, this does not apply to the lava lake on Nonuel.
- No longer takes light damage from heavy impacts with the environment.
...
- During Citadel: Scan the Keepers, only 20 of the 21 Keepers need to be scanned.
- During Find Liara T'Soni, the puzzle code for the mining laser is the same across all platforms.
- Revisions to the fight on Virmire: fuel tanks have been removed, and Saren Arterius will now fight alongside waves of geth.
...
- Citadel Councilors' names are now displayed in subtitles.

### Bug Fixes

- The Codex entry for Batarians is now given when David Anderson reveals the details of his ill\-fated Mission with Saren, instead of when playing Bring Down the Sky.
...
- Several camera angles during cutscenes adjusted, notably with Miranda on the Normandy.
- Kelly Chambers' facial features consistent with Mass Effect 3\.
- During the initial cutscene of Tali'Zorah nar Rayya's loyalty mission, Joker wears a Cerberus outfit instead of his Alliance Navy outfit from the game's prologue.
...
- Some of Kasumi's voicelines for "ads" on the Citadel were removed.
- In Kasumi: Stealing Memory during the skycar conversation with Kasumi, a camera angle is adjusted to be higher on Shepard's body when Kasumi says the Commander looks "great".
- The larger bipedal geth enemies more closely resemble the original appearance of the Geth Prime in Mass Effect 3\.
...
- A large blue box centered on Joram Talid's "talk box" was added in Thane Krios' loyalty mission, making it easier to spot him from the catwalks.
...
- Bonus dialogue relating to the events of Mass Effect Galaxy that could be heard if both Miranda Lawson and Jacob Taylor were brought along when first speaking with Ish on Omega is now heard by default without having to play Galaxy.
- Loading screens don't wait for the animation to finish, making loading times faster.
- The Vanguard's Charge power benefits from the Biotic Cooldown upgrade; it is intentionally unaffected by this upgrade in the original game.

### Bug Fixes

- Miranda does not ask whether Captain Anderson or Donnel Udina was nominated to the council \- the choice is automatically imported.
- Many bug fixes relating to choices in Mass Effect, resulting in many more Galactic News bulletins that refer to Assignments you completed in the first game, as well as existing ones reflecting the correct outcome. In some cases, this amounts to the restoration of formerly cut content.
	...
	- Galactic News reports about Sirta Foundation correctly reflect the outcome of UNC: Besieged Base.
	- Correct Galactic News report depending on status of Lord Darius following UNC: The Negotiation.
- The Beacon VI on 2175 Aeia no longer disappears after saying its ambient dialogue lines.
- The Archon Visor helmet piece now properly applies its benefit and reduces power recharge times.
...
- Tali's face, as can be seen in a photograph during the events of Mass Effect 3, originally used an edited portrait of the 2005 Miss England Hammasa Kohistani in the original. For Legendary Edition, a female face has been integrated into a "photo" of Tali wearing her normal outfit but with her face mask removed.
...
- Weapon stats are not based on the latest patched version of the original game, but rather the base game before any patches were applied.
...
- Ashley Williams' Marksman Ability has been fixed, enabling players to use her powers to their full extent.
