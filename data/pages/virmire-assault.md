...
- Base outskirts
- Entry point 1: front door
- Entry point 2: detainment level
- Saren's labs
- Facility main level
- Surprise revelations
- The bombsite
1/7You must infiltrate Saren's base and destroy it completely. Captain Kirrahe will assist with a diversionary strike to draw off most of the geth.
...
- Within the game's internal data, this mission is referred to using different names: "(Virmire:) Incursion" when approaching the facility, "(Virmire:) Infiltration" once inside, and "(Virmire:) Extraction" after planting the bomb.
- According to Mass Effect Legendary Edition gameplay statistics as of July 27, 2021, 60% of players saved Ashley while 40% saved Kaidan.
- When playing a default game of Mass Effect 3 that is not imported from a previous game's save file and where the player does not choose any of the plot points, Ashley is the survivor of the events on Virmire if Shepard is male; if Shepard is female, Kaidan is the survivor.
...
- Droyas and his assistant have unused lines associated with them, including a dialogue in which he would have resented Wrex for fighting against the "rebirth" of his own kind.
- Numerous data references and cut dialogues point to the once existing possibility to save both Kaidan and Ashley. Back on the Normandy, they would have shown gratitude and disbelief at Shepard's double rescue.
