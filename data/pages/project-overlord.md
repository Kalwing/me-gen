...
url: https://masseffect.fandom.com/wiki/Project_Overlord
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the Cerberus project. For the Mass Effect 2 DLC, see Overlord.* *For the assignment, see Overlord (assignment).* |
| --- | --- |

**Project Overlord** was a Cerberus research project based on Aite intended to devise a way to control the geth.
