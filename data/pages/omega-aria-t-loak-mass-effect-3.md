...
- Prelude to war
- Recruiting allies
- Nobody fucks with Omega
- Discretionary diversions
- Endgame
1/5Rendezvous with Aria's Fleet.

## Acquisition

Complete Citadel: Aria T'Loak. Note that doing so will allow you to start this mission even after Priority: Tuchanka but before Priority: The Citadel II (which automatically begins on trying to dock with the Citadel).

## Preparation

Travel to the Widow system in Serpent Nebula, located next to the Citadel, to begin the mission with Aria's mercenary fleet. Once you rendezvous with the fleet, you will be heading to Omega for a rather long mission, so this is your last chance to upgrade weapons, change bonus powers, retrain abilities and so on. There will be opportunities along the way to change weapons, mods, and even armor, however. Defense Matrix deserves the usual consideration as a bonus power for its improvement to Shepard's staying power in fights, and its shield restoring purge can be even more useful than usual during the tough battle waiting for you at the conclusion of the mission. Reave can also be a powerful and versatile option.

You should be prepared for a higher average level of difficulty in the fights on this mission overall, but this sojourn on Omega can be more than worth it in the form of large rewards of both experience and credits, as well as certain weapons and weapon mods that can't be found anywhere else. Your enemies will be a mix of familiar Cerberus forces and some new types of opponents. Energy Drain, Overload, and Disruptor Ammo powers are always useful against Cerberus shields. As Aria insists on Shepard leaving the Normandy and some of its apparently problematic crew members behind, there are no squad choices to make.
...
**Tip:** You'll find that Omega has a **lot** of spare grenades lying around as you move forward. Grenade powers can be used multiple times in every battle without fear of running out.
...
Your last fight at the Talon outpost will be at the main gates against Centurions, Troopers, and Rampart Mechs. The last wave will be another Atlas that likes to keep itself concealed with smokescreens. The area is studded with cover barricades and Shield Pylons will be supporting the Cerberus troops on the far end; the pylons can be quite challenging to take out unless you have an accurate scoped weapon, but Nyreen's Lift Grenades can usually take them out. Depending on your moves that may either turn out to be a hindrance or an advantage. There are two turrets by the sealed base door, but they cannot be mounted so fight with your own skills and Nyreen's, who will join you on this. There are also two Med Kits close to the right wall near the entrance. Make sure to grab them before you take out the rest of the Cerberus forces, as this will trigger a cutscene.
...
**Note:**  It's possible that you are unable to use the weapon bench at all initially, but it should become available for use after you've cleared all of the hostiles in the next area (the catwalks / dam).
...
- At least until Aria is freed, all enemies remain singularly focused on Shepard, to an unusual degree: they will totally ignore Decoys, Combat Drones, or Sentry Turrets, and even the Dominate power will not cause any enemy to shift its focus away from Shepard, including the *target* of Dominate itself.
...
- Assault Troopers and Nemeses are regularly and endlessly replaced when killed, so taking them out provides only a temporary respite.
	- Adjutants do not endlessly respawn in quite the same way: you’ll never be facing more than two at a time including the two in the area at the start of the fight. Each time a generator is destroyed, two more Adjutant replacements are "unlocked," meaning killing an Adjutant will cause another to spawn almost immediately until there are two in the area again. This only occurs after the first three generators are destroyed, so a maximum of eight Adjutants can be encountered, and you will face far fewer if you don't kill many before blowing the final generator.
...
Depending on the overall morality of your actions during this mission, Aria will either kill or spare General Petrovsky. If Aria is unwilling to spare Petrovsky, you can use two Paragon Interrupts to force her to do so, though this will considerably sour her attitude towards you. If Aria delivers Petrovsky to you, you can use two Renegade Interrupts to kill the general yourself by shooting him in the head, though this will also draw Aria's contempt. If you were mostly agreeable to Aria (i.e. Renegade) in your interactions with her throughout the mission and allow her to kill Petrovsky, she will give you an unsolicited kiss.

Completing this mission unlocks Flare and Lash as bonus powers in the Med Bay, and nets you the Omega Raiding Fleet and Omega Eezo Hoard War Assets. Sparing Petrovsky will earn you a third War Asset worth 30 points. Killing him will add 30 points to the Alliance First Fleet.
...
- **Total credits**: 75,002
	- Credits found: 60,002\*
		- The Invasion of Omega: 6 pickups
		- Talon Territory: 10 pickups
		- The Mines: 7 pickups
		- The Assault on Afterlife: 12 pickups
	- Alliance Funding: 15,000
- **Total Medi\-gels**: 83 units
	- The Invasion of Omega: 29 units
	- Talon Territory: 26 units
	- The Mines: 3 units (in 3 pickups)
	- The Assault on Afterlife: 25 units
- **Weapons**: N7 Valkyrie, Phaeston (if not owned), Chakram Launcher
- **Weapon mods**:
	- The Invasion of Omega: Assault Rifle High\-Velocity Barrel, Pistol Heavy Barrel, Shotgun High\-Velocity Barrel
	- Talon Territory: Assault Rifle High\-Velocity Barrel, Shotgun High\-Velocity Barrel, Sniper Rifle Thermal Scope, Shotgun Omni\-Blade
	- The Mines: Assault Rifle High\-Velocity Barrel, Pistol Heavy Barrel, Sniper Rifle Thermal Scope, Shotgun Omni\-Blade
	- The Assault on Afterlife: Sniper Rifle Thermal Scope, Shotgun High\-Velocity Barrel, Pistol Heavy Barrel, Shotgun Omni\-Blade
- **Morality**: Morality Guide (Mass Effect 3\)\#Omega: Aria T'Loak

\*The final stage (The Assault on Afterlife) has a maximum of 15,002 findable credits. After finding 15,000 credits, any further credit pickups you gain will only reward \+1 credits.
...
- The sequence right after entering the mines where the power to the elevator has to be turned on shares similarities to the sequence in the first *Jurassic Park* film where the titular park's power must be reactivated (i.e. following power cable piping in the dark and being ambushed by a monstrous creature immediately after power is restored).

##

Mass Effect 3: Omega Navigation

| ← Previous Mission | Mission Index |  |
| --- | --- | --- |
| Citadel: Aria T'Loak | Missions |  |
