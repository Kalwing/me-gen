---
title: Kaidan Alenko/Unique dialogue
url: https://masseffect.fandom.com/wiki/Kaidan_Alenko/Unique_dialogue
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
- On the Citadel:
	...
	- During the Citadel: Signal Tracking assignment, when Shepard asks the AI if the matter can be resolved peacefully Kaidan vehemently disagrees if the other squadmate is anyone else but Tali or Ashley: "What are you, crazy? It’s an AI, like the Geth, it would kill us all if it could!"
...
- Eden Prime:
	- "Eden Prime will never be the same again."
	- "Check your targets. Could be friendlies."
	- "Smells like smoke and death."
	- "We should move, Commander"

- On the Citadel:
	- In the Citadel Tower:
		- After the hearing with the Council, Kaidan voices his awe at the pinnacle of galactic power.
		- Kaidan opines that the fountain at the tower is soothing.
		- Kaidan notes the large number of stairs needed to reach the Council, wondering aloud if it's symbolic of the Council's importance.
	- At the Presidium:
	...
	- In Chora's Den:
		- Kaidan sees why the place is popular: "It's has quite the, uh, view." If Ash is talked to first, Kaidan responds to her observation: "What? You don't think they're here because of the food?"
		- After killing the first group of thugs guarding the place when going after Fist, Kaidan wonders aloud where all the dancers went.
...
- Therum:
	- Exterior surface:
		...
		- "Hell of a place."
	- Inside Prothean ruins: "The tiles in those holes remind me of a bathroom floor."

- Noveria:
	- Inside Port Hanshan:
		- "Looks like a hell of a storm outside."
		- "I like the decor here. Expensive but tasteful."
	- Outside Port Hanshan:
		- "A bit nippy."
		- "Wish we could pop off some incendiaries.
		- "I think I've got snow in my boots."
		- "Mom was right. I should've brought a sweater."

- Feros:
	- Zhu's Hope:
		- "Makeshift defenses. Untrained civilians. It's a miracle anyone's still standing."
		- "These people came here looking for a better life. And look what happened."
	- Prothean skyway:
		- "These ruins go on forever."
		- "Imagine this place at its height."
		- "Not my first choice for a colony."
		- "This place has seen better times."
	- ExoGeni facility: "Keep your guard up. This place is probably crawling with geth."
	- Thorian:
		- "God, it stinks in here. I feel like I'm going to be sick."
		- "This place is starting to freak me out."
- Virmire:
	- Salarian camp:
		- "These salarians seem pretty tough. I just hope they hold up under pressure."
		- "We're close, Commander. Saren can't hide forever."
		- "Be careful with Wrex. He's not himself."
		- "I don't like the way Wrex is behaving. He's really on edge."
		- (Wrex survives) "Nice work with Wrex. I didn't think anything would calm him down."
		- (Wrex survives) "Whatever you need, Commander. I'm right behind you."
		- (Wrex dies) "It's really too bad Wrex couldn't be reasoned with."
		- (Wrex dies) "I'm ready to go when you are, Commander."
	- On approach to Saren's base: "Sun, surf, sand… and geth. I bet they don't put that in the brochure."
	- Inside Saren's base:
		- "We eliminate this base and Saren's going to feel it!"
		- "We need to wipe this whole base out!"
- Ilos:
	- "This city is too quiet."
	- "I wonder how many lived here?"
	- "Feel like I'm walking over a grave."
- Final Battle
	- Citadel exterior: "I hope I remember my low\-gravity combat training."
...
- On Eden Prime:
	- Shortly after the first Husk encounter, Kaidan wonders what can be seen rising into the sky off in the distance; Ashley answers that it's a massive ship.
	- Kaidan spots Nihlus' body and points it out to Shepard.
	- After getting off the tram and Shepard interacts with the first bomb, Kaidan says the geth must have planted demolition charges. Ashley responds that they have to hurry and shut them down.
...
- On Priority: Thessia:
	...
	- During the fight with Kai Leng, when the assassin taunts Shepard over Major Kirrahe/Thane Krios' death, Kaiden will angrily growl "Come closer! I didn't catch that, you bastard."
