---
title: 'Namakli: Leviathan'
url: https://masseffect.fandom.com/wiki/Namakli:_Leviathan
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
First there are Cannibals and a Harvester. The Cannibals are scattered and not too much of a threat, and Cortez needs the Harvester gone to come in safely, so make it your priority. It will die fairly quickly if you have any sort of grenades: using them sets off a chain reaction of exploding barrels. Likewise, hitting it with any sort of fire or biotic explosion will tend to create a massive chain reaction.

**Warning:**  It is possible for your squad to get stuck on the high ledge after the cutscene rather than joining you below during this battle; if this occurs, they can still shoot and use powers from where they are. To unglitch them, you have to run forward or in circles for a bit and they will "teleport" down to you, but this can be quite dangerous to do in an active combat situation. The only other solution is to reload a save and hope this doesn't occur.
...
- **Weapons**: AT\-12 Raider
- **Weapon mods**: SMG High\-Velocity Barrel, SMG Recoil System, Assault Rifle Omni\-Blade
...
| --- | --- | --- |
| Leviathan: Find Ann Bryson | Missions | Citadel: Leviathan III |
