---
title: Scorpion
url: https://masseffect.fandom.com/wiki/Scorpion
game: Mass Effect 3
type: tech
characters: []
scraped: '2026-08-28'
...
- One other attractive feature of the Scorpion is perfect projectile accuracy at any range with negligible recoil. The rounds aren't affected by gravity and will travel straight to where the crosshair is pointing without random deflection; however, projectile travel time has to be taken into account. The Pistol Scope mod provides little benefit for the Scorpion.
...
- The Scorpion has a very high chance to trigger the effects of Disruptor Ammo/Rounds and Cryo Ammo/Rounds when an enemy is hit directly by a round. This makes the weapon very predictable at freezing, or priming targets for Tech Bursts.
	...
	- With incendiary ammo modifications, the Scorpion can prime unshielded enemies for Fire Explosions shortly after sticking them with one projectile because the target starts burning immediately, even though the initial projectile hit deals no damage. The holographic symbol for Incendiary Ammo/Rounds doesn't appear on the weapon.
...
- The Scorpion is very effective when combined with Tactical Cloak: the damage of the Scorpion projectiles is only done when they detonate and Tactical Cloak is only broken when they are fired, so firing them all onto a large target such as a Geth Prime and then cloaking allows for the damage bonus of Tactical Cloak to be applied to all the shots.
	- When firing the last round in a magazine in Tactical Cloak, the Cloak will not break. This appears to be a bug.
...
| Rank | Research Cost | Omni\-Gel Canister | Graphite | Lithium | Element Zero | Augmentation Slots |
| --- | --- | --- | --- | --- | --- | --- |
