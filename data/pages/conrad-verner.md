---
title: Conrad Verner
url: https://masseffect.fandom.com/wiki/Conrad_Verner
game: Mass Effect 3
type: character
characters: []
scraped: '2026-08-28'
...
- Verner does not appear in unmodified games of Mass Effect 2 or Mass Effect 3 that were not imported from a Mass Effect save file.
...
- According to Chris Priestly, Conrad was nearly cut from Mass Effect 2 and Mass Effect 3\. Enough members of the dev team wanted him in, so he stayed.
...
- A glitch in Mass Effect causes the Conrad encounter to be flagged both as "Intimidated" and "Charmed" in the importable save file, apparently leading to Mass Effect 2 picking the former over the latter and triggering Conrad to say that Shepard pointed a gun at him regardless of prior choice. The alternative scene of the Mass Effect 2 encounter with Conrad after a "Charmed" resolution in Mass Effect is still present in the game, and can be accessed by removing the incorrect flag with a save game editor. Conrad is still found in Eternity, and is claiming to be a member of Shepard's squad; carrying on the Commander's work after their death. The mission involving the Gateway Personal Defense clerk will play out the same. In Mass Effect 3, Conrad references the glitch, apologizing for accusing Shepard of pointing a gun at him if they hadn't, saying he was very stressed and confused at the time.
- A test mission for the terminal in the Shadow Broker base called "Rabbit Season" involved hunting down Conrad. It is described as "Low Risk, Low Reward."
