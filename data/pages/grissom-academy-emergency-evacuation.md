...
**Warning:** If you do not complete the mission before Priority: The Citadel II, it will be no longer available and considered failed, with a number of significant consequences.
...
After all of the enemies are down, replenish your ammo and move through the door on the lower level. Pick up the mission brief (\+20 XP) on the chairs on the left, open the Med Kit on the right, and pick up any additional ammo you need. Use the computer on the left farther down the corridor (\+3750 Credits). **If you had not leveled up earlier, check and see if you have now before moving through the door.**
...
The next room has an empty Atlas and a Combat Engineer, who is standing with his back to you. Open the Med Kit on the couch on your right, and access the engineer's data log on the floor (\+20 XP) to find out that Rodriguez is another high\-priority target for Cerberus indoctrination. If you wish, you can climb into the Atlas and head up the stairs to the docking area. There is an SMG Magazine Upgrade on the bench to the left of the entrance you came in: **remember** to pick it up after the fighting. You can also examine the statue of Jon Grissom in the middle of the room.
...
After you are back on board the Normandy, you'll have a video conference with Anderson, who will discuss the war and ask about Kahlee.

If Javik is part of your crew, you will find him in the walkway beneath engineering following this mission. He will comment about Jack's previous tenure in this space.
...
- **Total credits**: 25,000
	- Credits found: 12,500 (in 5 pickups)
	- Alliance Funding: 12,500
- **Medi\-gels**: 6 units (in 3 pickups)
- **Weapons**: M\-96 Mattock/M\-22 Eviscerator\*
- **Weapon mods**: Assault Rifle Stability Damper, SMG Heat Sink, Assault Rifle Precision Scope, SMG Magazine Upgrade, Sniper Rifle Piercing Mod\*
- **Armor pieces**: Mnemonic Visor, Serrice Council Chestplate
- **Mission Related**: Biotic Amp Interfaces
- **Morality**: Morality Guide (Mass Effect 3\)\#Grissom Academy: Emergency Evacuation

\*The Mattock (which may instead be an Eviscerator in some playthroughs) and the Sniper Rifle Piercing Mod are both contingent on having made a Paragon decision at the end of the Mass Effect 2 DLC, Project Overlord (included in **LE**).
...
- This mission's first draft was originally written by John Dombrow.
...
- According to Trick Weekes, the plot for this mission was inspired by the attack on the X\-Mansion in the film *X\-Men 2*, with Jack as Wolverine.
