...
url: https://masseffect.fandom.com/wiki/UNC:_Dead_Scientists
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
The next and main room contains 8 mercenaries, including 2 krogan, and a sniper. All of them can use Immunity in higher difficulties, which can make the fight a slog to go through if you're not playing Legendary Edition, hence it's recommended to stop them from activating it in the first place.
...
1. If you finished the UNC: Hades' Dogs assignment, Toombs comments that he managed to escape because someone already took Cerberus down.
2. Otherwise, Toombs' escape will not be explained \- only that he managed to escape.
...
All outcomes result in a text display describing the aftermath, followed by an immediate exit of the bunker on closing the notice. You can still reenter in case you haven't finished looting. A monitor in the room with Toombs and the scientist can be interacted with, though it does nothing other than display a ship schematic.
...
- This assignment is referred to as "(UNC:) Survivor's Revenge" in the game's internal data.
...
- An option for Shepard to refuse this quest from Hackett was cut.
