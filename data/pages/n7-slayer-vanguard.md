---
title: N7 Slayer Vanguard
url: https://masseffect.fandom.com/wiki/N7_Slayer_Vanguard
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
| | **Barrier:** 500 / **Health:** 500 | | | --- | --- | | **Class: N7 Slayer** | | | Phase Disruptor |  | | Biotic Charge |  | | Biotic Slash |  | | Fitness |  | |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

## Melee and movement

|  | - **Regular Melee** – Monomolecular Blades 	- **Melee Sequence:** The N7 Slayer executes a series of attacks with his sword. - **Heavy Melee (Biotic Strike)** – The N7 Slayer teleports a short distance forward before slashing at an enemy with his sword, resulting in a decapitation if the attack is fatal. - **Grab (Biotic Punch)** – The N7 Slayer Vanguard drags an enemy over cover and then executes them with a charged biotic punch. |
| --- | --- |
|  | - **Dodge (Acrobatics)** – The N7 Slayer Vanguard flips and teleports a short distance at the expense of barrier strength. - The N7 Slayer Vanguard can take cover, and can roll from cover to cover. |
