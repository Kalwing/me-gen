---
title: James Vega/Unique dialogue
url: https://masseffect.fandom.com/wiki/James_Vega/Unique_dialogue
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
- During N7: Fuel Reactors:
	- If he assists Captain Riley, at the mission's conclusion James says that killing Reapers was thanks enough.
...
- During Priority: Rannoch:
	- When the team first gets a view of the blast shield covering the source of the Reaper code signal and Shepard asks if anyone got a good look at it, James replies that it didn't look like the rest of the fortifications.
	- When Legion comments over the radio that the other geth have not registered their infiltration team as a threat, James responds that this oversight will bite them "in the ass."
...
- During Citadel Docks: Retake the Normandy:
	- If James responds to Traynor's confusion about the situation, he bluntly states that Cerberus cloned Shepard, following up with a shrug and "yeah, that's all I got."
	- James may complain that the crawlspace underneath the CIC is "a bit tight" and follows up with an apologetic "my bad" when Shepard warns the squad to be quiet.
...
James assigns nicknames to people, citing that some people just don't match their names, so he gives them new ones that are easier to remember. In general, he seems to prefer using some kind of shorthand to refer to others over their real names or formal titles/ranks.
...
- During Priority: Tuchanka:
	...
	- When approaching the krogan memorial ruins, James remarks on how the krogan really "did a number" on their own planet, and that he's starting to understand why the genophage was needed.
...
- During Kallini: Ardat\-Yakshi Monastery:
	...
	- When interacting with the dead asari commando near the end of the mission, and James speculates on if the commandos planted the explosives or messed up and died there,
		...
		- if Liara is in the party, Liara will say that commandos never abandon their mission, to which James will respond, "Doc, your people aren't invincible."
...
- During Citadel Docks: Retake the Normandy:
	- Right after Joker drops the squad off, James may growl at the approaching CAT6 mercs, "you do not want to get in my way, pendejo."
