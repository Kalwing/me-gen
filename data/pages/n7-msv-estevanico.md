---
title: 'N7: MSV Estevanico'
url: https://masseffect.fandom.com/wiki/N7:_MSV_Estevanico
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
To acquire the assignment, start scanning Zanethu (second planet). A distress call, identified by EDI as an anomaly, will be detected by the Normandy's sensors. The distress call reads as follows:
...
You land on the far side of the decrepit freighter, EDI comes over the comm warning that the ship may become imbalanced and fall if you explore it. There is a dead end path off to the right with a hanging loose tile that needs to be shot down to form a path further down.

**Warning:**  Do **not** shoot the hanging tile if you are standing directly under it, unless you want to experience one of the more unique "environmental deaths" possible in the game.
...
**Note:**  Despite the mission summary reporting 3,750 credits found, there are no credit pickups on this mission. All credits are awarded on completion.
