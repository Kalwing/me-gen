---
title: Mako Guide
url: https://masseffect.fandom.com/wiki/Mako_Guide
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
- "Q" to disembark
- "F" to Repair (**LE:** "R")
- "N" To return to the Normandy (**LE:** "F")
...
**Tip:** Holding down the jump jets while simultaneously holding down left (A) or right strafe (D), or sometimes forward movement (W), is also the most effective way of righting the Mako if it flips over completely, which, while rare, can be deadly if it occurs in the middle of a fight.
...
- While repairs are in progress, the Mako is stationary and unable to fire or use its thrusters. It is also impossible to exit the vehicle. If the vehicle is heavily damaged and there are still enemies around, get some distance between them first and stay out of their line of sight while repairs are ongoing.
...
**Warning:**  The Mako takes damage from your party's shots and attacks, so watch your aim and move your squad members in order to have a clear line of fire.
...
- Moving the Mako does not interrupt or prohibit repairs. It is still not possible to use the thrusters, weapons, or exit the vehicle while repairs are in progress.
