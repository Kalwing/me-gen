---
title: Illium
url: https://masseffect.fandom.com/wiki/Illium
game: Mass Effect 3
type: location
characters: []
scraped: '2026-08-28'
...
Reaper forces met a surprising amount of resistance at Illium. Its leaders were paranoid about keeping their fortunes, and were influential in both Terminus and Citadel space. They outfitted their large defense fleet and a high number of fission weapons, and in the brief space battle, used them on the Reaper fleet's troop transports rather than their near\-impervious capital ships. As a result, the inevitable ground invasion has been slowed to a crawl as the Reapers manufacture more troops.
...
- The Nos Astra hub, assignments and Liara included, was written by Trick Weekes.
...
- Palaven is misspelled as Palavan on the travel boards.
...
- The assignment Illium: Drunk Asari was cut from the game. Additionally, Kasumi Goto's recruitment mission was at one point planned to take place on Illium's rooftops, and The Art of the Mass Effect Trilogy mentions her loyalty mission may have also been meant to take place on Illium.

## See Also

- Mass Effect 2 Art Book/Texts\#03: Alien Worlds
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Illium
