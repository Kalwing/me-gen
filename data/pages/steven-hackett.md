...
url: https://masseffect.fandom.com/wiki/Steven_Hackett
game: Mass Effect 3
type: character
characters: []
scraped: '2026-08-28'
...
Later, when Shepard commits the galaxy's combined forces to deploying the Crucible in Sol against the Reapers, he requests clearance to board the Commander's ship. There, he signals the various fleets to mobilize, giving his pre\-battle address to all the soldiers participating in the upcoming fight:
...
Afterwards, Shepard and Hackett meet in holo\-conference with Anderson, who reports that the Reapers had moved the Citadel above Earth and had closed the Ward arms, making it impossible for the Crucible to dock. Hackett then details the plan for Sword fleet to engage the Reapers while Hammer strike teams aid the Earth resistance in reaching the conduit in London to teleport to the Citadel and unlock the Ward arms.
...
- Hackett had a fully\-voiced briefing for Shepard for the cut assignment UNC: Bring Down the Sky. This conversation stands out for showing Hackett getting genuinely annoyed at Shepard if the player refuses the assignment; the admiral complains that he can "only beg for favors" since Shepard isn't under his command, and bluntly hangs up.
