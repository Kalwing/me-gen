---
title: Personal Apartment
url: https://masseffect.fandom.com/wiki/Personal_Apartment
game: Mass Effect 3
type: location
characters: []
scraped: '2026-08-28'
...
Squad members and other characters can be called to the apartment after receiving messages from them at the private terminal. In addition, Shepard can receive invitations from certain people to meet them elsewhere on the Strip. Some characters have two possible interactions—one on the Strip, and one in the apartment—and they only happen in a particular order. The first meetup must be completed before receiving a message from that person that unlocks the second.
...
**Note:**  At least one match must be played at the Armax Arsenal Arena combat simulator before receiving Jack's message.
