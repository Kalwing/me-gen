...
After Shepard dealt with the Collectors, Cerberus sent teams through the Omega\-4 Relay to salvage Reaper technology from the Collector Base, whether it was destroyed or preserved. At Cronos Station, Commander Shepard's team discovers that Cerberus recovered the Human\-Reaper and are using it to augment the station's functionality—either its brain if the Collector Base was preserved or its heart if the Collector Base was destroyed. When the Alliance captures Cronos Station, the Human\-Reaper's remains are incorporated into the Crucible, becoming War Assets.
...
- In an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file, the Collector Base was destroyed by Shepard.
