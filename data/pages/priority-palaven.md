---
title: 'Priority: Palaven'
url: https://masseffect.fandom.com/wiki/Priority:_Palaven
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
This will likely be your first major combat mission following Priority: Mars. If this is your first playthrough with your current character, your weapon and armor customization choices will be limited, but you will have more options than you did on Mars, so be sure to review them on the Normandy before starting this mission.

The only squadmates you will have available for this mission will be Liara T'Soni and James Vega; you will have the ability to customize their armor for different gameplay bonuses as well from the squad selection screen.

**Note:**  Even if you completed Priority: Eden Prime before this mission, Javik cannot be brought along to Menae. This also applies to N7: Cerberus Lab, unless you postpone it until after this mission.
...
**Note:**  If you took any health damage during the fight at the comm tower, you will be back to full health after this interlude.

**Note:**  If Liara's Warp Ammo was applied to any of your squad's weapons, it will appear to still be active if she leaves your party, but this is purely a misleading visual effect and it is no longer actually doing anything. You can (and should) activate any other ammo powers your team may possess.
...
**Note:**  Your squadmates can sometimes fail to follow you into this area before the gate shuts, trapping them outside during the fight. It's a good idea to manually order them into the area before you go in.

Following this, Corinthus will need you to defend the main barricade. You will encounter a few waves of husks, but you'll have access to a mounted turret with which they can be taken out quickly.

**Tip:** It is possible to zoom your view while using a mounted gun. Also, while turrets have unlimited ammo, they need to reload every so often, and they are more accurate when fired in short bursts (the first shot is always perfectly aligned with the crosshair).

As soon as you take out the waves of husks, you will be forced off of the turret and outside of the base's walls by a Brute supported by a small group of husks. If you're playing through for the first time and have never faced a Brute, there are two important things to remember. One is to stay as far away from the Brute as possible as it uses powerful melee attacks and charges, so you will want to dodge and create distance whenever possible by sprinting and using combat rolls. The second thing to remember is that the Brute possesses armor plates that protect many areas of it from most standard bullets. Shoot it accurately in the head or its unprotected buttocks when it lunges past you; powers like Incinerate and fire or biotic Power Combos are also effective.
...
Soon you will see an explosion. Run over there and you'll be met by a group of Cannibals and Marauders, followed by more Cannibals and a Brute. Use the crater as cover and let the enemy come to you. Once they are clear, move further into the compound and look to the right. Marauders and a pair of Brutes appear. Also not that you will be locked into this area, as the narrow area where you entered will get blocked by debris after an explosion preventing you from retreating back the way you came. Time to stand and fight. This is the last battle of the mission, so use any grenades freely.

On the right as you come in, just past the first turian "bunker" is a most useful Reaper Blackstar heavy weapon; use it as you wish because this is the last firefight. Its immense explosion can take out one or both of the Brutes instantly. Beware that although you will suffer no splash damage, your squadmates can often be caught in the deadly blast.

**Tip:** If for any reason you can't make it to the Blackstar and you're having a tough time against the Brutes and Marauders that advance, there is a very narrow cul\-de\-sac where you entered the area where you can hide from Brutes and they can't reach you. It's a desperate strategy as you'll be trapped there and you can easily run out of ammo, but it's a viable last resort.

After the battle, search the area for mods: in this area, directly to the left from where you picked up the Blackstar, you can find a med kit. Turn around and face the bunker that is on fire. Head towards it to find another med kit, and a Sniper Rifle Enhanced Scope on the far left as you come in. After eliminating all the Reaper forces and acquiring the mod, approach the final ramp or climb up on the plateau to trigger the conversation with General Victus and end the mission.

**Warning:**  Try not to finish the battle near General Victus if you have not picked up the mod, or the end conversation may trigger automatically without you being able to look around the battlefield after.

You will then return to the Normandy and converse with the asari Councilor and Admiral Hackett.

## Aftermath

- Joker will need you to investigate reports of a fire in the AI Core, revealing that EDI has taken control of Dr. Eva Coré's body. EDI becomes a squadmate and can henceforth be found in the cockpit.
...
- **Total credits**: 25,000
	- Credits found: 12,500 (in 6 pickups)
	- Alliance Funding: 12,500
- **Medi\-gels**: 12 units (in 6 pickups)
- **Weapons**: M\-97 Viper, M\-27 Scimitar
- **Weapon mods**: Pistol Piercing Mod, Assault Rifle Piercing Mod, Pistol Magazine Upgrade, Assault Rifle Magazine Upgrade, Sniper Rifle Spare Thermal Clip, Sniper Rifle Enhanced Scope
- **Armor pieces**: Armax Arsenal Shoulder Guard, Hahne\-Kedar Greaves
- **Morality**: Morality Guide (Mass Effect 3\)\#Priority: Palaven
...
| --- | --- | --- |
| Priority: The Citadel I | Missions | Priority: Sur'Kesh |
