---
title: 'Priority: Thessia'
url: https://masseffect.fandom.com/wiki/Priority:_Thessia
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
Back on the Normandy Shepard sulks over the defeat before reporting it to the asari councilor. After the debrief, the entire team converge on the War Room to determine their next moves. EDI and Specialist Samantha Traynor tell you that they tracked Kai Leng to the planet Horizon in the Iera system, making the mission Priority: Horizon available. You will also be contacted by Anderson via the QEC, and you can receive a pep talk from him before leaving the War Room. If you didn't complete Grissom Academy: Emergency Evacuation, Anderson will mention that he heard about the the school's unfortunate fate.
...
- A conversation with Garrus can be had at his usual home in the gun battery where you can learn the fate of his family on Palaven, and he reveals he has advised Primarch Victus to begin a full retreat. If you sabotaged the genophage cure and the krogan were none the wiser, you can choose to confide this to him. If you don't already have it, this conversation also unlocks Proximity Mine as a bonus power.
- There is a conversation with Joker in the cockpit that leads to learning about the fate of his family.

## Rewards

*See also: Equipment Guide (Mass Effect 3\)*
- **Total credits**: 30,000
	- Credits found: 15,000 (in 3 pickups)
	- Alliance Funding: 15,000
- **Medi\-gels**: 10 units (in 5 pickups)
- **Weapons**: M\-98 Widow
- **Weapon mods**: Shotgun High Caliber Barrel, Sniper Rifle Concentration Mod, Assault Rifle Extended Barrel, SMG Heat Sink
- **Armor pieces**: Umbra Visor
- **Morality**: Morality Guide (Mass Effect 3\)\#Priority: Thessia
...
- The Art of the Mass Effect Trilogy/Mass Effect 3\#Thessia
...
| --- | --- | --- |
| Priority: The Citadel III | Missions | Priority: Horizon |
