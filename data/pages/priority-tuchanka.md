---
title: 'Priority: Tuchanka'
url: https://masseffect.fandom.com/wiki/Priority:_Tuchanka
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
- Conversing with Matriarch Aethyta at Apollo's Cafe on the Presidium Commons.
...
**Note:** : If you do this mission after completing only Tuchanka: Turian Platoon and not Attican Traverse: Krogan Team, the latter remains available to complete afterwards (and vice versa). N7: Cerberus Attack and Tuchanka: Bomb likewise remain available after completing this mission, though **Tuchanka: Bomb is time\-sensitive** and must be completed within 3 missions of becoming available or it is considered failed, resulting in severe story and gameplay consequences.
...
- If Shepard stops by, Diana Allers performs an interview which can result in War Asset improvements:
	- If the Charm option is picked, this will result in a boost to the Krogan Clans asset.
	- If the Intimidate option is picked, this will result in a boost to the Turian Seventh Fleet.
...
- **Total credits**: 50,000
	- Credits found: 25,000 (in 3 pickups)
	- Alliance Funding: 25,000
- **Medi\-gels**: 4 units (in 2 pickups)
- **Weapons**: Graal Spike Thrower, M\-5 Phalanx
- **Weapon mods**: Pistol Magazine Upgrade, Shotgun Smart Choke, Pistol Melee Stunner, SMG Scope, Assault Rifle Extended Barrel
- **Armor pieces**: Death Mask
...
 doubt the alliance will just go along with it though. maybe theyll send you after me. you get time to prepare. then we see whose the better soldier.
...
- This mission was written by John Dombrow.
- According to level designer Dave Feltham, the mission was originally not going to involve the turians, but that was changed because "the level felt too bleak and \[people] needed hope."
- "Vigil", the musical theme associated with both the eponymous character and the menu screen of the first game, plays over the Shroud dispersal cinematic if the genophage was cured, but not if the cure was sabotaged.
- According to Mass Effect Legendary Edition gameplay statistics as of July 27, 2021, 96% of players cured the genophage while 4% left the Shroud sabotaged.

## See Also

- The Art of the Mass Effect Trilogy/Mass Effect 3\#Tuchanka
...
| --- | --- | --- |
| Priority: Sur'Kesh | Missions | Priority: The Citadel II |
