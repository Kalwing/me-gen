...
**Note:**  No side missions can be completed once you begin Act III, so finish anything else you want to complete before heading to Cerberus Headquarters.
...
- Citadel: Aria T'Loak
	...
	- Once you complete this, it does not get listed as a completed mission, instead the entry gets replaced with the entry for Omega: Aria T'Loak
- *Citadel: Barla Von*
	- This mission cannot be completed before Priority: Sur'Kesh.
	- **Progress\-Sensitive Mission:** This mission expires if not completed before Priority: Tuchanka.
...
- Citadel: Dr. Bryson
	...
	- Once you complete this, it does not get listed as a completed mission, instead the entry gets replaced with the entry for Leviathan: Find Garneau
- *Citadel: GX12 Thermal Pipe*
	- This mission becomes available only after you have completed any two missions involving landing on a world (Leviathan and Omega missions count toward this).
