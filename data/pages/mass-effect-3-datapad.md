---
title: 'Mass Effect 3: Datapad'
url: https://masseffect.fandom.com/wiki/Mass_Effect_3:_Datapad
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
**Mass Effect 3: Datapad** was a free app for iOS devices, released on March 12, 2012\. Datapad allowed players to check the status of the galaxy map in Mass Effect 3 and receive messages from characters. Datapad also contained a Codex, as well as a mini\-game that interacts with the Mass Effect 3 Galaxy at War system. Datapad is not compatible with Mass Effect 3: Special Edition for Wii U.

As of June 6, 2013, Mass Effect: Datapad is no longer available through the App Store. However, a browser\-based version of the app can be accessed via Bioware's N7 HQ.

## Alliance News

The Alliance News section of the app included an official Mass Effect news feed as well as the official Mass Effect and BioWare Twitter feeds.
...
- **Duration of the mission** (depending on your upgrades) \- The shortest durations available are: short: 1 hour, medium: 3 hours, or long: 6 hours.
- **Reward (credits)** \- The rewards available are: short: 75 credits, medium: 600 credits, or long: 1,125 credits.
- **Reward (galactic readiness)** (depending on your upgrades) \- The best rewards available are: short: \+2,80%, medium: \+2,98%, or long: \+3,17% for the associated theater.
...
- **Shielding** reduces the chance of a fleet being crippled after a mission.
...
- **Galactic Command Coordination**: Allows the player to earn significant additional readiness rating per mission.
