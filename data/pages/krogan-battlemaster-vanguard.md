---
title: Krogan Battlemaster Vanguard
url: https://masseffect.fandom.com/wiki/Krogan_Battlemaster_Vanguard
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the multiplayer class in Mass Effect 3\. For the elite krogan warriors in general, see Krogan Battlemaster.* *For other uses of the term Battlemaster, see Battlemaster (disambiguation).* |
| --- | --- |
...
| | **Barrier:** 1000 / **Health:** 1000 | | | --- | --- | | **Class: Krogan Battlemaster** | | | Biotic Charge |  | | Carnage |  | | Barrier |  | | Rage |  | |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

## Melee and movement

|  | - **Regular Melee (Krogan Headbutt)** – The Krogan Battlemaster headbutts an enemy, staggering it briefly. - **Heavy Melee (Krogan Charge)** – The Krogan Battlemaster Vanguard charges forward a short distance and strikes an enemy with held weapons. - **Grab (Physical Punch)** – The Krogan Battlemaster Vanguard drags an enemy over cover and then executes them with a gruesome physical punch. |
| --- | --- |
|  | - **Dodge** – The Krogan Battlemaster Vanguard lacks a dodge maneuver. - The Krogan Battlemaster Vanguard can take cover, but cannot roll from cover to cover. |

## Player Notes

### General Notes

- The Krogan Battlemaster's Biotic Charge is quite different from other Vanguards'. Charge takes longer to reach its target and has a longer cooldown, but deals more damage. Biotic Charge is considered a melee attack, so any kills from it count towards activating/extending Blood Rage.
...
- It's highly recommended to make one's build geared around survivability and to forego putting points into Carnage in order to maximize the potential of the Battlemaster. Opt for protection from Barrier, and use the rank 5 "Martial Artist" evolution in the Fitness skill tree to allow for greater melee damage. Alongside that, make sure the Battlemaster has extra damage protection from when he gets enraged, and he can withstand almost anything.
...
- Watch out for Nemeses while closing the distance with them, as one shot will strip your barriers entirely on higher difficulties, while a second shot will deplete health.
- Using the Reegar Carbine is rather useful as most enemies have just health or shields/barriers, which makes Phantoms much less dangerous. Piercing mod can solve problems with Dragoons, Atlases and Guardians, as it can easily hit through their shields and armor.
...
- It is much more difficult to melee Geth since some enemies can stun anybody struck by their shots. Time attacks carefully, and stick by your team to avoid any grief. Or otherwise, stick to weapon synergy and firing.
	- However, the Krogan Battlemaster is immune to most staggering attacks, especially during his melee animations. This makes them one of the most capable units for engaging the Geth directly (the only other characters that are immune to being staggered are the N7 Destroyer and the Krogan Shaman).
