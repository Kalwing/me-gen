...
|  | *This article is about research projects and upgrades in Mass Effect 2\. For research in Mass Effect: Andromeda, see Research (Mass Effect: Andromeda).* *For upgrades generally, see Upgrades.* |
| --- | --- |
...
**Note:** The chance of landing a critical hit seems to be between 20\-25%. This bonus does stack with the bonus damage from landing headshots.
...
**Note:** Heavy weapon ammo is automatically added to fill the extra capacity gained from upgrades (unlike medi\-gel capacity upgrades, which do not provide additional medi\-gel).
...
**Note:** This upgrade is bugged; contrary to its description, it increases damage against shields but **does not** affect biotic barriers.
...
**Note:** Despite the wording implying this only applies to health, the damage reduction to melee attacks applies to shields by the same amount as well.
...
**Note:** Additional medi\-gel must be found on missions to actually fill the new capacity (in contrast to heavy weapon ammo capacity upgrades that automatically add free ammo).
...
**Note:** Despite the in\-game text, the burst regeneration does not "fully" restore shields, only 50% of their current maximum value.
**Note:** The chance of triggering burst regeneration upon losing shields appears to be between 20\-30%.
## New Armor
...
**Note:** Unlocked by asking Jack about Normandy Upgrades (using "Investigate"), or by completing her loyalty mission.
**Note:** Contrary to the description, this upgrade does affect Jack's Warp Ammo.
...
**Note:** Unlocked by asking Mordin about Normandy Upgrades (using "Investigate"), or by completing his loyalty mission.
**Note:** Contrary to its description this upgrade provides a 25% bonus.
...
**Note:** Unlocked by asking Grunt about Normandy Upgrades (using "Investigate"), or by completing his loyalty mission.
...
**Note:** Unlocked by asking Miranda about Normandy Upgrades (using "Investigate"), or by completing her loyalty mission.
...
**Note:** Unlocked by asking Samara about Normandy Upgrades (using "Investigate"), or by completing her loyalty mission. You can speak with Morinth about the upgrade using the "Investigate" conversation option as well, but this isn't required to unlock it.
...
**Note:** Unlocked by asking Jacob about Normandy Upgrades (using "Investigate"), or by completing his loyalty mission.
...
**Note:** Unlocked by asking Thane about Normandy Upgrades (using "Investigate"), or by completing his loyalty mission.
...
**Note:** Unlocked by asking Tali about Normandy Upgrades (using "Investigate"), or by completing her loyalty mission.
...
**Note:** Unlocked by asking Garrus about Normandy Upgrades (using "Investigate"), or by completing his loyalty mission.
## Training Upgrades
...
- Contrary to its description, the Shotgun Shield Piercing upgrade increases damage against shields but **does not** affect biotic barriers.
