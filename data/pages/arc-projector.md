---
title: Arc Projector
url: https://masseffect.fandom.com/wiki/Arc_Projector
game: Mass Effect 2
type: tech
characters: []
scraped: '2026-08-28'
...
The **Arc Projector** is a heavy weapon in Mass Effect 2.
...
The Arc Projector is available as a downloadable content item if the Cerberus Network has been activated, and it can first be equipped once Shepard has been given command of the Normandy SR\-2. In Mass Effect Legendary Edition it is part of the game by default with no DLC or activation of Cerberus Network being required, becoming available to the player at the same point.
...
- In contrast to most heavy weapons, the Arc Projector has limited range. A good rule of thumb is that it won't hit enemies engaging at sniper rifle\-appropriate distances.
...
Strategies
- This weapon is good at slowing down groups of husks and stripping their armor if they have any but isn't particularly good at killing them especially on higher difficulties. Also, getting hit by melee attacks interrupts attempts to fire the weapon. The M\-622 Avalanche, M\-100 Grenade Launcher, and even the M\-490 Blackstorm are more effective at mass husk\-killing and more ammo\-efficient as well.
- The Arc Projector is riskier to use on Hardcore and Insanity due to the 2 second charge\-up delay before firing. On the higher difficulties 2 seconds taking enemy fire is often more than enough to be fatal and charging a shot forces you to poke out from cover if you are currently attached to any. The only way to compensate for this is to stand behind large cover without attaching to it and time the shot to fire the moment you poke out. Fortunately, the Arc Projector doesn't require precise aiming.

## Trivia

- The Arc Pistol is a heavy pistol variant of the Arc Projector created by Admiral Daro'Xen vas Moreh.
