...
url: https://masseffect.fandom.com/wiki/Citadel:_Homecoming
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- Within the game's internal data, this assignment is referred to as "(Citadel:) In Flanders Fields". *In Flanders Fields* is the name of a war poem written by John McCrae after the funerals of one of his friends who died in battle.
...
- According to content cut from Mass Effect 2, if the player left the body with the Alliance, the decision bore fruit in the form of weapons upgrades.
