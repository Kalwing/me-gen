---
title: 'Noveria: Rift Station'
url: https://masseffect.fandom.com/wiki/Noveria:_Rift_Station
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- Reach the heart of the problem and deal with it
1/2You've found Rift Station held by the battered survivors of the science team. It's obvious they've had a bad time, and can't hold out much longer.
...
1. By approaching the sealed\-off doors at the restricted area of the Rift Station main level. A computer voice will alert you that the "Watchdog Protocol" is active.
2. Being accosted by Han Olar after Alestia Iallis' attack during Noveria: Quarantine will update your journal if you haven't done the former yet.
3. If you did Noveria: The Hot Labs first, your journal updates with the mission entry whichever way you choose to reach the Secure Lab as detailed below. The upper entry is gained if you went through the Restricted Area, while the alternative entry is gained if you went through the Ventilation Room via Scientist Barracks.
...
- Within the game's internal data, this mission is referred to as "(Noveria:) Science Station".
...
| --- | --- | --- |
| Noveria: Matriarch Benezia | Missions | Noveria: Matriarch Benezia |
