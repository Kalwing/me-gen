---
title: Horizon (mission)
url: https://masseffect.fandom.com/wiki/Horizon_(mission)
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
Now that the coast is clear, Delan emerges from his garage and complains you failed to rescue his friends. All of your responses to him are loaded with morality points. Only when one of your teammates mentions your name will Delan display a glimmer of recognition of who you are. As if to drive the point home, the Virmire survivor, apparently spared abduction by the Collectors, announces their arrival with a short list of your greatest accomplishments. Unimpressed, and indignant that the Alliance rep is still around while so many of his fellow colonists aren't, the mechanic leaves in a huff.
...
**Note:**  You may now purchase the Retrain Powers (Tactical Shift) research upgrade in the Normandy Tech Lab for 2,500 element zero, allowing you to reallocate all of your squad points however you wish.
...
- Brian Kindregan wrote the first passes for this mission.
...
- Unused plot data points to a number of narrative and gameplay changes for this mission: it appears at one point, the player would have taken control of the character of Lilith right before and during the invasion, similar to the player controlling Joker later in the game. You could walk around the colony and talk to people, including Kaidan or Ashley, but as the ship arrives, you'd be tasked with a few objectives. Some of them could be failed or succeeded, influencing the state of the colony later on as the player controls Shepard again. It also appears player\-controlled Lilith would have been the one to revive Kaidan or Ashley from stasis, a plotpoint left unexplained in the final game.
- Among all the possible squadmate reactions available during the mission, the developers have accounted for Tali's presence, even though she can't be recruited until after this mission is completed. Kaidan or Ashley even have special remarks, expressing surprise at seeing both Shepard and Tali have joined Cerberus (and possibly Garrus too).
