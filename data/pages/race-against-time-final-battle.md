...
url: https://masseffect.fandom.com/wiki/Race_Against_Time:_Final_Battle
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- Take lengthy detours
- Exhaust incoming enemies
- Beat Citadel defenses
- Back to the beginning
1/5You have followed Saren to the Citadel. He is trying to transfer control of the station to Sovereign so the Reaper invasion can begin. You must stop him and find a way to destroy Sovereign once and for all.
...
**Legendary Edition:**  To spice things up, geth troops now periodically spawn around Saren: Troopers, Shock Troopers, and even Destroyers, anywhere in the Council Chambers. The spawns don't stop until Saren's dead, so as with the original game prioritize hammering away at him despite the number of targets now gunning for your team. However, you may not want to stay as exposed when doing so, and abilities like Hacking and Sabotage can be quite useful to keep pressure off you.
...
- In the area where the Krogan Battlemaster can be encountered shortly before entering the Council Chambers, Avina's distorted audio warning about the damage to the Citadel advising non\-essential personnel to evacuate can be heard repeating in both English and French.
...
- There are a number of unused squadmate lines related to the Citadel Tower elevator.
- An unused dialogue suggests Captain Kirrahe could assist Shepard while climbing the Citadel Tower, provided he had survived the events on Virmire earlier.
- Another unused dialogue had Saren/Sovereign hold one final conversation with Shepard after Saren's metamorphosis, allowing the Reaper to taunt the organics one last time before its defeat.
- An alternative cutscene for Shepard coming out of the rubble had Anderson explain that all charges against him were dropped. The scene also featured Executor Venari Pallin, whose survival would also be the subject of cut content in Mass Effect 2\.

## See Also

- The Art of Mass Effect/Alien Worlds\#Ilos Archive
- Bonus Content Disc/Environments: Ilos
- Bonus Content Disc/Environments: Citadel\#Image 26
...
| --- | --- | --- |
| Race Against Time: Conduit | Missions |  |
