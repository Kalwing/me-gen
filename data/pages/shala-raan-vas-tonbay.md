---
title: Shala'Raan vas Tonbay
url: https://masseffect.fandom.com/wiki/Shala'Raan_vas_Tonbay
game: Mass Effect 3
type: character
characters: []
scraped: '2026-08-28'
...
- Cut journal entries for Mass Effect 2 point to Shala'Raan having a different role during Tali's trial: instead of recusing herself, she would have supported exiling Rael'Zorah. She accuses him of endangering the Fleet by relaxing security protocols on the Alarei. However, the player could find evidence that proves security remained tight, which would tip the trial in Tali's favor.
- Unused voicelines show that it was possible at one point to leave the Alarei without finding Rael'Zorah's body. Shala'Raan would show much empathy towards Tali at the news that she didn't find him, and would offer to let her know when his body is found, which Tali refuses. If Tali was exiled, Shala'Raan even offers to visit her after the Collectors are dealt with.
