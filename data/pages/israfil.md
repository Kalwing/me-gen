---
title: Israfil
url: https://masseffect.fandom.com/wiki/Israfil
game: Mass Effect 3
type: location
characters: []
scraped: '2026-08-28'
...
| --- | --- | --- |
| Palladium | Medium | 5,500 |
| Platinum | Medium | 8,000 |
| Iridium | High | 16,500 |
| Element Zero | Low | 3,500 |

## Trivia

- Israfil may be named after the trumpet angel in Islam.
- Totenkopf (literally "head of a dead man") refers to only the skull. It does not mean but can be used to describe Death's head.
- SSV Manila may be named after the capital of the Philippines.
