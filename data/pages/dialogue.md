...
*For rank descriptions and other information on the Charm and Intimidate talents, see Talents\#Player Exclusive.*
*For Paragon/Renegade point rewards and Charm/Intimidate requirements for specific dialogue choices, see Morality Guide.*
...
*For Paragon/Renegade point rewards for specific dialogue choices, see Morality Guide (Mass Effect 2\).*
...
*For Paragon/Renegade point rewards for specific dialogue choices, see Morality Guide (Mass Effect 3\).*
...
| Icon | Conversation Choice | Description |
| --- | --- | --- |
|  | **Branching Arrows** | Selecting this conversation choice will stop the current line of dialog and will move to a new conversation branch about a different subject or potentially a different part of the current subject. This choice moves conversations forward. |
|  | **Question Mark** | Selecting this conversation choice will provide extra information or potentially extra conversation sub menus before moving a conversation forward. This choice may or may not result in a few additional sub menus but won't lock Pathfinder Ryder out of the current branching dialogue paths. |
|  | **Two People** | Selecting this conversation choice develops friendships. This choice can open potential loyalty missions but doesn't lock Pathfinder Ryder out of romance choices. |
|  | **Large Heart** | Selecting this conversation choice is the flirtation option. Conversation choices along these lines deal with romance. This isn't an all or nothing conversation choice. Pathfinder Ryder has to flirt many times to develop a romance and the option to lock in a romance will be very clearly stated. |
...
| Icon | Tone Type | Wheel Location | Description |
| --- | --- | --- | --- |
|  | **Emotional** | Top Left | Pathfinder Ryder listens to the heart rather than the head, even if this breaks the rules. Pathfinder Ryder responds with sympathy, anger, or passion. |
|  | **Logical** | Top Right | Pathfinder Ryder has thought of the pros and/or cons and does what makes the most sense. Pathfinder Ryder responds with pragmatism and rational thought over emotions. |
|  | **Casual** | Bottom Left | Pathfinder Ryder is less focused on the task at hand and more relaxed. Pathfinder Ryder responds with jokes or light\-hearted dialogue. |
|  | **Professional** | Bottom Right | Pathfinder Ryder focuses on what the job requires rather than emotional responses. Pathfinder Ryder responds with formal courtesy. |
...
- The dialogue system base design has been patented at US Patent US20070226648A1.
