---
title: 'Dossier: The Justicar'
url: https://masseffect.fandom.com/wiki/Dossier:_The_Justicar
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
After the mission, Detective Anaya from the Spaceport sends Shepard this email:
...
- The police barrier turns red when Shepard crosses it, but it does not react at all to squadmates.
...
- Several ambient comments from civilians at the spaceport were cut.
- When the player is about to enter the areas where Minagen X3 is stored, squadmates would have stopped to ask Shepard if they'd rather not take a biotic squadmate along if neither of them are, in order to take advantage of the chemical's effects.
- There were also additional squadmate reactions when affected by Minagen X3\.
