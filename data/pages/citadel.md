...
- As the Mass Effect franchise pays homage to numerous sources fact and fiction, the Citadel \- as one of its most iconic features \- may have had several possible inspirations.
	- Its role as a space station which serves as the central hub for commerce and diplomacy for multiple species was inspired by Babylon 5.
...
- *BioWare: Stories and Secrets from 25 Years of Game Development* mentions that proposed names for the Citadel were "Optigon" and "Oculon". The latter is widely referenced throughout the first game's internal data relating to the Citadel. Similarly, the acronym "C\-Sec" was also shown to have been "Oc\-Sec" at some point.
- A combat simulator planned on the Citadel was apparently scrapped during the first game's development. It would have been located in the "Marshals training ground". When the idea was scrapped, that area was remade into the C\-Sec academy. A combat simulator was eventually implemented for the game's downloadable content Pinnacle Station, and later for the Armax Arsenal Arena in Mass Effect 3: Citadel.
- The following assignments taking place on the Citadel were cut from Mass Effect:
	...
	- Citadel: The Mugger
- The assignment Citadel: Mysterious Stranger was cut from Mass Effect 2\.

## See Also

- The Art of Mass Effect/Alien Worlds\#The Citadel\-Presidium
- Bonus Content Disc/Environments: Citadel
- Mass Effect 2 Art Book/Texts\#03: Alien Worlds
- The Art of the Mass Effect Trilogy/Mass Effect\#The Citadel
- The Art of the Mass Effect Trilogy/Mass Effect 2\#The Citadel
- The Art of the Mass Effect Trilogy/Mass Effect 3\#The Citadel
- The Art of the Mass Effect Trilogy/Mass Effect 3\#The Citadel (2\)
- BioWare: Stories and Secrets from 25 Years of Game Development/The Making of Mass Effect\#Untitled Anecdote 2
