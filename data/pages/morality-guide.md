---
title: Morality Guide
url: https://masseffect.fandom.com/wiki/Morality_Guide
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
**Note:** Choosing the first Paragon option will lock you out of choosing the second Renegade option (and vice versa), making it impossible to obtain both Paragon and Renegade points during the speech. For example: if "Nobody's going to help us" is chosen, "Everyone is counting on us" will be replaced by a neutral option.
...
**Note:**  Taking the Charm or Intimidate options immediately after choosing "I have Lorik's evidence" rewards no morality points. To receive any of the following morality rewards, one of the three available options that are neither Charm or Intimidate must first be chosen. Also, if you already received a garage pass from Anoleis in exchange for revealing Opold's smuggling, only the last option below will be available.
...
- 2 Renegade for saying "No." (Must first pick the investigate option on the left; you still get the grenades)
...
- Kill Wrex
	- 25 Renegade for "\[Signal Ashley to kill Wrex.]" (available if in a previous conversation with Ashley and Kaidan Shepard asks "Wrex?" instead of saying "Enough about Wrex." and then says "You're right." or "Be ready.")
	- 25 Renegade for "\[Shoot Wrex.]"
		- 2 Paragon for saying "Damn it"
	- 8 Paragon for saying either "Calm down." or "We can work this out.", then "What the hell?!" and finally "I'm in command." (Ashley kills Wrex without signaling her)
...
- 9 Renegade for saying "I can't trust you." then "Too risky."
	- 2 Paragon for saying "I think I can trust you." or "I'm letting you out."plus
