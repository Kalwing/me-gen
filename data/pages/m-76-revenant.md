---
title: M-76 Revenant
url: https://masseffect.fandom.com/wiki/M-76_Revenant
game: Mass Effect 3
type: tech
characters: []
scraped: '2026-08-28'
...
The **M\-76 Revenant** is an assault rifle in Mass Effect 2, Mass Effect 3, and Mass Effect: Andromeda.
...
The M\-76 Revenant is only usable by Commander Shepard if Shepard is of the Soldier class and chooses it during the Collector Ship mission.
...
Multiplayer
Weapons are randomly rewarded through purchases of item packs. The M\-76 Revenant is categorized as rare and requires no multiplayer expansion packs.
...
- Multiplayer
General
- The Revenant functions in a similar manner as it did in Mass Effect 2, but it carries 20 fewer rounds per thermal clip, reloads slower, has substantially reduced accuracy, and it has even harsher recoil.
- The M\-76 Revenant has one of the highest capacities of all assault rifles, exceeded only by the Geth Pulse Rifle and N7 Typhoon. This makes the Revenant great at laying down suppressive fire and dealing with large groups of enemies. It definitely lends itself to the "spray and pray" method of combat. The Revenant also carries a good amount of spare ammunition.
- The Revenant slows its wielder's movement when fired, though certain multiplayer classes and all single\-player NPC squad members are exempt from this penalty.
- The Revenant has extremely high recoil and crosshair bloom. It is also not that accurate even by default unless the player aims down sights (zooms), which exacerbates the stability problem. This makes the weapon difficult to use without cover, or in long\-range engagements. To counter this, employ an Assault Rifle Stability Damper mod, focus on being in cover, and fire in controlled bursts at more distant targets.
- You can hit medium to long range targets if you can compensate for the recoil while firing by pulling your aim down. Combining this with a scope mod and firing from cover can make the Revenant a surprisingly accurate and stable weapon.
- The Revenant has a fairly long reload time. A Soldier can mitigate this problem with a well\-timed Adrenaline Rush to reload instantly. Performing a reload\-cancel is also advised.
- The Revenant can't penetrate objects like Guardian shields or enemy armor plating by default, so ammo modification or piercing mods must be equipped; this will usually result in a steep damage penalty.
- Marksman is very effective with high capacity automatic weapons like the Revenant, increasing damage and accuracy; however, muzzle climb is made even more severe.
- The N7 Hurricane deals more damage than the Revenant at less than *half* the Revenant's weight, and it is only somewhat harder to control.
- The N7 Typhoon is considerably heavier than the Revenant, but it is superior in almost every conceivable way and without slowing movement speed. The Revenant does have an advantage over the Typhoon in that there is no damage potential lost when firing shorter bursts, as the Revenant has no need to "spin up".
Single\-player
- The Revenant is a good weapon for squadmates, as they will actually take advantage of the Revenant's full rate of fire unlike with many other weapons. Additionally, they are exempt from the movement penalty, weight, recoil, and crosshair bloom of the weapon. However, the N7 Typhoon is a superior option for squad members in almost every way.
Multiplayer
- Firing the Revenant slows most classes in multiplayer. Drell and vorcha classes are slowed the most, while krogan and batarian classes are only marginally slowed. The Geth Juggernaut Soldier, Krogan Warlord Sentinel, N7 Destroyer Soldier, and all volus classes are exempt from the movement penalty.
- Marksman mitigates the weapon's accuracy issues and also allows for an automatic reload. The Turian Soldier class excels with this weapon.
...
- Multiplayer
Singleplayer
- Combined with a Beam Emitter augmentation, the Revenant turns into an armor destroyer. This combination is excellent option for taking down Destroyers, Fiends, and Hydras.
Multiplayer
...
| --- | --- | --- | --- | --- | --- | --- |
| I | 34 | 620 | 60 | 360 | 40 | 40 |
| II | 36 | 620 | 60 | 370 | 43 | 38 |
| III | 38 | 620 | 60 | 380 | 45 | 36 |
| IV | 41 | 620 | 60 | 390 | 46 | 33 |
| V | 43 | 620 | 60 | 400 | 47 | 31 |
| VI | 45 | 620 | 60 | 410 | 48 | 29 |
| VII | 47 | 620 | 60 | 420 | 48 | 27 |
| VIII | 49 | 620 | 60 | 430 | 49 | 24 |
| IX | 52 | 620 | 60 | 440 | 50 | 22 |
| X | 54 | 620 | 60 | 450 | 50 | 20 |

Multiplayer

| Rank | Damage | Rate of Fire | Max Clip Size | Max Ammo | Accuracy | Weight |
| --- | --- | --- | --- | --- | --- | --- |
| I | 72 | 620 | 66 | 360 | 40 | 40 |
| II | 73 | 620 | 66 | 370 | 43 | 38 |
| III | 75 | 620 | 66 | 380 | 45 | 36 |
| IV | 76 | 620 | 67 | 390 | 46 | 33 |
| V | 78 | 620 | 67 | 400 | 47 | 31 |
| VI | 79 | 620 | 60 | 410 | 48 | 29 |
| VII | 80 | 620 | 68 | 420 | 48 | 27 |
| VIII | 82 | 620 | 69 | 430 | 49 | 24 |
| IX | 83 | 620 | 69 | 440 | 50 | 22 |
| X | 86 | 620 | 70 | 450 | 50 | 20 |

### Development

| Rank | Research Cost | Omni\-Gel Canister | Copper | Cadmium | Element Zero | Augmentation Slots |
| --- | --- | --- | --- | --- | --- | --- |
...
- A revenant is a spirit or corpse brought back from the dead.
