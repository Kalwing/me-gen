---
title: Reaper IFF
url: https://masseffect.fandom.com/wiki/Reaper_IFF
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
If you want a heavy weapon for general combat on this mission, the M\-622 Avalanche's ability to stagger and instakill husks probably makes it your best bet, though both the M\-100 Grenade Launcher and the M\-490 Blackstorm can be effective as well. Alternatively, the M\-920 Cain can drastically shorten the difficult battle at the end of the mission.
...
If Legion was sold to Cerberus, it will appear as an enemy during Priority: Cerberus Headquarters. If it was sold to Cerberus or if it wasn't activated at all, a Geth VI will take its place during the three missions it appears in. If Legion was activated and it survives the suicide mission, it appears in the aforementioned missions and it may be possible to gain both geth and quarian allegiance if Tali is also present. If it does not survive the Collector Base, the aforementioned Geth VI takes its place, but this VI is referred to as a "backup" of Legion, and there are other variations in some interactions and dialogue that account for having known Legion.
...
- Unused text strings appear to depict an indoctrinated voice trying to win Shepard over to the Reapers' side. Writer Chris L'Etoile confirmed it belonged to Dr. Chandana, who would have shown up as a husk in a boss fight in the level.
- Other unused voicelines show squadmates' reaction to hearing Legion speak.
- At the end of the mission, an option to leave the disabled Legion behind was present during development. If Shepard suggested it, squadmates would ask for confirmation, citing it as a rare opportunity, except for Tali, Jacob and Zaeed who approve leaving it. If Shepard confirmed, then the squad would return to the Normandy without taking Legion. The Illusive Man would also send a corresponding email.
