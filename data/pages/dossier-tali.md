...
In terms of heavy weapons, the Arc Projector deals bonus damage to shields and even more to synthetic enemies, and it also possesses several useful secondary effects that can come in especially handy on this mission. There will be one opportunity to change weapons, so you can consider taking one loadout of weapons for the first half of the mission and then switch to a different loadout for the second half, which features some heavily armored opponents, including a "boss" that can be an excellent target for the M\-920 Cain.
...
**Combat Strategy:** It's a good idea to "leapfrog" forward, ordering your squadmates to take specific cover locations before moving up yourself, and so on. The Recon Drones come in distinct waves with breaks in between, so clearing them out quickly gives you more time to deal with the Prime(s). Long range powers and weapons tend to work best for this since you don't have to move up into dangerous territory and risk getting caught in the open by more drones when they show up. Rank 4 Area Overload is excellent for destroying the drone swarms; Adepts can use Singularity to create a floating "flytrap" that will destroy any drones that enter it. Unfortunately, AI Hacking is not effective here, as it won't stop the drones from attacking you or cause them to turn on each other; the most it will do is distract a nearby Prime briefly. It is generally safe to advance between waves of drones, because any new wave will stop in front of your position rather than moving past or flanking you.
...
**Vanguard Exploit:** After opening the shutters, a Vanguard can move to the left window's corner and Charge to the Colossus, which will be interrupted by Kal'Reegar telling Shepard to stop, triggering his dialogue. After conversing with him, the Colossus will be glitched and will no longer fire upon Shepard. It is possible to charge to the Colossus again, where you may attack it freely for a while before geth troops begin spawning from two exits of the wall behind the Colossus. You may also call your squadmates to your position by the Colossus, though they may not survive as you attempt to take it down. Other geth may also be glitched by Charging from the window, usually those near Kal'Reegar.
...
- The idea of the sun damaging the player's squad was possibly re\-used from an unused idea from Caleston/Therum, the planet where Liara T'Soni is found and rescued. A development note mentions Joker telling Shepard to "stick to the shade or you'll get yourself cooked pretty fast down there."
...
- Unused plot data implies the player would have needed to find 3 demolition charges instead of 2 at one point; the locations given are "excavation", "garage", and "supply shed".
- Location and plot data both mention Geth Hoppers, suggesting the enemy type from the first game would have returned in this level.
