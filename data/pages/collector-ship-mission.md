---
title: Collector Ship (mission)
url: https://masseffect.fandom.com/wiki/Collector_Ship_(mission)
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
- Even N7 assignments (e.g. "anomalies") count as a mission, so pick your five missions carefully. Non\-combat assignments (e.g. Omega: Packages for Ish) do not count.
- Even though Overlord technically consists of four separate assignments, it only counts as one for purposes of the countdown.
...
The above will get you to the Collector ship to get the special weapon or training and have it available for as many other missions as possible. Choosing this path will make this challenging mission even harder, but the weapon training is unlocked prior to the combat sections so you will at least gain its benefit for the fight. You may want to plan ahead and obtain specific weapon models or upgrades prior to this mission so your new weapon training will be as effective as possible immediately.
...
- Squadmates can have difficulty climbing up onto the raised platforms that dock with your starting platform (you may have to order them around obstacles with multiple move commands to assist their pathing AI). For this reason, Kasumi can also fail to successfully Shadow Strike the second Scion or any other enemy on the raised platforms. She cannot Shadow Strike the first Scion on the isolated platform.
- You can move onto the first platform that docks with your starting platform, and it's a fairly safe place for your party once the first Scion is dead. However, there is some glitchy map architecture that prevents any powers or gunfire from reaching the second Scion from there, even though it might appear you have clear line of sight.
...
- There is some more glitchy map architecture here that can prevent any hitscan (instant cast, non\-projectile) powers, including squadmates' powers, from landing on enemies on the high ground. You'll either have to use your own projectile powers and weapon fire to take them down from where you enter, or take the braver step of moving your party forward to get unobstructed angles.
...
- Even though he cannot possibly be recruited by the time this mission is played, Legion's presence is accounted for in the squadmate reactions throughout the mission.
- There are a number of alternate voicelines for the Illusive Man during the debriefing.
