...
- Corey Gaspur and other developers once added a volus in a crate in the Mass Effect 3 Multiplayer lobby. The whole thing started as a joke, but positive feedback made them consider the notion seriously. Subsequently, four volus character classes were made available in multiplayer mode with the release of the Mass Effect 3: Retaliation DLC pack.
- Cat Valente, author of Mass Effect Andromeda: Annihilation, consulted with BioWare over what the volus look like beneath their suits, but it was never used in the novel in case the revelation would be done in future games.

## See Also

- The Art of Mass Effect/Life\-Forms\#Volus
- Bonus Content Disc/Creatures: Volus
- The Art of the Mass Effect Trilogy/Mass Effect\#Volus
