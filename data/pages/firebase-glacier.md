---
title: Firebase Glacier
url: https://masseffect.fandom.com/wiki/Firebase_Glacier
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
- The map is divided into 3 sections; the hazard will always move to the section where the game's host is and will start making circles on a predetermined path in this section.
...
- Glacier is by far the fastest map for speedrunning the game solo.
