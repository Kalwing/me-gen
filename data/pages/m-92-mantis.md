---
title: M-92 Mantis
url: https://masseffect.fandom.com/wiki/M-92_Mantis
game: Mass Effect 3
type: tech
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the sniper rifle. For the armor set, see Mantis Armor.* *For the gunship, see A\-61 Mantis Gunship.* |
| --- | --- |
...
- The Mantis is a powerful and precise single\-shot sniper rifle, able to kill most lower\-ranked enemies with a single headshot, often even at higher difficulties with the right damage modifiers. This power is offset by a low rate of fire and a low ammunition reserve.
	- The Mantis does not receive any additional ammunition from either the Off\-Hand Ammo Pack or the Terminus Armor. The 10% bonus to reserve ammunition is not rounded up.
...
Single\-player
- Time dilation effects from using the Sniper Rifle Concentration Mod, Adrenaline Rush, or from the Infiltrator's class power Operational Mastery, can make it much easier to line up shots with the Mantis.
- The Mantis is a very effective sniping option for Ashley or Garrus until more powerful alternatives like the M\-98 Widow, Black Widow, or Javelin become available.

## Trivia

- While the Mantis looks nearly identical to the primary sniper rifle model from Mass Effect, the scope has changed and the multiple levels of magnification are absent. Among the rifles that use this model, the Mantis' texture appears to resemble the Hahne\-Kedar Avenger the most.
