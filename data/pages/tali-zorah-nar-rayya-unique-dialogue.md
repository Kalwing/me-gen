---
title: Tali'Zorah nar Rayya/Unique dialogue
url: https://masseffect.fandom.com/wiki/Tali'Zorah_nar_Rayya/Unique_dialogue
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
- Therum:
	- Exterior surface:
		- "My people have searched many generations for a world to call home. If we landed here, we'd just keep searching."
		- "Even the geth wouldn't want to live in this heat."
	- Inside Prothean ruins: "It looks like this cavern formed around the ruin. After it was built."

- Noveria:
	- Inside Port Hanshan:
		- "My people have dealt with the corporations on Noveria in the past. They pay well, and they don't ask any questions."
		- "From all I've heard, blizzards are quite common here."
	- Outside Port Hanshan:
		- "The appeal of winter wears thin very quickly."
		- "I'm wearing an environmental suit, and I'm still freezing."

- Feros:
	- Zhu's Hope:
		- "These people are brave, but the geth are relentless. My people know this better than anyone."
		- "These colonists may not have much, but this is their home. They will fight to the death to defend it."
	- Prothean skyway:
		- "The geth have brought ruin to this world. As they do to every world."
		- "This city was once a marvel of Prothean technology. Now it's nothing but a graveyard."
	- ExoGeni facility: "I doubt anyone's still alive in here. The geth are very thorough."
	- Thorian:
		- "In all our wanderings, my people have never come across any creature like this!"
		- "Is this thing a plant or an animal? Or something in between?"

- Virmire:
	- Salarian camp:
		- "The upcoming battle frightens me, but I know Saren must be stopped."
		- "The krogan seems very upset."
		- "These salarians are willing to die to stop Saren… and so am I."
		- "I am sensing that Wrex no longer trusts us."
		- (Wrex lives) "Wrex's mood has changed since you spoke with him."
		- (Wrex lives) "I will fight with fire for you, Commander."
		- (Wrex dies) "We will miss the krogan's strength. But I sense the team is better off now that he is gone."
		- (Wrex dies) "I am ready at your word, Commander Shepard."
	- On approach to Saren's base: "This world is beautiful. Too bad it's been contaminated by Saren and his geth."
	- Inside Saren's base:
		- "The salarians are counting on us, Shepard. We can't let them down."
		- "This place is an abomination. Saren's research must be destroyed."

- Ilos:
	- "My people once tried to find this world. We hoped we could settle here. But we didn't know it would feel so… unwelcome."
	- "We shouldn't be here. Not us. Not the geth. Not Saren."

- Final Battle
	- Citadel exterior: "Don't worry about me, Shepard. Quarians are used to making spacewalks. It comes in handy if we have to make repairs on our ships."
	- Presidium/Council Chambers:
		- "Quickly, before it's too late!"
		- "Saren is trying to take control of the Citadel!"
		- "We have to stop him before he brings back the Reapers!"
...
- On Illium:
	...
	- During Samara's recruitment mission:
		- When speaking with Detective Anaya and she says justicars are drawn to impossible causes, Tali may respond, "How convenient for us."
		- When Niftu Cal says he will "toss Wasea about like a rag doll", Tali will remark that "He can barely talk, much less fight."
