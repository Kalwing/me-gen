---
title: 'N7: Archeological Dig Site'
url: https://masseffect.fandom.com/wiki/N7:_Archeological_Dig_Site
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
**Outgoing Message: Request for Aid**
...
**Incoming Message: Let's Make a Deal**
...
- Instead of the vision Shepard experiences when interacting with the console, an alternative sequence exists in the files which has the console itself display the Milky Way, followed by a Reaper approaching a planet and blowing it up.
...
| --- | --- | --- |
|  | Assignments | N7: MSV Strontium Mule |
