...
url: https://masseffect.fandom.com/wiki/Flashbang_Grenade
game: Mass Effect 2
type: lore
characters: []
scraped: '2026-08-28'
...
- Improved Flashbang grenade has the largest radial area of effect of any power with the exception of Tech Armor's detonation.
- **Bonus Power:** When used by Shepard as a bonus power Flashbang Grenade has some unique properties:
	...
	- **Warning:**  Shepard's version of Flashbang Grenade can affect Shepard and also squadmates at very close range. This causes no damage, but it will momentarily stagger squadmates and Shepard and can also blind Shepard. Fortunately, the grenade must go off almost right at the feet of Shepard for the blinding effect to occur. Kasumi's version of the power does not cause adverse effects to allies.
...
- Flashbang's ability suppression effect is useful against enemies with Tech Armor or Barrier as it will prevent them from restoring their shielding. However, Geth Troopers cannot be prevented from restoring their shields with Flashbang.
