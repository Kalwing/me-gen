---
title: 'Codex (Mass Effect: Andromeda)'
url: https://masseffect.fandom.com/wiki/Codex_(Mass_Effect:_Andromeda)
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the Codex for Mass Effect: Andromeda. For the original trilogy Codex, see Codex.* *For the guide to collecting Codex entries in this game, see Codex Entry Guide (Mass Effect: Andromeda).* |
| --- | --- |
