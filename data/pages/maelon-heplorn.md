---
title: Maelon Heplorn
url: https://masseffect.fandom.com/wiki/Maelon_Heplorn
game: Mass Effect 3
type: character
characters: []
scraped: '2026-08-28'
...
In 2185, Maelon is reported as captured by krogan warriors from Clan Weyrloc attempting to reverse the effects of the genophage virus. Mordin requests the aid of Commander Shepard in retrieving Maelon from his captors.
...
If Maelon was spared, he follows Mordin's advice and opens his own clinic on Omega, but he goes into hiding after Clan Weyrloc places a bounty on him. He also sends a message to Shepard if the genophage is cured.
