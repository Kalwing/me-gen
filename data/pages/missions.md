---
title: Missions
url: https://masseffect.fandom.com/wiki/Missions
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
*See also: Assignments, Mass Effect Guide, Mass Effect 2 Guide, Mass Effect 3 Guide, Mass Effect System Guide, Storyline*
...
Missions are listed mostly in the order they are received although some of the name updates happen after you receive another mission. Note that these missions are listed as they initially appear in the Journal, the names of missions do change as the game progresses.
...
- Noveria: Geth Interest → Noveria: Leave Port Hanshan
...
*See also: Mass Effect Galaxy Guide*
...
→ Collector Base: Final Battle (no formal Journal entry)
