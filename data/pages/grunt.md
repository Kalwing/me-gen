...
EDI suggests visiting Tuchanka to consult a krogan clan leader, and Shepard goes to Clan Urdnot for assistance. The clan leader explains that Grunt is undergoing the krogan equivalent of puberty. Grunt must take part in a Rite of Passage with Shepard at his side as his krantt to prove himself a worthy krogan and join a clan, or die in the attempt.
...
- Lukas Kristjanson was the main writer for Grunt in the second game, taking over after some first pass drafts by Brian Kindregan.
...
- In an interview video, writer Mac Walters reveals that Grunt was inspired by Garrus' assignment in the first game, more specifically the aspect of letting Shepard decide the moral orientation of a squadmate, but taken to the extreme through the idea of raising a baby krogan. See Cut Content below.
...
- Grunt can use a unique charge ability against nearby enemies, making him the only squad member with a spontaneous melee attack that is not an active power.
- There is a bug where Grunt may be unable to use his Fortification power after his loyalty mission is completed, and be listed as not loyal despite having the red loyalty ring around him in the squad selection screen. This will not have an effect on the suicide mission. This bug was fixed with a title update on May 17, 2010\.
- In the Shadow Broker's Video Archive, Grunt is mentioned as "Okeer Test Subject Number 317".
- In the Mass Effect 2 Cinematic Trailer, the Illusive Man's computer states Grunt is 300\+ years old. According to the defunct character sheet on BioWare's site, it claims his age is 22\.
- Grunt does not appear in an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file. His absence on the memorial wall implies he never became part of Shepard's squad, i.e. he was not released from his tank.
...
- An internal document used in the early development of Mass Effect 2 contained the concept for a squadmate nicknamed "Design\-A\-Krogan": Cerberus would provide Shepard with a krogan breeding chamber which could use genetic material from suitable parents (like Urdnot Wrex if alive) to grow an adult krogan. The Commander could then raise him to acquire either a Paragon or Renegade personality. This formed the basis for Grunt, although he was made more mature and self\-deciding than originally suggested.
- An unused journal entry shows that Grunt could at one point be killed right after being awakened on the Normandy.
- A minor argument between Grunt and Shepard was cut from the game in the loyalty mission's aftermath if Shepard chose not to let Grunt speak for himself regarding Gatatog Uvenk's offer to join his clan.
- A confrontation between Grunt and Mordin was planned at some point following the completion of their loyalty missions, similar to the ones between Miranda and Jack or between Tali and Legion. Taking his new\-found allegiance to the Urdnot clan seriously, Grunt would turn hostile against Mordin, considering him a threat against his clan. Barring the use of persuasion skills, Shepard could side with Grunt by claiming that his clan's continued existence alone proves Mordin's work has failed. In the alternative, Shepard could later reconcile with Grunt by convincing him that he is the one with the thicker skin.
...
- Mass Effect 2 Character Concepts\#3b. The Design\-A\-Krogan
- Mass Effect 2 Art Book/Texts\#01: Heroes and Villains
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Grunt
