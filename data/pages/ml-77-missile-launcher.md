...
url: https://masseffect.fandom.com/wiki/ML-77_Missile_Launcher
game: Mass Effect 2
type: tech
characters: []
scraped: '2026-08-28'
...
- The missiles of the ML\-77 are seeking projectiles and they will always attempt to home in on any active enemy targets in the area (regardless of whether Shepard can see them). This includes targets using cloaking abilities such as Geth Hunters.
	...
	- A missile appears to acquire a target almost immediately after being fired, and target acquisition appears erratic and random, with successive missiles rarely choosing the same target if there are multiple enemies present.
	...
	- The detection range for missile target acquisition is *very* long; in general, if there is any enemy active in the current battle space, ML\-77 missiles will home in on them.
...
- Like the grenades fired by the M\-100 Grenade Launcher, ML\-77 missiles deal explosive damage in an area and possess a force component that enables them to stun/stagger enemies hit and instantly kill husks. A single missile will kill a Husk or a glowing Abomination on all difficulties except Insanity.
...
- The inability to single out and focus on one particular target in a crowd with this weapon is in most cases a frustrating weakness, though not always. It can be useful for finishing off or stunning multiple but highly spread out enemies moving erratically.
- Even though the missiles seek enemies, fast\-moving foes such as varren and FENRIS Mechs can evade them at long range. The missiles track targets more aggressively at shorter ranges, though this increases the chance of self\-damage.
- It is useful for being able to attack with impunity while totally obscured from enemy view, something not possible with conventional or even most heavy weapons. This can be useful for fighting especially dangerous enemies such as Gunships, YMIR Mechs, or the Oculus which can deal considerable damage to an exposed player and often move unpredictably.
- Homing missiles can be useful in fights where direct lines of attack are very awkward due to differences in elevation or a lack of effective cover.
- Missiles can home in on targets even if they are currently out of sight behind cover, making the ML\-77 capable of laying down suppressive fire if you or allies must expose themselves out of cover for any reason. Since enemies have a tendency to pop out of cover to attack whenever you do, missiles that were already launched while they were hiding can hit and stun them the moment they pop out, if you time your moves well.
