---
title: Planet Scanning
url: https://masseffect.fandom.com/wiki/Planet_Scanning
game: Mass Effect 2
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about scanning planets for resources in Mass Effect 2\. For the system in Mass Effect 3 to recover War Assets, see Search and Rescue. Scanning for Resources planetside in Mass Effect: Andromeda additionally requires the Omni Tool.* |
| --- | --- |
...
- **Only scan RICH worlds.** And maybe sometimes "Good" ones. Don't bother tiresomely scanning resource poor or even moderate worlds. Just the "rich" worlds that you have access to at the very beginning of the game are enough to get you all the resources you ever need! Resource rich locations are almost always smaller rocky planets, not gas giants.
...
- **Mix assignments and mining.** Assignments, as well as some missions worlds, are often rich in resources. Some of these same locations also have Element Zero. If you mine the rich worlds in a system where you currently have business, you will need very few, if any, purely mining trips. Also, prioritize mining in non\-relay systems you find yourself in, as those cost fuel to fly to.
