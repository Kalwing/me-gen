---
title: Krogan Hammer
url: https://masseffect.fandom.com/wiki/Krogan_Hammer
game: Mass Effect
type: tech
characters: []
scraped: '2026-08-28'
...
However, this weapon is comparatively slow. It takes about a second and more from upswing (prepping the hammer) to downswing (dealing damage), which in battlefield conditions translates to plenty of time to be counterattacked, or for the intended target to slip away.

Three characters can wield the Krogan Hammer: Pathfinder Ryder, Nakmor Drack, and the Krogan Gladiator.
...
- Running towards the target then using the hammer helps offset its slowness as forward momentum propels the character while the weapon animation is executing. Dashing, however, doesn't as there is a momentary pause between the end of the dash and the start of the upswing animation.
