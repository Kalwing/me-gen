...
Proceed along the linear pathway until you come to a crashed quarian escape pod. A Geth Trooper and Geth Pyro will be standing with their backs to you. It is possible to flank them by taking a path to the far right side. It seems too close, but hugging the right side will prevent them from noticing you. Notice that if you get close enough carefully, a teammate will shout "GETH". Should you prefer a more aggressive approach, you can eliminate the hostiles immediately. Decide on your strategy, and afterward, a squad member will go forth to analyze a dead quarian using their omni\-tool. Before proceeding to your main destination, don't forget to salvage the wreckage worth 2,500 credits next to the burning debris, and also make a circular loop around the path on your right to pick up the salvage labeled Geth Parts for 2,500 credits. Proceed along the trail and be careful; there are multiple Geth Trip Mines on the ground. Pick up the Javelin on the ground next to a trip mine before progressing.
...
**Tip:** If you do choose to follow the left hand path first, note that there is a ladder you can use to drop to the ground and move around to the far left to flank the turret you encounter on that side. You'll find another ladder behind the turret's field of fire than you can climb up again to reach the AA gun deck.
...
- If Admiral Koris dies, the Quarian Civilian Fleet War Asset will be reduced by 75 Military Strength. Also, depending on your other choices, it may not be possible to make peace between the quarians and geth at the end of Priority: Rannoch.
...
- Regardless of which mission you do first (Rannoch: Geth Fighter Squadrons or **Rannoch: Admiral Koris**), the two arguments below will occur in this order:
	- After the first completed mission, Admiral Raan starts arguing with Admiral Gerrel. Shepard can choose to "support" one or the other. Supporting Admiral Raan **reduces** the value of the Quarian Heavy Fleet war asset by 10\. Supporting Admiral Gerrel **increases** the value of the same by 25\.
	- After the second completed mission, Admiral Xen starts arguing with Tali. Shepard can choose to "support" one or the other. Supporting Admiral Xen gives you the Advanced AI Relays war asset worth 45 war assets, meanwhile supporting Tali will provide 2 Paragon points.

## Rewards

*See also: Equipment Guide (Mass Effect 3\)*
- **Total credits**: 25,000
	- Credits found: 12,500 (in 4 pickups)
	- Alliance Funding: 12,500
- **Medi\-gels**: 2 units (in 1 pickup)
- **Weapons**: Javelin
- **Weapon mods**: Assault Rifle Magazine Upgrade, Shotgun Shredder Mod, SMG Magazine Upgrade
- **Armor pieces**: Armax Arsenal Chest
- **Mission Related**: Target Jamming Technology
- **Morality**: Morality Guide (Mass Effect 3\)\#Rannoch: Admiral Koris
...
- This mission was written by Sylvia Feketekuty.
