---
title: 'Kallini: Ardat-Yakshi Monastery'
url: https://masseffect.fandom.com/wiki/Kallini:_Ardat-Yakshi_Monastery
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
**Note:**  Though the mission's name suggests you should go to the Kallini system of the Nimbus Cluster, the monastery is actually in the Mesana system (Nimbus Cluster) on the planet Lesuss. This is partially fixed in Legendary Edition, where prior to completing the mission it is referred to as "Mesana: Distress Signal" in the Journal, though after completing the mission it reverts to being called "Kallini: Ardat\-Yakshi Monastery".
...
- **Total credits**: 25,000
	- Credits found: 12,500 (in 2 pickups)
	- Alliance Funding: 12,500
- **Medi\-gels**: 11 units (in 4 pickups)
- **Weapons**: Disciple
- **Weapon mods**: Assault Rifle Stability Damper, Pistol Melee Stunner, Sniper Rifle Spare Thermal Clip, Assault Rifle Precision Scope
- **Armor Pieces**: Serrice Council Shoulder Guard
- **Intel**: Gallae's Electronic Signature
- **Mission Related**: Asari Widow
...
- If Tali is spoken to in the engine room following this mission, she may comment on the events at Sanctuary even before Shepard actually goes there; she may also say she hopes that the Catalyst is found soon. These comments were likely meant to occur following Priority: Horizon instead.
