...
url: https://masseffect.fandom.com/wiki/Artificial_Intelligence
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
- In early development of Mass Effect 2, an AI squadmate (other than geth) was being considered for the game. Nicknamed "the Tank", this would've been a large "deactivated 75\-year old robot" that Shepard could buy or repair through scavenging. It was noted that this squadmate could open up interesting interactions if traveling to Citadel space since it's an illegal AI, or that it could provide discussions on slavery and AI ownership.
