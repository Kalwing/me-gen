---
title: Turian Sentinel
url: https://masseffect.fandom.com/wiki/Turian_Sentinel
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
| | **Shield:** 750 / **Health:** 500 | | | --- | --- | | **Class: Turian Veteran** | | | Warp |  | | Overload |  | | Tech Armor |  | | Fitness |  | |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

## Melee and movement

|  | - **Regular Melee** – Punch 	- **Melee Sequence:** The Turian Sentinel executes a series of up to three punches. - **Heavy Melee (Dual Omni\-Blades)** – The Turian Sentinel generates two omni\-blades and slashes horizontally. - **Grab (Omni\-Blade Stab)** – The Turian Sentinel drags an enemy over cover and then executes them by stabbing with an omni\-blade. |
| --- | --- |
|  | - **Dodge** – The Turian Sentinel lacks a dodge maneuver. - The Turian Sentinel can take cover, and can roll from cover to cover. |
...
- An enemy hit by Warp will possibly be under a debuff, increasing all the damage it receives. In particular, it becomes an excellent target for Incendiary Rounds or Warp Rounds.
- Overload is a power of multiple contact points and as such, it can detonate multiple Power Combos in one cast. Casting powers such as Snap Freeze or Arc Grenade in front of an Overload\-spamming Turian Sentinel is likely to enable a large quantity of combo detonations.
