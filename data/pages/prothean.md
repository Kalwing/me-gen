---
title: Prothean
url: https://masseffect.fandom.com/wiki/Prothean
game: Mass Effect 3
type: species
characters: []
scraped: '2026-08-28'
...
In addition to the technology they left behind, the Protheans left a greater influence through their in\-depth study of other races. Their work has had the greatest impact on asari, humans, and the hanar. A Prothean ruin on Eletania reveals that the elder race was monitoring humanity even in its early Cro\-Magnon form. The eventual discovery of a relatively small data cache in a ruined Prothean research station on Mars introduced humans to element zero and its follow\-on technologies, advancing the species' development by a few centuries at least. It also revealed the location of the Charon Relay, enabling humanity to become an interstellar civilization and a major galactic power almost overnight.

The hanar, who call the Protheans "the Enkindlers", credit them with giving the hanar sentience and language, and worship them as a wise and benevolent race who allowed them to become civilized.

Even more profound was the Prothean influence on the asari. One of the deepest secrets of the asari government is a collection of ancient asari relics held in a temple on Thessia. The relics show asari goddesses and their companions as Protheans. The asari were nurtured and, to a degree, uplifted by the Protheans, according to the last surviving Prothean, Javik. Even the asari aptitude for biotics was apparently cultivated by the Protheans. Javik also claims his people believed the asari would be a failsafe if the Protheans were exterminated—that the asari race's innate wisdom and patience combined with the head start gifted from Prothean intervention would enable it to succeed where its benefactors failed, defeating the Reapers in the next cycle.
...
| - Agetoton - Antibaar - Binthu - Bira - Chasca - Corang - Eden Prime - Eletania - Fehl Prime - Feros - Garvug - Gei Hinnom - Ilos | - Joab - Kahje - Karumto - Kopis - Mars - Quana - Sharring - Therum - Thessia - Tuntau - Zada Ban - Zafe |
| --- | --- |

## Trivia

- The name "Prothean" may derive from the Greek words 'protero', meaning "earlier" or "former"; 'proto', meaning "primary" or "first"; and 'protean', referring to that which is changeable or adaptable. Another possibility is that the name derives from the words 'proto' or 'protero' and 'theos', meaning "God". Depending on how the words 'proto' or its derivative 'protero' are interpreted, the word "Prothean" could mean "someone who existed before Gods" or "the first or former God". The name also bears a resemblance to Prometheus, the mythological Titan who gave mortals the gift of fire, enabling them to learn the arts of civilization, much like how the Protheans helped advance primitive species including humans. The hanar refer to the Protheans as "Enkindlers", a word that connotes fire.
...
- The Codex image for the Protheans in Mass Effect 2 and Mass Effect 3 shows some resemblance to a Husk, particularly in the glowing blue lights present on the upper body. This image resembles the statues found on Ilos, but does not resemble Javik or representations of living Protheans.
	...
	- According to senior\-writer John Dombrow, the Inusannon represent the mentioned statues on Ilos.
...
- Early in the conception of the first game, a story draft titled "Master Slaves" revolved around the revelation that humanity had been a slave race to a now\-extinct race of advanced aliens called Nazari, who had built the mass relays and other technological marvels. Due to this unique connection to the Nazari, humans were supposed to be gifted for understanding and manipulating Nazari technology. While the Nazari as a whole would later on be developed into the Reapers, the special connection with an ancient extinct alien species would form the basis for Commander Shepard's interactions with Prothean beacons and technology.
- An internal document listing ideas for potential Mass Effect 2 squadmates contained the concept of a Prothean hologram character who would be found drifting in space after being disconnected from its docking unit. New lore associated with this hologram would have revealed that in the age of the Prothean Empire, holograms were fighting for their rights and to be considered equal to organics. After finding it a new docking unit, this hologram squadmate would have been restored into the actual appearance of a live Prothean.

## See Also

- The Art of the Mass Effect Trilogy/Mass Effect 3\#Javik
- BioWare: Stories and Secrets from 25 Years of Game Development/The Making of Mass Effect 3\#Untitled Anecdote 7
