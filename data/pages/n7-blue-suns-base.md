---
title: 'N7: Blue Suns Base'
url: https://masseffect.fandom.com/wiki/N7:_Blue_Suns_Base
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
**Blue Suns Ambush Site Detected**
...
**Client Agent Incoming**

---

An agent from the prospective client arrived today. The client has asked for discretion, which raised a few red flags. On Commander Santiago's suggestion, I plan to persuade the agent to divulge the nature and location of the cargo.

**Prothean Artifact Confirmed**

---

Well, that didn't take long. The client's agent folded under minimum pressure. Commander Santiago's hunch was correct: the client hopes to hire us to move a Prothean artifact from the dig site. With a little more pressure the agent should gladly give up the location of the dig site itself.

**Dig Site Location Confirmed**

---

It took some persuasion, but the agent gave up the location of the dig site. I'm dispatching ships and men to the location now. Santiago ought to be pleased. That Prothean artifact is worth much more than we'd ever get for transporting it.
...
| ← Previous Assignment | Assignment Index | Next Assignment → |
| --- | --- | --- |
| N7: MSV Strontium Mule | Assignments | N7: Javelin Missiles Launched |
