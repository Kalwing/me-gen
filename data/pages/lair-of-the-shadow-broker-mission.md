---
title: Lair of the Shadow Broker (mission)
url: https://masseffect.fandom.com/wiki/Lair_of_the_Shadow_Broker_(mission)
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
- Boss fight with a minion
- Lair of the Shadow Broker
- Deeper into the lair
- Expose the Shadow Broker once and for all
1/5Cerberus has delivered information on purchases the Shadow Broker has made recently. It may provide the information Liara T'Soni needs to track down the Shadow Broker's location.
...
**Squadmate Powers Tip:** For both of the major "boss" enemies to come in this mission, Stasis will stun or at least distract them even when they have intact protections. It also instantly destroys the flying drones you will encounter from time to time, and of course it has its traditional ability to simplify a combat by temporarily removing and knocking down any enemy footsoldier. For these reasons, fully upgrading Liara's Stasis with the Enhanced Stasis evolution is strongly recommended. Fully max out Asari Scientist as well, and don't waste any extra points on Singularity.
...
- Credits: 90,000\*
	- Cerberus Funding: 45,000
	- Credits Found: 54,000\*
- Resources
	- Element Zero: 1,000
	- Palladium: 4,000

\*In\-game Mission Complete screen reports inaccurate values, see Bugs section below

## Bugs

- The in\-game Mission Complete screen is currently bugged and displays incorrect values for both Credits Found and Total Credits Earned. The actual maximum amount of credits you can find from pickups is 54,000\. In addition, there is a hidden cap of 90,000 on total credits earned from completing the mission. In other words, it is possible to miss up to 9,000 credits worth of pickups and still be awarded the maximum possible 90,000 credits. Also note that this maximum does not count credits from salvaging medi\-gel and power cells. For example, if you found 48,000 credits and salvaged 5 medi\-gels and 2 power cells, your total credits earned from the mission would be 90,700, regardless of what the "Mission Complete" screen displayed.

## Trivia

- Several writers contributed to this mission: Jay Watamaniuk (the Illium section), Sylvia Feketekuty (the Shadow Broker ship), Trick Weekes (general plot outline, and Liara throughout the entire DLC), and Mac Walters for supervising the whole.
- According to Senior Designer Dave Feltham, the Tela Vasir chase was inspired by the chase on foot after Zhora in *Blade Runner*, and the car chase by the one in *The Fifth Element*.
...
- A rather extensive development script was recovered from the DLC's files, detailing the mission's various cutscenes and player progression.
...
- According to writer Trick Weekes, earliest plans for the DLC were to rescue Liara from the Shadow Broker, but they were abandoned due to making Liara appear more vulnerable than what she was supposed to have become. Later on, the chase after Vasir was supposed to take Shepard from Illium to Omega, but the team decided to keep the narrative arc on Illium.
- At some point, Liara was meant to return to her Illium office even after assuming the role of Shadow Broker. In the resulting inaccessible dialogue, she was able to shed some light on the reason the Collectors were after Shepard: to find genetic abnormalities, among other things. Writer Trick Weekes commented on this in an interview, saying that it was a temporary dialogue but plans later changed. In the same dialogue, Liara may call Shepard "Shadow Broker." According to Weekes in the same interview, having Shepard become the Shadow Broker was one of the ideas the writing team was considering in early stages.
- An unused conversation implies it was possible at one point to launch the mission remotely via comms, without even visiting Liara in her office.
- During the conversation with the Shadow Broker, a dialogue option telling him that he should be more concerned about the Reapers was removed.
- In Shepard's cabin, when Liara says she needs to know Shepard will always come back, an option to deny it was removed from the game.
- Unused voicelines were uncovered which depict the Illusive Man thanking Shepard for killing the Shadow Broker, which he calls an "old friend." He also approves of Liara taking over the position, describing her as an "invaluable" asset.
