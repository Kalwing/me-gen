...
- An early development scene in Mass Effect showed a geth unit helping another damaged unit; it didn't reflect the coldness inherent to a race of war\-waging robots, leading to art director Derek Watts making fun of the scene during a preview by singing "Lean on Me." The scene was dropped, and the dragon's teeth were invented to make the geth scarier.
- Writer Chris L'Etoile noted that the geth's outlook on other species was meant to be specifically different from Data or the Borg from *Star Trek*; he aimed to make them reflect on living beings from a more passive and distant viewpoint.
...
- While the geth were chosen to serve as an antagonistic race from early on during the first game's development, Saren's army was originally made up of batarians instead, when they had a different, bat\-like appearance.
- Before the character of Legion was properly conceptualized, an early idea for a geth squadmate called the "Geth Frankenstein" consisted of a "boss"\-type geth unit that Shepard would find disabled. After finding parts to fix it, this geth unit would eventually become aware again but was said to struggle with the "silence" resulting from being cut off from the geth network.

## See Also

- The Art of Mass Effect/Life\-Forms\#Geth
- The Art of Mass Effect/Transport\#Geth Ships
- Bonus Content Disc/The Making of Mass Effect\#Creating Characters \& Races
- Bonus Content Disc/Creatures: Geth
- Bonus Content Disc/Technology: Space Vehicles \- Geth
- The Art of the Mass Effect Trilogy/Mass Effect\#Geth
- The Art of the Mass Effect Trilogy/Mass Effect\#Geth Technology
- The Final Hours of Mass Effect 3/Chapter 4: Codename SFX
