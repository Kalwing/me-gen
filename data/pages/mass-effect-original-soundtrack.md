---
title: Mass Effect Original Soundtrack
url: https://masseffect.fandom.com/wiki/Mass_Effect_Original_Soundtrack
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
- Several compositions from the game are not included as tracks on the album. However, many of the missing tracks have been extracted from the game, and uploaded into the Wiki. See Mass Effect Cut Content/Soundtrack.

|  | "Strangers" |
| --- | --- |

- The bonus content disc of the Mass Effect Limited Collector's Edition contains an exclusive music track called "Strangers" not found elsewhere, though it could be heard partially in menus in all editions of the bonus disc. Some of the other tracks also sport different names: 'Battle for Revenge' for 'Battle at Eden Prime', 'The Plaza' for 'Noveria', 'The Mako' for 'Virmire Ride', and 'Romance Theme' for 'Love Theme'.
...
- "Uncharted Worlds", the theme associated with the Galaxy Map in the Mass Effect trilogy, makes an appearance in the 2025 documentary *What Exactly Is Inside Jupiter?*

## Availability

- iTunes Store (will launch iTunes application)
- Australian iTunes Store (will launch iTunes application)
- Spotify (will launch Spotify application)
- Amazon.com
- Beatport
...
- Mass Effect Cut Content/Soundtrack
