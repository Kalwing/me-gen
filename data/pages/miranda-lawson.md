...
url: https://masseffect.fandom.com/wiki/Miranda_Lawson
game: Mass Effect 3
type: character
characters: []
scraped: '2026-08-28'
...
- Imported save file
- Romance import
- Non\-import game with default conditions

**Meet me on the Citadel**
...
I'll be waiting on the Citadel by Bay D24\.
...
It's been a while since we've worked together. But I trust you. A very rare commodity since I walked away from Cerberus and the Illusive Man. We should talk. It's safer in person.
...
After Shepard retakes the Normandy, Miranda may visit the Citadel and can be invited up to the Commander's apartment for a drink. The two discuss the recent events with Shepard's duplicate, which Miranda heard of secondhand through several confusing reports that made it sound like the real Shepard had lost their mind. She also reveals she knew about Maya Brooks in her Cerberus days, though under a different alias; all Miranda knew is that Maya was the one who compiled the dossiers for Shepard's team in the mission against the Collectors, and nothing more because Miranda was focused on bringing Shepard back to life at that time. If Shepard is in a romance with Miranda, they share an intimate moment.
...
- Chris L'Etoile wrote the first drafts for Miranda's character, before she was taken over by Mac Walters and Trick Weekes. Most of the confrontation with Jack was written by Brian Kindregan.
...
- According to a Mass Effect 2 character document used during development, Miranda was conceptualized as a 35\-year\-old "Cerberus Superwoman" whose loyalty can be secured by helping her learn more about the Illusive Man. She had both parents as opposed to having only Henry Lawson for a father. She is described as a manipulative predator, treating both Shepard and Jacob as playthings at first, and would only be interested in a genuine romance with Shepard if her loyalty is high enough. Near this point in development, her name was Serafina Guerrero de Vallado, nicknamed Sera. "Serafina" means "fiery" or "burning", while "Guerrero de Vallado" approximately means "fencing warrior" in Spanish.
- Later on, after the first name Miranda was decided, her original surname was Solheim, Norwegian for "Sunhome." This was chosen in part because she is one of the relatively rare characters born on Earth (i.e. from the Sol system).
...
- Mass Effect 2 Character Concepts\#1\. Cerberus Superwoman
- Mass Effect 2 Character Concepts\#Cerberus Female
- Mass Effect 2 Art Book/Texts\#01: Heroes and Villains
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Miranda Lawson
