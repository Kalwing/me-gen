---
title: 'Priority: The Citadel II'
url: https://masseffect.fandom.com/wiki/Priority:_The_Citadel_II
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
**Warning:**  Priority: Citadel II itself is a "point of no return" for Grissom Academy: Emergency Evacuation, which must be completed prior or it will become unavailable and be considered failed (Specialist Traynor will notify you afterwards that Elysium fell to the Reapers and everyone at the academy is almost certainly dead).
...
- If Thane is not around but Captain Kirrahe survived the events of Virmire, Leng will attempt to kill the councilor, but a cloaked Kirrahe will take the blow instead, dying in the process. As he was never a member of the Normandy's crew, Kirrahe's name will not appear on the ship's Memorial Wall.
...
| **Factor** | **Yes** | **No** |
| --- | --- | --- |
| Romanced Ashley/Kaidan in Mass Effect | \+2 | \+0 |
| • Cheated on them in Mass Effect 2 | −1 | \+0 |
| Saved the Council in Mass Effect | \+1 | −1 |
| Kept Kirrahe or Thane alive through to Mass Effect 3 and save the salarian Councilor (otherwise Udina will produce a fabricated video of Shepard assassinating the salarian Councilor) | \+0 | −2 |
| Shepard was kind to Ashley/Kaidan during Priority: Mars | \+1 | −1 |
| Visited Ashley/Kaidan in the hospital once (when they were awake) | \+2 | \+0 |
| • Admitted and/or apologized for cheating on Ashley/Kaidan (if Shepard did cheat on them in Mass Effect 2\) | \+0 | −1 |
| • Visited them in the hospital a second time | \+1 | \+0 |
| Lowered their weapons against Ashley/Kaidan during the final confrontation | \+1 | \+0 |

**Final trust level:**

| −1 or below | → Ashley/Kaidan cannot be talked down |
| --- | --- |
| 0–3 | → Reputation check |
| 4 or higher | → Ashley/Kaidan automatically sides with Shepard |
...
- Finally, optional Squad Members / War Assets may make themselves available:
	- Assuming you didn't shoot Ashley/Kaidan, they will approach you at Normandy Dock: Bay D24 as you try to board the Normandy. You have the option to ask them rejoin your squad as a party member (although it's possible for them to refuse), in which case Ashley or Kaidan will take up residence in the Starboard Observation Lounge on the Normandy and become available for both missions and shipside chats. If they aren't asked to join or refused Shepard's offer, they will remain on the Citadel as War Assets (25\). If they join Hackett, you will be unable to interact with them socially aside from an e\-mail from Ashley/Kaidan saying good\-bye.
...
- **Total credits**: 25,000
	- Credits found: 25,000 (in 4 pickups)
	- Alliance Funding: none
- **Medi\-gels**: 12 units (in 5 pickups)
- **Weapons**: M\-76 Revenant, M\-25 Hornet, M\-358 Talon
- **Weapon mods**: Assault Rifle Piercing Mod, Sniper Rifle Extended Barrel, Pistol Piercing Mod, Pistol High\-Caliber Barrel, Sniper Rifle Piercing Mod
- **Armor Pieces**: Recon Hood, Securitel Helmet
...
- In an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file, both Thane Krios and Kirrahe are dead, making the salarian councilor (Esheel) impossible to save.

Mass Effect 3 Navigation

| ← Previous Mission | Mission Index | Next Mission → |
| --- | --- | --- |
| Priority: Tuchanka | Missions | Priority: Perseus Veil |
