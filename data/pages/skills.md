---
title: Skills
url: https://masseffect.fandom.com/wiki/Skills
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
| Combat | Tech | Biotics |
| --- | --- | --- |
| Omni Grenade | Overload | Pull |
| Concussive Shot | Incinerate | Throw |
| Barricade | Assault Turret | Charge |
| Turbocharge | Cryo Beam | Nova |
| Trip Mine | Energy Drain | Shockwave |
| Flak Cannon | Tactical Cloak | Annihilation |
| Pistols | Flamethrower | Backlash |
| Assault Rifles | Unknown (Remnant VI) | Singularity |
| Shotguns | Invasion | Lance |
| Sniper Rifles | Team Support | Barrier |
| Combat Fitness | Offensive Tech | Offensive Biotics |
| Combat Tools | Auxiliary Systems | Containment |
...
| --- | --- | --- | --- | --- | --- |
| Cora Harper | Charge | Nova | Shield Boost | Asari Commando | Defensive Training |
| Jaal Ama Darav | Energy Drain | Sticky Grenade | Avenger Strike | Rebel Soldier | Resilience |
| Liam Kosta | Frag Grenade | Havoc Strike | Overload | Military Training | Defense |
| Nakmor Drack | Blood Rage | Incinerate | Flak Cannon | Krogan Warrior | Grizzled Veteran |
| Pelessaria B'Sayle | Invasion | Pull | Shockwave | Duelist | Survivalist |
| Vetra Nyx | Power Armor | Concussive Shot | Turbocharge | Turian Smuggler | Defensive Expert |
