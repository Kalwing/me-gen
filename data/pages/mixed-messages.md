...
url: https://masseffect.fandom.com/wiki/Mixed_Messages
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
The mission is acquired if after talking to Jim in The Docks' observation deck jail (on the upper floor, to the west and above the dock entrance; this mission is not marked with a hexagonal marker on the map when it is available to be acquired), but only if you agreed to deliver the message. You can talk to him again if you declined the first time and you've changed your mind.
