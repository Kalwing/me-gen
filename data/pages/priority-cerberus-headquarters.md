---
title: 'Priority: Cerberus Headquarters'
url: https://masseffect.fandom.com/wiki/Priority:_Cerberus_Headquarters
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
Until you're ready to return to Earth for the final battle, you still have free run of the Normandy herself, and you should feel free to check in with the crew and hear any final comments they might have. Visit Cortez's shopping depot to make any last purchases (the Citadel shops are somehow still available to make remote purchases from, despite the station now being under Reaper management). Do Mass Effect 3: Galaxy at War activities if you need some last\-minute buffing of your War Assets. Note that you've received either the Reaper Heart (100\) or the Reaper Brain (110\) as War Assets augmenting the Crucible. **Legendary Edition:**  the Galaxy at War system is not in Mass Effect Legendary Edition and War Asset numbers are treated as if Galactic Readiness is at 100%.
...
- **Total credits**: 80,000
	- Credits found: 25,000 (in 5 pickups)
	- Alliance Funding: 55,000
- **Medi\-gels**: 15 units (in 6 pickups)
- **Weapons**: M\-37 Falcon
- **Armor pieces**: Serrice Council Greaves, Delumcore Overlay
- **Morality**: Morality Guide (Mass Effect 3\)\#Priority: Cerberus Headquarters
...
- According to former cinematic designer Violet McVinnie, Kai Leng was originally slated to die in combat. She advocated for the sequence where Leng attempts a sneak attack, only for the player to be presented with an interrupt option to stab him.
...
| --- | --- | --- |
| Priority: Horizon | Missions | Priority: Earth |
