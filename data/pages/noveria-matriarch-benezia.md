...
url: https://masseffect.fandom.com/wiki/Noveria:_Matriarch_Benezia
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- Play corporate intrigue games
- Leave Port Hanshan
- Reach Peak 15
- Fix Peak 15's problems
- Reach Rift Station
- Confront Benezia
1/6Matriarch Benezia, a top advisor to Saren, is on Noveria. If you can capture her, it is likely she has insight into his plans.
...
- On newer AMD CPUs, a bug may cause models in the game, including that of Shepard and the squad, to be rendered as blocks of black pixels upon entering the Peak 15 garage. This is caused by AMD discontinuing their 3DNow! support, and the game for purely relying on manufacturer check to enable 3DNow rendering.
	...
	- A workaround is to open the in\-game console and enter the following command:
...
- This mission is referred to as "(Noveria:) Tracking the Matriarch" within the game's internal data.
...
| --- | --- | --- |
| Noveria: Geth Interest | Missions |  |
