---
title: Asari Commando
url: https://masseffect.fandom.com/wiki/Asari_Commando
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about Asari Commandos in general. For information on the enemy in Mass Effect, see Asari Commando (enemy).* *For the skill in Mass Effect: Andromeda, see Asari Commando (skill).* |
| --- | --- |
...
\*Human but served in and trained with commando units
