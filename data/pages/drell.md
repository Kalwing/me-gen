---
title: Drell
url: https://masseffect.fandom.com/wiki/Drell
game: Mass Effect 3
type: species
characters: []
scraped: '2026-08-28'
...
*See also: Drell Biology on the Codex*
...
*See also: Drell Culture on the Codex*
...
Known mortuary practices of drell living on Kahje include preparing a body for sea burial. The body is wrapped in sea\-vines, weighted with stones, then slid down to the depths by hanar chanting funerary songs.
...
- Drell biology has had several inconsistent portrayals across the Mass Effect franchise.
	- In Mass Effect 2, Thane exhibits blinking with the two sets of eyelids. In Mass Effect 3, none of the drell featured (including Thane) ever blink their inner lids.
	- Issue Twelve of Mass Effect: Foundation portrays drell bleeding green. Within the games, however, drell blood color is red.
	- While all drell models in the games have fused ring and middle fingers, the comics have portrayed several drell as having five separate fingers: Quoyle in Mass Effect: Homeworlds and Feron in Mass Effect: Redemption.
- While giving a female Shepard inter\-species sexual advice, Mordin Solus states that in humans, sustained skin contact with drell can cause rashes, as well as hallucinations if the contact is oral. This is reminiscent of the effects produced by ingesting toad poison, which is sometimes used as a psychotropic drug.
- According to Trick Weekes, the nature of Kepral's Syndrome is largely based on the real\-life disease of cystic fibrosis.
- The drell are the only race without a Primary Codex entry in Mass Effect 2\. It appears that one did exist during development, but it was cut before the game's release. The oversight has now been corrected and deemed canon as per confirmation in BioWare's N7HQ website.
- Drell were envisioned as a playable race in the multiplayer prototype Mass Effect Team Assault, according to a concept artwork depicting the player class "biotic" as a drell.
- Drell are a playable race in Mass Effect 3's cooperative multiplayer mode.
...
- In cut interactions during Dossier: The Professor, Thane notes that drell have "few diseases". When the plague starts to infect him, he remarks that his "bones are aching", an early symptom of respiratory illness among drell. When Mordin cures him, he mentions that drell are very rare on Omega.

##

- Mass Effect 2 Races: Drell
