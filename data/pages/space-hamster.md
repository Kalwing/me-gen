---
title: Space Hamster
url: https://masseffect.fandom.com/wiki/Space_Hamster
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
- The Space Hamster is a reference to BioWare's Baldur's Gate series, in which a party member named Minsc carried a "miniature giant space hamster" named Boo in his inventory. Any attempts to remove the rodent would result in an audio file being played, the same "squeak" that the Space Hamster intones when interacted with. In the Citadel DLC, Shepard orders the hamster to "go for the eyes" if anyone attacks it \- something Minsc frequently says to Boo in Baldur's Gate. Many members of BioWare who worked on the Mass Effect trilogy had worked on Baldur's Gate 1 and 2 before, including writer Lukas Kristjanson who acted as lead writer on the fantasy franchise's first two games.
- The first Mass Effect\-related mention of the space hamster was on a Christmas card posted by BioWare in 2007, a month after the first Mass Effect's release. In it, a joke dialogue wheel contains the answer "A space hamster" to Santa Claus asking "little Johnny" what he wants as a present.
