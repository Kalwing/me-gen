---
title: Hunting the Archon
url: https://masseffect.fandom.com/wiki/Hunting_the_Archon
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
If Sloane granted you access to Vehn Terev, the door beyond the prison is open. If not, it's closed, and nobody finds out you're there. Either way, Vehn doesn't know where the Archon's ship is, but he suggests that Ryder use the transponder he buried outside town to triangulate the Archon's position.
...
Meanwhile, you may have escaped the Archon but the Initiative ships are still in Tafeno when you access the galaxy map. Paarchero will be gone from the system once you jump out, and show up docked at the Nexus the next time you visit the station. If this mission has been completed before Cora Harper: At Duty's Edge, then the next time Ryder visits the Nexus, the salarians instead of the asari are welcomed by Tann, even if Cora's loyalty has been already obtained. The salarians also give their thanks to Ryder for saving them. Successive visits to the Nexus won't welcome more pilgrims.
...
- This mission was written by John Dombrow and Neil Pollner.
...
| --- | --- | --- |
| A Trail of Hope II | Missions (Mass Effect: Andromeda) | The Journey to Meridian |
