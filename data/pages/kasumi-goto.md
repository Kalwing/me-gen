...
- Jay Turner was the main writer for Kasumi in the second game.
...
- In an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file, Kasumi does not appear and her name is not on the Normandy's memorial wall, indicating she never became part of Shepard's team.
...
- According to a Mass Effect 2 character document used during development, Kasumi was first conceptualized as a "Spacejacker", a 25\-year\-old ship thief/hacker who crosses paths with Shepard when they're trying to steal the same thing. A related prototype concept for the "Master Thief" involved her operating in the Terminus Systems going where nobody else can. After some refining, the Spacejacker concept developed into the "Young Thief": specialized in stealing ships, this squadmate would also intend to steal the "Leviathan", which was the name of Shepard's new ship during this phase. It's also mentioned she was considered for a potential lesbian romance for female Shepard because of her distrust of men.

- Data indicates Kasumi was originally recruited while chased by a gunship on Illium's rooftops, and her loyalty mission, Kasumi: Memento or Mori, involved stopping a bio\-research corporation's plans to release a virus targeting Alliance citizens on the Citadel. A journal entry describes it as Kasumi's "personal mission of justice."
- In a cut dialogue with Shepard on the Normandy, Kasumi would mention her annoyance at the way people typically pronounce her name: "K'sue\-me". The dialogue also mentions a different story with Keiji (known as Kamau in this version): they had found weapon specs of alien origin on a remote planet, but were unable to crack them. Hock tortured and later killed Kamau in an attempt to have them decrypted.
- In a previous version of her loyalty mission, Kasumi would infiltrate Hock's party while visible, as "Miss Kozou." Several guests would remark on her suit and her hood in varying tones of appreciation.
...
- Mass Effect 2 Character Concepts\#8\. The Spacejacker
- Mass Effect 2 Character Concepts\#Young Thief \- Mac
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Kasumi Goto
