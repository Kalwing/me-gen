---
title: 'Priority: Earth'
url: https://masseffect.fandom.com/wiki/Priority:_Earth
game: Mass Effect 3
type: mission
characters: []
scraped: '2026-08-28'
...
- The conclusion to Shepard's trilogy
- There's no turning back
1/2Allied forces are assaulting the Reapers above Earth. Hammer must get a team of soldiers onto the Citadel in order to activate the Crucible. Coordinate with Anderson to get to the Citadel beam.
...
While you may be too distracted by enemies to pay much attention, you can hear voice chatter from allied forces discussing how to take out the Reaper Destroyer guarding the Conduit with only ground forces; a female soldier recommends the use of Thanix missiles, complements of which are apparently available to the various Hammer strike teams.

Proceed until you see another Mako, which will eventually be set upon by a Harvester. You can choose to kill the Harvester for \+100 bonus XP, which is fairly easy if you have the right guns or bring squadmates with biotics like Warp and Dark Channel. Taking out the Harvester before it destroys the Mako also has the bonus that the Mako will remain in the fight and assist you with its machine gun. The other enemies are numerous Marauders and Cannibals, and a Banshee also joins the fight once the Harvester either dies or it destroys the Mako and flies away (whichever happens first). Focus on the Banshee before it can teleport too close to you, but keep an eye on the other foes and beware of grenades. More enemy infantry will drop in from the roof of the ruined building ahead to your left as the fight progresses, but the total number of enemies is finite.

**Warning:**  While the Mako is alive the Harvester only shoots at the tank, but its shots have a wide area of effect. Standing too close to the Mako on either side can severely damage you or your squadmates, though staying behind it is fairly safe. Also note that while the Mako survives quite a while under the Harvester's barrage even on Insanity, once it explodes the Harvester **may target you** and fire potentially lethal parting shots even as it flies away.
...
The ladder leads to an apartment, where a Ravager, supported by other infantry, fires down into the street. If ever there was an ideal place to unload a few grenades, this is it—but be careful as a few will come your way too. Wipe everything out to see the platoon advance, and then loot the apartment, which has ammo and a medkit in the bathroom and another medkit under a corpse outside the bathroom. You can also examine a computer in the apartment after looting. Then, try the door, where Husks will attack you.
...
Finally, you get to head out into the back alley, where two more Brutes come smashing out through the wall as you approach the end. Retreat while taking them out, and then go through the hole they opened. This room has a datapad you can examine, some thermal clips, and a full resupply of grenades. The next door leads to a cutscene.
...
In the Extended Cut/Legendary Edition, you'll witness the survival or deaths of the squadmates you brought with you depending on your War Asset rating; specifically, get below 2100 EMS (4200 in Legendary Edition) and they're kaput. One indication they'll die is if during the initial space battle at the beginning of the mission the allied ships are prominently shown being beaten by the Reapers.
...
- **Total credits**: none
- **Total medi\-gels**: 24 units
	- First Stage: 2 (in 1 pickup)
	- FOB: 6 (in 3 pickups)
	- Second Stage: 16 (in 7 pickups)
- **Morality**: Morality Guide (Mass Effect 3\)\#Priority: Earth
...
- A female Shepard's reaction to Cortez being shot down is bugged: no voice line can be heard, only a subtitle of Shepard shouting Steve's name appears (regardless of whether subtitles are turned on or not). This is due to a glitch where the interaction is coded only for the condition where Shepard romanced Cortez, and there is no recorded line from a female Shepard, likely because it's a male Shepard romance exclusively.

## Trivia

- The mission begins on the left (north) bank of the River Thames. The river and downed bridges can be seen both from the drop\-off point and a few other locations you can reach during early lulls in the fighting. The position of Big Ben shows which bank you're on, and it can be established that the mission starts at approximately the present\-day location of the Embankment and Hungerford bridges.
...
- The human saying that Garrus references when saying goodbye to Shepard at the FOB originates from a traditional Irish toast:
...
| --- | --- | --- |
| Priority: Cerberus Headquarters | Missions |  |
