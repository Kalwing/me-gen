...
|  | *This article is about the geth enemy unit. For the playable multiplayer class, see Geth Hunter Infiltrator.* |
| --- | --- |
...
The Geth Hunter's strong shielding and moderate health mean it can withstand a considerable amount of fire before destruction. Like most other infantry enemies, they will take additional damage from headshots, but their headshot area is located slightly above their "flashlight".
...
Like in Mass Effect 2, Geth Hunters are capable of cloaking. Unlike in Mass Effect 2, their "flashlights" no longer shine when cloaked, making them more difficult to locate. In addition to using their shotguns, Geth Hunters are now capable of making a surprisingly effective melee attack that can stagger targets back, leaving them vulnerable to a point\-blank shotgun blast. Their shotguns can also cause brief stuns that don't cause a full stagger, but still interrupt most player actions.

**Defensive**

Geth Hunters have a moderate amount of health, as well as shields that can regenerate over time after not being damaged. Like other geth units, they can dodge attacks by hopping to the side. Geth Hunters tend to cloak and run away in order to recharge their shields.

### Tactics

- When cloaked, Hunters are nearly invisible except for a shimmering, translucent outline. While in stealth, they cannot be targeted by powers unless you fire upon them with weapons first.
	- Powers can still hit cloaked Hunters, but only if the power is fired "blind" (no lock) with the crosshair directly on\-target, or if the power has an area of effect like a grenade. If the Hunter is in close proximity to visible enemies, powers tend to auto\-target the other foes instead.
	- The Javelin's scoped mode can highlight them in purple, as well as Hunter Mode (in red). The enhanced thermal scope mods for assault and sniper rifles can also reveal cloaked Hunters.
...
- All larger bipedal geth platforms in the Legendary Edition versions of Mass Effect and Mass Effect 2 have been redesigned along the lines of the Geth Prime's original Mass Effect 3 appearance. Originally, they had only a single large light on their heads; now, while the "flashlight" may remain, the heads also sport three smaller "eyes", shoulder armor has been removed, and they have an overall leaner build. Primes in the first game still retain their white coloration from the original Mass Effect, likely to differentiate them from the red\-colored Geth Juggernauts in that game.
