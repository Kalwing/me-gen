---
title: Squad
url: https://masseffect.fandom.com/wiki/Squad
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
- When automatic power use for squadmates is on, they will "spam" all of their abilities in rapid succession whenever they are available; this can be both a blessing and a curse, depending on how much you want to maximize their effectiveness versus not having to micromanage them.
	...
	- Squadmate AI does a very poor job of taking obstructions into account when using abilities, another reason to be very selective about turning on automatic power use. Open areas tend to be the best places to "let them off the leash".
