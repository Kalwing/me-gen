...
Completing this mission adds a Geth Prime Platoon to your War Assets, and fulfills an obligatory requirement for the geth\-quarian peace process.
...
- Regardless of which mission you do first (**Rannoch: Geth Fighter Squadrons** or Rannoch: Admiral Koris), the two arguments below will occur in this order:
	...
	- after the second completed mission, Admiral Xen starts arguing with Tali. Shepard can choose to "support" one or the other. Supporting Admiral Xen gives you the Advanced AI Relays war asset.
...
- **Intel**: Improved Geth Resistors, Miniaturized Armor Capacitors
- **Mission Related**: Reaper Code Fragments
- **Morality**: Morality Guide (Mass Effect 3\)\#Rannoch: Geth Fighter Squadrons

\*Alliance Funding reported in\-game as only 12,500 credits, but no credits are found on the mission.

## Email

If Legion is around instead of Geth VI, you will receive an email from the recently liberated Geth Primes.

**Status\_Update\_314\.20R**
...
- Towards the end of the mission, Legion states that Shepard is the first organic to cooperate with the geth since the end of the Morning War. Presumably, Saren Arterius would not count as he worked with the Reaper\-worshipping geth heretics who are not considered "true geth" by Legion's faction.
	- Also, attempts "to open diplomatic channels" with the geth were made, presumably by the Council, but these ended in failure: "emissary vessels sent to open negotiations were attacked and destroyed the moment they entered geth space".
