...
**Location:** Milky Way / Maroon Sea / Matano System /  **Second planet**
...
In 2183, the colony is wiped out by a Cerberus experiment. Dragon's teeth converted the colonists to husks.
...
| --- | --- | --- |
| 1 | Initial | Civilian building (UNC: Colony of the Dead) |
| 2 | Initial | Civilian building (UNC: Colony of the Dead) |
| 3 | Initial | Science facility (UNC: Colony of the Dead) |
| 4 | Initial | Probe (salvage) |
| 5 | Initial | Prothean pyramid and dig site (UNC: Prothean Data Discs) (salvage). In the structure, there is a med kit, a Technician Kit, and a Crate (Average Decryption). Beside the structure is a crate with the disc, as well as another crate (Average Decryption).  *“There are several small Prothean artifacts in the crate, including an intact Prothean data disc. It appears to be in excellent condition.”* |
...
Chasca's atmosphere has a light hail of organic particulates, although it is one of the few worlds where it's safe to go helmetless.

The world's points of interest aside from the colony buildings lie along a complex mountain range with steep inclines, which could result in arduous uphill drives going from place to place.

## Trivia

- All planets in the Matano system are named after deities of Inca mythology. Chasca is the Inca deity of dawn and twilight.
- In Mass Effect Legendary Edition, Chasca's terrain now features 3D grass carpeting instead of plain green textures.
