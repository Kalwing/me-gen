---
title: Codex
url: https://masseffect.fandom.com/wiki/Codex
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the Codex for the original* Mass Effect *Trilogy. For the guide to collecting Codex entries in those games, see the Codex Entry Guide.* *For the Codex in* Mass Effect: Andromeda*, see Codex (Mass Effect: Andromeda).* |
| --- | --- |
