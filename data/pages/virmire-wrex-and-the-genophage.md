...
url: https://masseffect.fandom.com/wiki/Virmire:_Wrex_and_the_Genophage
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
- This assignment was written by Lukas Kristjanson.
...
- This assignment is referred to as "(Virmire:) Krogan Conundrum" within the game's internal data.
- BioWare social media coordinator David Hulegaard recalls that initial audience reactions on sparing or killing Wrex veered strongly toward the latter when the developers first demoed the Virmire section of Mass Effect.
- According to Mass Effect Legendary Edition gameplay statistics as of July 27, 2021, 94% of the time Wrex survives the confrontation. He dies in the remaining 6%.
