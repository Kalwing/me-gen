---
title: Cabal Vanguard
url: https://masseffect.fandom.com/wiki/Cabal_Vanguard
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
| | **Barrier:** 750 / **Health:** 500 | | | --- | --- | | **Class: Turian Veteran** | | | Poison Strike |  | | Nightshade Blades |  | | Biotic Focus |  | | Venom Gauntlets |  | |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |

## Melee and movement

|  | - **Regular Melee** – Gauntlet slash 	- **Melee Sequence:** The Cabal Vanguard executes a continuous series of gauntlet slashes. - **Heavy Melee (Venom Gauntlets)** – The Cabal Vanguard leaps to a target and stabs with venom\-tipped blades, dealing poison damage over time. If the stab is fatal, the target is decapitated. - **Grab (Venom\-Tipped Blades Stab)** – The Cabal Vanguard drags an enemy over cover and then executes them by stabbing with venom\-tipped blades. |
| --- | --- |
|  | - **Dodge** – The Cabal Vanguard teleports a short distance at the expense of barrier strength. - The Cabal Vanguard can take cover, and can roll from cover to cover. |
