---
title: Charge
url: https://masseffect.fandom.com/wiki/Charge
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the biotic Charge power in Mass Effect 2 and Mass Effect 3\. For the Turbocharge skill in Mass Effect: Andromeda, see Turbocharge.* *For the Charge skill in Mass Effect: Andromeda, see Charge (skill).* |
| --- | --- |
...
- A biotically\-created mass effect field sends the user almost instantaneously across the battlefield towards a target.
	...
	- Charge will not trigger against destructible objects like explosive canisters, though Shepard will glow biotically if this is attempted.
...
- Charge is intentionally unaffected by the Biotic Cooldown upgrade; it is affected by all other cooldown modifiers normally, e.g. from Assault Mastery.
	- **Legendary Edition:**  In Legendary Edition, Charge's recharge time *is* lowered by the Biotic Cooldown upgrade.
- Charge does token damage: 25/35/45/45 base damage at ranks 1/2/3/4, respectively. Heavy Charge upgrades this base damage to 60\.
- Even without Area Charge, multiple enemies can be hit as long as they are within 3 meters from Shepard in a 60° cone ahead.
- A successful Heavy Charge slows game speed by 80% for 1\.15 seconds.
...
- Charge only starts restoring shields at rank 2\. While the amount of shields restored is small relative to later ranks of the power, this is still a massive upgrade to your longevity compared to rank 1, thanks to the brief immunity to health damage you receive after shields fully break. To fully take advantage of this immunity period, you should wait until it wears off before using Charge to restore shields, which gives you both the shields and another immunity period if the restored shields break.
...
| *Force \& Damage* Increase damage and force by 30% (40% multiplayer). - **Recharge Speed:** 8 sec (11\.20 krogan) - **Damage:** 375 (680 multiplayer non\-krogan, 850 krogan) - **Force:** 750 N (1105 N multiplayer non\-krogan, 1275 N krogan) - **Barrier Restored:** 50% | *Radius* Hit up to 2 additional targets within 2 meters of the impact point. |
| --- | --- |

#### Rank 5: Weapon Synergy/Power Synergy

| *Weapon Synergy* Increase weapon damage by 15% (25% multiplayer) for 3 seconds (5 sec multiplayer) after a successful Biotic Charge. | *Power Synergy* Increase power damage and force by 25% (40% multiplayer) for 15 seconds (10 sec multiplayer) after a successful Biotic Charge. |
| --- | --- |

#### Krogan Battlemaster Vanguard Rank 5: Weapon Synergy/Melee Synergy

| *Weapon Synergy* Increase weapon damage by 25% for 5 seconds after a successful Biotic Charge. | *Melee Synergy* Increase melee damage by 40% for 5 seconds after a successful Biotic Charge. |
| --- | --- |

#### Rank 6: Bonus Power/Barrier

| *Bonus Power* Give Biotic Charge a 25% (50% multiplayer) chance of not triggering a cooldown. | *Barrier* Increase barriers by an additional 50% after a successful Biotic Charge. - **Recharge Speed:** 8 sec (11\.20 krogan) - **Damage:** 375 (680 multiplayer non\-krogan, 850 krogan) \[Force \& Damage], 300 (520 multiplayer non\-krogan, 650 krogan) \[Radius] - **Force:** 750 N (1105 N multiplayer non\-krogan, 1275 N krogan) \[Force \& Damage], 600 N (845 N multiplayer non\-krogan, 975 N krogan) \[Radius] - **Barrier Restored:** 100% |
| --- | --- |

### Player Notes

Mechanics
- Charge deals 1\.5x damage to barriers.
...
- Players can perform a powerful combo by spamming both Biotic Charge and Nova consecutively. First, use Biotic Charge to quickly reach a group of enemies; optionally, use a heavy melee attack on a single enemy; finally, use Nova without any delay to do damage and/or stun all enemies in close proximity. If the player has upgraded Biotic Charge with the rank 6 Barrier evolution and has a quick enough power recharge rate, this combo can be spammed infinitely.
	- This tactic is by no means foolproof. While Charge does provide significant damage resistance for a limited time, it's still quite possible to take heavy damage or even instantly lose shields the moment Charge completes depending on what enemies are in the vicinity. If this happens, you won't be able to use the temporary invulnerability provided by Nova to buy time for your next Charge to restore shields, a critical component of the combo.
...
- Reave is an excellent bonus power for a Vanguard. It hits the target instantly, so it can be triggered immediately before Charge, and with the Radius evolution, a single Reave, then Charge and Nova can cause multiple Biotic Explosions. It is also an alternative to Pull for dealing with Guardian shields, and if you trigger the Charge quickly enough, their shield will still be down and your Charge will still hit them. Lastly, Reave provides a damage reduction bonus that will come in handy should your follow\-up Nova or heavy melee not kill the target.
