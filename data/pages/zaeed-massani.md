...
- Jay Turner was the main writer for Zaeed in the second game, while Cathleen Rootsaert wrote Zaeed in the Citadel DLC for Mass Effect 3\.
- Zaeed is only available through the Zaeed \- The Price of Revenge DLC pack, which is included in Mass Effect Legendary Edition.
- According to his character page on BioWare's defunct Mass Effect 2 site, Zaeed served in the Alliance before turning mercenary. 40 years old by 2185, he was bounty hunting for 20 years. However, this would mean he founded the Blue Suns with Vido at only 15 years old in 2160\.
...
- Zaeed is one of only two squad mates (the other being Kasumi Goto) whose loyalty mission is available straight away after recruiting them. He is also one of four squad mates without a mission tied to his recruitment (the other three being Jacob, Miranda, and Kasumi). He is also one of only two squad mates who can die on their loyalty mission (the other being Samara).
	- Like Kasumi, Zaeed also does not have any dialogue options when the player talks to him on board the Normandy. Instead, he, as well as some items in his proximity, can be interacted with, prompting him to reminisce or comment on the team or his earlier missions. Zaeed will be as talkative and mission\-specific opinionated as any other party member *during* missions, however.
- In an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file, Zaeed does not appear and his name is not on the Normandy's memorial wall, indicating he never became part of Shepard's team.
...
- According to an internal document used in early Mass Effect 2 development, the earliest character pitch for a squadmate nicknamed "The Mercenary" envisioned him as a 30\-year\-old man (although very experienced) whom Cerberus would hire to serve as Shepard's guide in the Terminus. It was mentioned that failing to maintain his loyalty could result in his selling out Commander Shepard to the Collectors.
- In a separate but related document, the name for the "Veteran" squadmate was given as "Hariz al\-Kherij". In Arabic, "Hariz" means "strong", and "al\-Kharij" (with an *a*) means "the one who leaves" or "goes out."
- In a cut dialogue where the Illusive Man would provide Zaeed's dossier for recruitment, he would introduce him under the name "Zaeed Shak". In Arabic, Persian and Hindi, "Shak" means "doubt" or "suspicion".
- Zaeed's acquisition and loyalty missions were at one point planned to be completely different. Zaeed would have been recruited on Korlus, with Shepard being forced to break into a criminal hideout to steal the money needed to hire him. To secure his loyalty, Shepard would have gone with him to Tuchanka to fake his death in order to get rid of the second best bounty hunter in the galaxy.
...
- Mass Effect 2 Character Concepts\#13\. The Mercenary
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Zaeed Massani
