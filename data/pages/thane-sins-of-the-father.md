---
title: 'Thane: Sins of the Father'
url: https://masseffect.fandom.com/wiki/Thane:_Sins_of_the_Father
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
Note that in order to find out about the Shepard VIs, Shepard needs to ask about them before asking about Kelham. Shepard can ask for a copy of the VI, for Mouse to stop selling them, or for a cut of the profits. None of the choices has any effect on the game and the player doesn't get to see the Shepard VI (yet).

Go back to Captain Bailey to ask about finding Kolyat. The situation is awkward for the C\-Sec captain, because he and Kelham have an arrangement—Kelham bribes Bailey and he looks the other way. Nevertheless, Bailey is willing to help Shepard by arresting Kelham and providing an opportunity for Shepard and Thane to interrogate him. You must now try to make Kelham confess before his lawyer arrives.
...
Captain Bailey will send Shepard the following message after the mission only if Thane and Kolyat got to talk with each other.
...
- Right before entering the room where you talk to the stock boy, the game can switch to the cutscene you get if you lose the target just as you update Thane on the target’s location. The audio of the update can still be heard despite the screen saying you failed the mission.
...
- Successfully gaining Thane's loyalty during this mission awards the achievement "Cat's in the Cradle", which is an idiom as well as the title of a 1974 song by Harry Chapin, wherein a father repeatedly neglects his son in favor of his work, only to later in life come to the realization that his now\-adult son is mirroring his behavior.
...
- An early plot concept in a design document for this mission implies Shepard could persuade Kolyat to "turn his life around."
- Plot data related to this mission indicates at one point during development, the person being interrogated was named "Luran" and could end up killed if the interrogation went too far.
