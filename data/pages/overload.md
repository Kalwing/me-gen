---
title: Overload
url: https://masseffect.fandom.com/wiki/Overload
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
|  | *This article is about the tech power in Mass Effect 2 and Mass Effect 3\. For the talent in Mass Effect, see Electronics.* *For the skill in Mass Effect: Andromeda, see Overload (skill).* |
| --- | --- |
...
Strategies
- Heavy Overload tends to be overkill for taking out shields on basic foot soldiers, but is useful against foes with higher than average shields like YMIRs. Area Overload is very useful for stripping shields (and even other protections) and disabling weapons of multiple minor enemies. This can be especially useful against enemy Engineers, as it will easily take out any of the drones they summon as well.
- Overload is most effective against standard shielded enemies when it is able to destroy their entire shield in one use, leaving them vulnerable to disabling effects like biotics or freezing attacks. Tech Damage upgrades you earn will improve Overload's damage, as will certain armor pieces, passive class powers, and of course, higher ranks of Overload itself. Try to keep your Overload damage high enough to offset the damage loss you suffer by gaining character levels. This level scaling damage penalty also applies to squadmates.
...
| *Chain Overload* Hit 1 additional target within 8 meters with 60% less damage. | *Damage* Increase damage by 30%. - **Recharge Speed:** 6\.40 sec - **Damage:** 330 |
| --- | --- |

#### Rank 5: Neural Shock/Recharge Speed

| *Neural Shock* Incapacitate weaker organic enemies for a short duration. | *Recharge Speed* Increase recharge speed by 25%. - **Recharge Speed:** 5\.33 sec - **Damage:** 330 |
| --- | --- |

#### Rank 6: Chain Overload/Shield Damage

| *Chain Overload* Increase damage by 15%.Hit 1 additional target within 8 meters with 60% less damage. - **Recharge Speed:** 6\.40 sec (Neural Shock), 5\.33 sec (Recharge Speed) - **Damage:** 297 (Chain Overload), 363 (Damage) | *Shield Damage* Increase damage to barriers and shields by an additional 100%. |
| --- | --- |

### Player Notes

Damage
- Overload does differing amounts of damage to health, armor, and shields based upon rank evolutions and the enemies being impacted by Overload.
...
| *Neural Shock* | *Shield Damage* | OrganicHealth \& Armor | OrganicBarriers/Shields | SyntheticHealth \& Armor | SyntheticShields |
| --- | --- | --- | --- | --- | --- |
|  |  | 0\.5x | 3x | 1x | 3x |
|  | ✓ | 5x | 6x |
| ✓ |  | 1x | 6x | 3x |
...
- If both chain evolutions are chosen, the third hit will only do 16% of the original hit damage (an additional 60% reduction of the second hit's 60% damage reduction, not a 60% reduction of the original hit). In addition, it may "forget" to do normal damage to synthetics (instead doing half damage) or do extra damage to shields/barriers (instead doing normal damage).
...
- Overload is one of the few powers in Mass Effect 3 that can both prime and detonate Power Combos (though you must use a different power from Overload to prime or detonate any combo).
	...
	- If Overload is given one or both chain evolutions, each additional Overload chain is capable of detonating a separate Tech Burst, Fire Explosion or Cryo Explosion, which makes Overload relatively unique, as most powers can only detonate one combo per use.
...
- Chain hits can jump to invisible targets such as cloaked Geth Hunters. They can also jump to hit and potentially destroy Reaper Barrier Engines and Cerberus shield generators and pylons.
- Phantoms, Banshees, and Rampart Mechs don't use their power\-blocking protective stances after being hit by Overload, as it is a hitscan (non\-projectile) power.
...
- Overload even without Neural Shock will cause tech\-shock stuns against most unshielded infantry targets (even synthetic ones). This also applies to any chain hits, making Overload with both Chain evolutions one of the best "crowd control" powers in the game, since the chain hits don't need line of sight to the Overload user and automatically hit in a fairly large area without giving opponents a chance to dodge.
	- Neural Shock is a powerful additional incapacitating effect against unprotected infantry, and a useful damage boost against organic foes. Husks and Abominations are immune to standard tech\-shock stuns, but they are vulnerable to Neural Shock.
...
- **Single\-Player:** Engineer, Sentinel, EDI, Garrus Vakarian, Kaidan Alenko, Nyreen Kandros, Kasumi Goto, Miranda Lawson
- **Multiplayer:** Geth Engineer, Human Engineer, Turian Ghost Infiltrator, Turian Sentinel
