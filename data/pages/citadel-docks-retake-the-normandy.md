...
Once you are done, head into the access room to the War Room to get Private Campbell’s favorite mug (for 3 credits), an Assault Rifle Thermal Scope mod, and a merc PDA with a story of someone shooting their own foot off. When you are done, head over to the galaxy map and pick up the merc payment worth 15,000 credits.

Before you head to the elevator, you will discover that "somebody" dumped all of the personal effects from your cabin, including your Model Ships, pets, and medals, into a large bin with orders to dispose of everything. Shepard will have something to say about that—several things if you're persistent. You can also hear the head screaming from Bryson's experiment, if it was in Shepard's quarters.
...
- **Total credits**: 30,003
	- Credits found: 15,003 (in 2 pickups)
	- Alliance Funding: 15,000
- **Medi\-gels**: 5 (in 2 pickups)\*
- **Weapon mods**: Sniper Rifle Ultralight Materials, Shotgun Ultralight Materials, Assault Rifle Thermal Scope
- **Morality**: Morality Guide (Mass Effect 3\)\#Citadel Docks: Retake the Normandy

\*Unlimited medi\-gels in the shuttle bay, but no XP reward
...
- If Wrex and Garrus are the two squadmates, in the elevator ride down to the shuttle bay, Garrus asks Wrex and Shepard if they miss the conversations that they used to have on the Citadel, a reference to the conversations that occurred when in elevators between areas in Mass Effect.

Mass Effect 3: Citadel Navigation

| ← Previous Mission | Mission Index | Next Mission → |
| --- | --- | --- |
| Citadel Archives: Escape | Missions | Citadel: Party |
