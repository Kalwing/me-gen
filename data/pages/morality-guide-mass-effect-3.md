---
title: Morality Guide (Mass Effect 3)
url: https://masseffect.fandom.com/wiki/Morality_Guide_(Mass_Effect_3)
game: Mass Effect 3
type: lore
characters: []
scraped: '2026-08-28'
...
- Saying "Yes, but it's unnecessary." *(If not imported character.)*
	- 2 Paragon for saying "I haven't changed."
	- 2 Renegade for saying "We're out of time."
...
- Saying "How can you say that?"
	- 2 Paragon for saying "I never left." *(only if previously romanced.)*
	- 2 Paragon for saying "I'm still here." *(If previously not romanced.)*
	- 2 Renegade for saying "That's all in the past." *(only if previously romanced.)*
	- 2 Renegade for saying "I am who I am." *(If previously not romanced.)*
- Saying "Yes, but it's unnecessary." *(If not imported character.)*
...
- 5 Paragon for using Paragon interrupt. *(Only available if Mordin: Old Blood was completed in Mass Effect 2\. If Maelon's data was destroyed, Shepard has to apologize in Sur'Kesh and reveal the deal Dalatrass Linron offered.)*
...
- 2 Paragon for saying "It was my fault." or "I'm responsible for her death."
...
Ashley protecting the Council, if Ashley somewhat trusts Shepard (romanced in ME1, cheated in ME2, not nice with her in Mars, original Council alive, admitted cheating \-not telling her she was the one cutting ties\-)
...
Talk to Geth VI in the drive core (if Legion was never encountered)

- 2 Paragon for saying "I'm listening for now."
- 2 Renegade for saying "Sure you were."

Talk to Geth VI/Legion restored from backup in the drive core (if Legion did not survive the Suicide Mission)

- 2 Paragon for saying "I still trust it."
- 2 Renegade for saying "You're right."

Talk to Legion in the drive core
...
Arriving at the Reaper base, talk to Legion/Legion backup/Geth VI and Tali

- 2 **Reputation** for interaction.

Talk to the unnamed Reaper

- 2 Paragon for saying "We'll destroy you eventually."
	- 5 Paragon for taking the Paragon Interrupt
- 2 Renegade for saying "You're arrogant for a machine."
	- 5 Renegade for taking the Renegade Interrupt

Talk to Legion/Legion backup/Geth VI and Tali

- If geth platform is Legion:
	- 15 Paragon for Charming "\[Rally the fleet]"
	- 15 Renegade for Intimidating "\[Warn the fleet]"
	- 15 Paragon for selecting \[Upload the code]
	- 15 Renegade for selecting \[Let geth die]
- If geth platform is Legion backup/Geth VI:
	- 15 **Reputation** for selecting any of the following options: \[Allow the upload], \[Stop Legion], \[Upload the code], \[Let geth die].
...
Talk to Wrex before returning to Normandy (if genophage cure sabotaged)

- 2 Paragon for saying "I needed salarian help."
- 2 Renegade for saying "Krogan can't handle a cure."

plus
- 5 Renegade for taking the first Renegade interrupt.

plus
- 5 Renegade for taking the second Renegade interrupt.

plus
- 2 Paragon for saying "He deserved better."
- 2 Renegade for saying "He went nuts."
...
Vendetta, the Prothean VI

- Not choosing investigate option "Crucible."
	- 2 Paragon for saying "But we need your help."
	- 2 Renegade for saying "It isn't over yet!"
- Choosing investigate option "Crucible."
	- 2 Paragon for saying "Then help us."
...
- Saying "Whose side are you on?"
 *n.b. The rewards are opposite what is normal.*
...
plus
- 2 Renegade for "\[LIE] What do you mean?", then "You bet. I'm out of here." *(Only available if female Shepard and cheated on romance.)*
- 4 **Reputation** for additional interaction with Kaidan (any Investigate option).
...
Talk to Doctor Chakwas or Doctor Michel (if recruited at the hospital)

- 2 **Reputation** for interaction.

Talk to James (initial conversation)
...
Talk to Liara (initial cabin conversation)
...
Conversation with Aria in the skycar

- 2 Paragon for saying "Some might say that about you."
- 2 Renegade for saying "Our kind of guy."

### Rendezvous with Aria's Fleet

Meeting Aria on the Cerberus cruiser

- 2 Paragon for saying "It sounds risky."
- 2 Renegade for saying "I like it."

plus

- 2 Paragon for saying "I can't say the same."
- 2 Renegade for saying "Not from your boss."

### Omega: Aria T'Loak

After getting out of the escape pod

- 2 Paragon for saying "Why am I skeptical?"
- 2 Renegade for saying "Glad to hear it."
...
- 15 Paragon for re\-routing the power
- 15 Renegade for taking the Renegade interrupt to overload the reactor

plus

- 5 Paragon for taking the Paragon interrupt when Aria talks with Nyreen
...
Meeting Petrovsky in the Afterlife after the final battle if Shepard has been ambivalent or mostly Renegade throughout the mission

- 2 Paragon for taking the first Paragon interrupt
	- 15 Paragon for taking the second Paragon interrupt to stop Aria from killing Petrovsky
	- 15 **Reputation** for not taking the second Paragon interrupt
- 15 Renegade for not taking the first Paragon interrupt, allowing Aria kill Petrovsky plus 15 **Reputation**

plus

- 2 Paragon for saying "You need to reform." or "Take care of the people."
- 2 Renegade for saying "I'll leave you to guess." or "Time to pay up."

Meeting Petrovsky in Afterlife after the final battle if Shepard has been mostly Paragon throughout the mission

- 2 Renegade for taking the first Renegade interrupt
	- 15 Renegade for taking the second interrupt and killing Petrovsky.
		- 5 Paragon for saying "You need to reform."
		- Saying "It's your life."
			- 2 Paragon for saying "Take care of the people."
			- 2 Renegade for saying "Time to pay up."
	- 15 **Reputation** for not taking the second interrupt, leaving Petrovsky alive
- 15 Paragon for not taking the first Renegade interrupt, leaving Petrovsky alive
	- 2 Paragon for saying "Take care of the people."
	- 2 Renegade for saying "Time to pay up."
...
plus
- 5 Paragon for taking the first Paragon Interrupt.
- 5 Renegade for taking the first Renegade Interrupt.
...
- 2 Paragon for saying "Seriously, I sound like that?"
- 2 Renegade for saying "I say much cooler things."
...
- 5 Paragon for saying "I know you, Traynor."
...
plus
- 15 Paragon for saying "\[Save the clone]"
- 15 Renegade for saying "\[Kill the clone]"
...
### Silversun Strip: Other Interactions

Wait for Joker in the bar of Silver Coast Casino
