---
title: Thane Krios
url: https://masseffect.fandom.com/wiki/Thane_Krios
game: Mass Effect 3
type: character
characters: []
scraped: '2026-08-28'
...
- Chris L'Etoile was the main writer for Thane in the second game, while Chris Hepler wrote him in the third game.
...
- Thane does not appear in an unmodified game of Mass Effect 3 that was not imported from a Mass Effect 2 save file. His name appears on the Normandy's memorial wall, indicating he did not survive the suicide mission.
...
- According to a BioWare document used to define concepts for Mass Effect 2's squadmates, Thane Krios was conceived from the beginning to be a spiritual fighter belonging to one of the newly\-introduced alien races. His various pitches ("The Crusader", then "New Alien", and finally "The Assassin") mention the character was inspired by Shepherd Book from *Firefly*, Mr. Rochester from Jane Eyre, and assassin Martin Blank in *Grosse Pointe Blank*. His earliest concept didn't present him as an assassin, instead having him act as an "observer" on Shepard's ship after obtaining a plot\-critical weapon from the species he belonged to. At one point, his given name was "Krios Than", which Mac Walters changed to its present form.
...
- Mass Effect 2 Character Concepts\#14\. The Crusader
- Mass Effect 2 Character Concepts\#New Alien \- Mac
- Mass Effect 2 Character Concepts\#The Assassin — Krios Than
- Mass Effect 2 Art Book/Texts\#01: Heroes and Villains
- The Art of the Mass Effect Trilogy/Mass Effect 2\#Thane Krios
- BioWare: Stories and Secrets from 25 Years of Game Development/The Making of Mass Effect 2\#Untitled Anecdote 3
