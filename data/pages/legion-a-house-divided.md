---
title: 'Legion: A House Divided'
url: https://masseffect.fandom.com/wiki/Legion:_A_House_Divided
game: Mass Effect 2
type: mission
characters: []
scraped: '2026-08-28'
...
**Warning:** You can take friendly fire from the Rocket Drones, so don't stand in front of them! You can also be damaged when they self\-destruct or are destroyed by enemy fire.
...
If playing a non\-imported game in Mass Effect 3, none of the above penalties or bonuses will accrue to the War Assets of whichever faction Shepard sides with.
...
- The tower defense minigame was worked into the mission when tech designer Keith Hayward suggested he could use Unreal Engine's Kismet scripting to code it without any external programming support.
- When choosing to rewrite the geth, Legion states the electromagnetic pulse sent out by the station will have a power yield in excess of 1\.21 petawatts. This may be a reference to the film *Back to the Future*, where 1\.21 gigawatts of electricity was needed to power Doc Brown's time machine.
