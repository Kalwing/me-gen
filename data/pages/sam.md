---
title: SAM
url: https://masseffect.fandom.com/wiki/SAM
game: Mass Effect
type: character
characters: []
scraped: '2026-08-28'
...
Short for **S**imulated **A**daptive **M**atrix, **SAM** is an artificial intelligence designed by Alec Ryder himself. From the SAM Node in Hyperion, he receives a direct feed of the Pathfinder's sensory input: he sees and feels as Ryder does, providing them with advanced situational awareness, problem solving, and tactical enhancements. All members of the Pathfinder team receive implants, allowing them to communicate directly with SAM.
...
SAM\-E was a partition of SAM designed to test SAM's transferability when Alec dies. Implanted in Cora Harper, the experiment was deemed a failure when Ryder discovered that SAM\-E's maladjusted integration would eventually harm its host. SAM\-E's memories and experiences were thus folded back into SAM, although his separate personality matrix was gone.
