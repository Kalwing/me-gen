...
You'll be facing a combination of organic and synthetic enemies protected by shields and/or armor. Jacob's Incendiary Ammo can help against armor and organics to a degree, so a second squadmate with anti\-shield/anti\-synthetic powers is a good idea, with a loyal Tali being a standout choice.
...
- This mission has a number of unused conditionals related to an earlier iteration with a fairly different narrative. In it, the ship which had crashed was not Alliance but a Cerberus survey ship instead, and the planet would be home to intelligent though somewhat primitive aliens. They would come to worship the humans, and Jacob's father would end up leading repression against dissidents. After meeting him, Shepard could lecture him about interfering with a pre\-spaceflight species, and he could end up killed by a mech. Two other characters who would have been present in the mission are also mentioned: Kindahl and Clarke.

## See Also

- The Art of the Mass Effect Trilogy/Mass Effect 2\#2175 Aeia
