---
title: 'Task: Roekaar Manifestos'
url: https://masseffect.fandom.com/wiki/Task:_Roekaar_Manifestos
game: Mass Effect
type: lore
characters: []
scraped: '2026-08-28'
...
The third manifesto datapad can be found in Old Pelaav, in the north building on the right side after Ryder enters it.

Fourth Datapad
The fourth datapad's location on the ground.The fourth datapad's location on the map.
The fourth manifesto datapad can also be found in Old Pelaav, in the the southwest building of the encampment. As Ryder passes the door it is on the left, right next to the door. Don't forget to scan the object on the tower for \+100  while Ryder is here.
