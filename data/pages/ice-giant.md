---
title: Ice Giant
url: https://masseffect.fandom.com/wiki/Ice_Giant
game: Mass Effect
type: mission
characters: []
scraped: '2026-08-28'
...
1. Stay in the initial cover and take the Troopers out from afar, using your assault rifle and sniper rifle (if purchased) on them after you've Pulled or Leashed (if purchased) them out of cover.
2. Since they hide in cover and don't move from their position, roll from cover to cover, then use push and your shotgun. Alternate with the assault rifle to earn a higher score.
3. If you're replaying this checkpoint with upgraded abilities, you can run around wreaking havoc with Charge, Slide and melee attacks.
